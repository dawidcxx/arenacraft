...
MoveSpline::MoveSpline()
    : m_Id(0), time_passed(0), vertical_acceleration(0.f), initialOrientation(0.f), effect_start_time(0), point_Idx(0),
...
#define CHECK(exp)                                                                                                     \
  ...
  {                                                                                                                    \
    if (unit)                                                                                                          \
      LOG_ERROR("misc.movesplineinitargs", "MoveSplineInitArgs::Validate: expression '{}' failed for {}", #exp,        \
