...
void LoadRandomEnchantmentsTable()
{
  ...
  if (result)
  {
    ...
    LOG_INFO("server.loading", ">> Loaded {} Item Enchantment Definitions in {} ms", count,
...
uint32 GetItemEnchantMod(int32 entry)
{
  ...
  {
    LOG_ERROR("sql.sql",
              "Item RandomProperty / RandomSuffix id #{} used in `item_template` but it does not have records in "
