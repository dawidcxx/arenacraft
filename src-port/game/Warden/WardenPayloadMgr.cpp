...
bool WardenPayloadMgr::UnregisterPayload(uint16 payloadId) { return CachedChecks.erase(payloadId); }
...
uint32 WardenPayloadMgr::GetPayloadCountInQueue() { return QueuedPayloads.size(); }

std::list<uint16>* WardenPayloadMgr::GetPayloadsInQueue() { return &QueuedPayloads; }
