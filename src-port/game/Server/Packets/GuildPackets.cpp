...
void WorldPackets::Guild::GuildUpdateMotdText::Read() { _worldPacket >> MotdText; }
...
void WorldPackets::Guild::GuildUpdateInfoText::Read() { _worldPacket >> InfoText; }
...
void WorldPackets::Guild::GuildPromoteMember::Read() { _worldPacket >> Promotee; }

void WorldPackets::Guild::GuildOfficerRemoveMember::Read() { _worldPacket >> Removee; }
