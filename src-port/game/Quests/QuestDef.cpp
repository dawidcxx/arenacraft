...
void Quest::InitializeQueryData()
{
  ...
  queryData << uint32(
      GetQuestLevel()); // may be -1, static data, in other cases must be used dynamic level: Player::GetQuestLevel (0
                        // is not known, but assuming this is no longer valid for quest intended for client)
