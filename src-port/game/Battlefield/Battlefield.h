...
public:
  ...
  // Graveyard methods
  // Find which graveyard the player must be teleported to to be resurrected by
  // spiritguide
...
protected:
  ...
  WorldLocation KickPosition; // Position where players are teleported if they switch to
                              // afk during the battle or if they don't accept invitation
