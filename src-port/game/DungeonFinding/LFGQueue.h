...
private:
  ...
  LfgCompatibility CheckCompatibility(Lfg5Guids const& checkWith, const ObjectGuid& newGuid, uint64& foundMask,
  ...
  LfgCompatibleContainer CompatibleTempList; // new compatibles are added to this container while
                                             // main one is being iterated

  LfgWaitTimesContainer waitTimesAvgStore;    // Average wait time to find a group
                                              // queuing as multiple roles
