...
public:
   ...
   * @return True if you want to continue sending the packet, false if you want
   * to disallow sending the packet
   */
   ...
   * @param session Contains information about the WorldSession
   * @param packet Contains information about the WorldPacket
   * @return True if you want to continue receive the packet, false if you want
   * to disallow receive the packet
   */
