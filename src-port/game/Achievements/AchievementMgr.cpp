...
bool AchievementCriteriaData::IsValid(AchievementCriteriaEntry const* criteria)
{
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_T_CREATURE:
    ...
    {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` (Entry: {} Type: {}) for data type "
                "ACHIEVEMENT_CRITERIA_DATA_TYPE_CREATURE ({}) has non-existing creature id in value1 ({}), ignored.",
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_T_PLAYER_CLASS_RACE:
    if (classRace.class_id && ((1 << (classRace.class_id - 1)) & CLASSMASK_ALL_PLAYABLE) == 0)
    {
      LOG_ERROR(
          "sql.sql",
          "Table `achievement_criteria_data` (Entry: {} Type: {}) for data type "
          "ACHIEVEMENT_CRITERIA_DATA_TYPE_T_PLAYER_CLASS_RACE ({}) has non-existing class in value1 ({}), ignored.",
    ...
    if (classRace.race_id && ((1 << (classRace.race_id - 1)) & RACEMASK_ALL_PLAYABLE) == 0)
    {
      LOG_ERROR(
          "sql.sql",
          "Table `achievement_criteria_data` (Entry: {} Type: {}) for data type "
          "ACHIEVEMENT_CRITERIA_DATA_TYPE_T_PLAYER_CLASS_RACE ({}) has non-existing race in value2 ({}), ignored.",
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_T_PLAYER_LESS_HEALTH:
    if (health.percent < 1 || health.percent > 100)
    {
      LOG_ERROR(
          "sql.sql",
          "Table `achievement_criteria_data` (Entry: {} Type: {}) for data type "
          "ACHIEVEMENT_CRITERIA_DATA_TYPE_PLAYER_LESS_HEALTH ({}) has wrong percent value in value1 ({}), ignored.",
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_T_PLAYER_DEAD:
    if (player_dead.own_team_flag > 1)
    {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` (Entry: {} Type: {}) for data type "
                "ACHIEVEMENT_CRITERIA_DATA_TYPE_T_PLAYER_DEAD ({}) has wrong boolean value1 ({}).",
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_T_AURA:
  {
    ...
    {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` (Entry: {} Type: {}) for data type {} ({}) has wrong spell id in "
                "value1 ({}), ignored.",
                criteria->ID, criteria->requiredType,
    ...
    {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` (Entry: {} Type: {}) for data type {} ({}) has wrong spell effect "
                "index in value2 ({}), ignored.",
                criteria->ID, criteria->requiredType,
                (dataType == ACHIEVEMENT_CRITERIA_DATA_TYPE_S_AURA ? "ACHIEVEMENT_CRITERIA_DATA_TYPE_S_AURA"
                                                                   : "ACHIEVEMENT_CRITERIA_DATA_TYPE_T_AURA"),
    ...
    {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` (Entry: {} Type: {}) for data type {} ({}) has non-aura spell "
                "effect (ID: {} Effect: {}), ignores.",
                criteria->ID, criteria->requiredType,
                (dataType == ACHIEVEMENT_CRITERIA_DATA_TYPE_S_AURA ? "ACHIEVEMENT_CRITERIA_DATA_TYPE_S_AURA"
                                                                   : "ACHIEVEMENT_CRITERIA_DATA_TYPE_T_AURA"),
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_S_AREA:
    if (!sAreaTableStore.LookupEntry(area.id))
    {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` (Entry: {} Type: {}) for data type "
                "ACHIEVEMENT_CRITERIA_DATA_TYPE_S_AREA ({}) has wrong area id in value1 ({}), ignored.",
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_VALUE:
    if (value.compType >= COMP_TYPE_MAX)
    {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` (Entry: {} Type: {}) for data type "
                "ACHIEVEMENT_CRITERIA_DATA_TYPE_VALUE ({}) has wrong ComparisionType in value2 ({}), ignored.",
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_T_LEVEL:
    if (level.minlevel > STRONG_MAX_LEVEL)
    {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` (Entry: {} Type: {}) for data type "
                "ACHIEVEMENT_CRITERIA_DATA_TYPE_T_LEVEL ({}) has wrong minlevel in value1 ({}), ignored.",
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_T_GENDER:
    if (gender.gender > GENDER_NONE)
    {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` (Entry: {} Type: {}) for data type "
                "ACHIEVEMENT_CRITERIA_DATA_TYPE_T_GENDER ({}) has wrong gender in value1 ({}), ignored.",
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_SCRIPT:
    if (!ScriptId)
    {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` (Entry: {} Type: {}) for data type "
                "ACHIEVEMENT_CRITERIA_DATA_TYPE_SCRIPT ({}) does not have ScriptName set, ignored.",
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_MAP_DIFFICULTY:
    if (difficulty.difficulty >= MAX_DIFFICULTY)
    {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` (Entry: {} Type: {}) for data type "
                "ACHIEVEMENT_CRITERIA_DATA_TYPE_MAP_DIFFICULTY ({}) has wrong difficulty in value1 ({}), ignored.",
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_MAP_PLAYER_COUNT:
    if (map_players.maxcount <= 0)
    {
      LOG_ERROR(
          "sql.sql",
          "Table `achievement_criteria_data` (Entry: {} Type: {}) for data type "
          "ACHIEVEMENT_CRITERIA_DATA_TYPE_MAP_PLAYER_COUNT ({}) has wrong max players count in value1 ({}), ignored.",
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_T_TEAM:
    if (team.team != ALLIANCE && team.team != HORDE)
    {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` (Entry: {} Type: {}) for data type "
                "ACHIEVEMENT_CRITERIA_DATA_TYPE_T_TEAM ({}) has unknown team in value1 ({}), ignored.",
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_S_DRUNK:
    if (drunk.state >= MAX_DRUNKEN)
    {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` (Entry: {} Type: {}) for data type "
                "ACHIEVEMENT_CRITERIA_DATA_TYPE_S_DRUNK ({}) has unknown drunken state in value1 ({}), ignored.",
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_HOLIDAY:
    if (!sHolidaysStore.LookupEntry(holiday.id))
    {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` (Entry: {} Type: {}) for data type "
                "ACHIEVEMENT_CRITERIA_DATA_TYPE_HOLIDAY ({}) has unknown holiday in value1 ({}), ignored.",
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_S_ITEM_QUALITY:
    ...
    {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_requirement` (Entry: {} Type: {}) for requirement "
                "ACHIEVEMENT_CRITERIA_REQUIRE_S_EQUIPPED_ITEM ({}) has unknown quality state in value1 ({}), ignored.",
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_MAP_ID:
    if (!sMapStore.LookupEntry(map_id.mapId))
    {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_requirement` (Entry: {} Type: {}) for requirement "
                "ACHIEVEMENT_CRITERIA_DATA_TYPE_MAP_ID ({}) has unknown map id in value1 ({}), ignored.",
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_S_PLAYER_CLASS_RACE:
    if (!classRace.class_id && !classRace.race_id)
    {
      LOG_ERROR(
          "sql.sql",
          "Table `achievement_criteria_data` (Entry: {} Type: {}) for data type "
          "ACHIEVEMENT_CRITERIA_DATA_TYPE_S_PLAYER_CLASS_RACE ({}) must not have 0 in either value field, ignored.",
          criteria->ID, criteria->requiredType, dataType);
      return false;
    }
    if (classRace.class_id && ((1 << (classRace.class_id - 1)) & CLASSMASK_ALL_PLAYABLE) == 0)
    {
      LOG_ERROR(
          "sql.sql",
          "Table `achievement_criteria_data` (Entry: {} Type: {}) for data type "
          "ACHIEVEMENT_CRITERIA_DATA_TYPE_S_PLAYER_CLASS_RACE ({}) has non-existing class in value1 ({}), ignored.",
          criteria->ID, criteria->requiredType, dataType, classRace.class_id);
      return false;
    }
    if (classRace.race_id && ((1 << (classRace.race_id - 1)) & RACEMASK_ALL_PLAYABLE) == 0)
    {
      LOG_ERROR(
          "sql.sql",
          "Table `achievement_criteria_data` (Entry: {} Type: {}) for data type "
          "ACHIEVEMENT_CRITERIA_DATA_TYPE_S_PLAYER_CLASS_RACE ({}) has non-existing race in value2 ({}), ignored.",
          criteria->ID, criteria->requiredType, dataType, classRace.race_id);
      return false;
    }
    return true;
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_S_KNOWN_TITLE:
  {
    if (!sCharTitlesStore.LookupEntry(known_title.title_id))
    {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_requirement` (Entry: {} Type: {}) for requirement "
                "ACHIEVEMENT_CRITERIA_DATA_TYPE_S_KNOWN_TITLE ({}) have unknown title_id in value1 ({}), ignore.",
...
bool AchievementCriteriaData::Meets(uint32 criteria_id, Player const* source, Unit const* target,
                                    uint32 miscvalue1 /*= 0*/) const
{
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_INSTANCE_SCRIPT:
  {
    ...
    {
      LOG_ERROR("sql.sql",
                "Achievement system call ACHIEVEMENT_CRITERIA_DATA_TYPE_INSTANCE_SCRIPT ({}) for achievement criteria "
                "{} for non-dungeon/non-raid map {}",
    ...
    if (!instance)
    {
      LOG_ERROR("sql.sql",
                "Achievement system call ACHIEVEMENT_CRITERIA_DATA_TYPE_INSTANCE_SCRIPT ({}) for achievement criteria "
                "{} for map {} but map does not have a instance script",
                ACHIEVEMENT_CRITERIA_DATA_TYPE_INSTANCE_SCRIPT, criteria_id, map->GetId());
      return false;
    }
...
void AchievementMgr::Reset()
{
  for (CompletedAchievementMap::const_iterator iter = _completedAchievements.begin();
       iter != _completedAchievements.end(); ++iter)
  {
...
void AchievementMgr::ResetAchievementCriteria(AchievementCriteriaCondition condition, uint32 value,
                                              bool evenIfCriteriaComplete)
{
  ...
  LOG_DEBUG("achievement", "AchievementMgr::ResetAchievementCriteria({}, {}, {})", condition, value,
...
void AchievementMgr::SaveToDB(CharacterDatabaseTransaction trans)
{
  ...
  {
    for (CompletedAchievementMap::iterator iter = _completedAchievements.begin(); iter != _completedAchievements.end();
         ++iter)
    {
  ...
  if (!_criteriaProgress.empty())
  {
    for (CriteriaProgressMap::iterator iter = _criteriaProgress.begin(); iter != _criteriaProgress.end(); ++iter)
    {
      ...
      // pussywizard: insert only for (counter != 0) is very important! this is how criteria of completed achievements
      // gets deleted from db (by setting counter to 0); if conflicted during merge - contact me
    ...
    do
    {
      ...
      if (!criteria)
      {
        ...
        LOG_ERROR("achievement",
                  "Non-existing achievement criteria {} data removed from table `character_achievement_progress`.", id);
...
void AchievementMgr::SendAchievementEarned(AchievementEntry const* achievement) const
{
  ...
  if (guild)
  {
    Acore::BroadcastTextBuilder _builder(GetPlayer(), CHAT_MSG_GUILD_ACHIEVEMENT, BROADCAST_TEXT_ACHIEVEMENT_EARNED,
                                         GetPlayer()->getGender(), GetPlayer(), achievement->ID);
  ...
  else if (GetPlayer()->IsInWorld())
  {
    ...
    Acore::BroadcastTextBuilder _builder(GetPlayer(), CHAT_MSG_ACHIEVEMENT, BROADCAST_TEXT_ACHIEVEMENT_EARNED,
                                         GetPlayer()->getGender(), GetPlayer(), achievement->ID);
    Acore::LocalizedPacketDo<Acore::BroadcastTextBuilder>                          _localizer(_builder);
...
/**
 * called at player login. The player might have fulfilled some achievements when the achievement system wasn't working
 * yet.
 */
...
static const uint32 achievIdForDungeon[][4]             = {
    ...
    {321, true, true, true},   {916, false, true, false},  {917, false, true, false},
    {918, true, false, false}, {2219, false, false, true}, {0, false, false, false}};

/**
 * this function will be called whenever the user might have done a criteria relevant action
 */
void AchievementMgr::UpdateAchievementCriteria(AchievementCriteriaTypes type, uint32 miscValue1 /*= 0*/,
                                               uint32 miscValue2 /*= 0*/, Unit* unit /*= nullptr*/)
{
  // disable for gamemasters with GM-mode enabled
  if (_player->IsGameMaster())
    return;
       ...
       i != achievementCriteriaList->end(); ++i)
  {
    ...
    case ACHIEVEMENT_CRITERIA_TYPE_COMPLETE_ACHIEVEMENT:
      if ((miscValue1 && achievementCriteria->complete_achievement.linkedAchievement == miscValue1) ||
          (!miscValue1 && GetPlayer()->HasAchieved(achievementCriteria->complete_achievement.linkedAchievement)))
    ...
    case ACHIEVEMENT_CRITERIA_TYPE_LEARN_SKILLLINE_SPELLS:
    {
           ...
           spellIter != GetPlayer()->GetSpellMap().end(); ++spellIter)
      {
        ...
        for (SkillLineAbilityMap::const_iterator skillIter = bounds.first; skillIter != bounds.second; ++skillIter)
        {
          ...
          {
            // xinef: do not add couter twice if by any chance skill is listed twice in dbc (eg. skill 777 and spell
            // 22717)
            ++spellCount;
            break;
          }
    ...
    case ACHIEVEMENT_CRITERIA_TYPE_EARN_ACHIEVEMENT_POINTS:
    {
      if (!miscValue1)
      {
        ...
        for (CompletedAchievementMap::iterator itr = _completedAchievements.begin();
             itr != _completedAchievements.end(); ++itr)
                                         ...
                                         AchievementEntry const*         achievement)
{
  ...
  // finished achievement should indicate criteria completed, since not finding progress would start some timed
  // achievements and probably other things
...
bool AchievementMgr::IsCompletedAchievement(AchievementEntry const* entry)
{
  ...
  for (AchievementCriteriaEntryList::const_iterator itr = cList->begin(); itr != cList->end(); ++itr)
  {
    ...
    // found an uncompleted criteria, but DONT return false yet - there might be a completed criteria with
...
void AchievementMgr::SetCriteriaProgress(AchievementCriteriaEntry const* entry, uint32 changeValue, ProgressType ptype)
{
  ...
  LOG_DEBUG("achievement", "AchievementMgr::SetCriteriaProgress({}, {}) for {}", entry->ID, changeValue,
...
void AchievementMgr::SendAllAchievementData() const
{
  WorldPacket data(SMSG_ALL_ACHIEVEMENT_DATA,
                   _completedAchievements.size() * 8 + 4 + _criteriaProgress.size() * 38 + 4);
...
CompletedAchievementMap const& AchievementMgr::GetCompletedAchievements() { return _completedAchievements; }
...
void AchievementMgr::ProcessOfflineUpdate(AchievementOfflinePlayerUpdate const& update)
{
  ...
  case ACHIEVEMENT_OFFLINE_PLAYER_UPDATE_TYPE_COMPLETE_ACHIEVEMENT:
  {
    ...
    ASSERT(achievement, "Not found achievement to complete for offline achievements update. Wrong arg1 ({}) value?",
           update.arg1);
  ...
  default:
    ASSERT(false, "Unknown offline achievement update type ({}) for player - {}", update.updateType,
...
void AchievementGlobalMgr::LoadAchievementCriteriaList()
{
  ...
  for (uint32 entryId = 0; entryId < sAchievementCriteriaStore.GetNumRows(); ++entryId)
  {
    ...
    {
      LOG_DEBUG("server.loading", "Achievement {} referenced by criteria {} doesn't exist, criteria not loaded.",
                criteria->referredAchievement, criteria->ID);
      continue;
    }
...
void AchievementGlobalMgr::LoadAchievementCriteriaData()
{
  ...
  do
  {
    ...
    if (!criteria)
    {
      LOG_ERROR("sql.sql", "Table `achievement_criteria_data` has data for non-existing criteria (Entry: {}), ignore.",
                criteria_id);
      continue;
    }
    ...
    if (scriptName.length()) // not empty
    {
      if (dataType != ACHIEVEMENT_CRITERIA_DATA_TYPE_SCRIPT)
        LOG_ERROR("sql.sql",
                  "Table `achievement_criteria_data` has ScriptName set for non-scripted data type (Entry: {}, type "
                  "{}), useless data.",
  ...
  for (uint32 entryId = 0; entryId < sAchievementCriteriaStore.GetNumRows(); ++entryId)
  {
    ...
    if (!GetCriteriaDataSet(criteria) &&
      ...
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` does not have expected data for criteria (Entry: {} Type: {}) for "
                "achievement {}.",
                criteria->ID, criteria->requiredType, criteria->referredAchievement);
  }

  LOG_INFO("server.loading", ">> Loaded {} additional achievement criteria data in {} ms", count,
...
void AchievementGlobalMgr::LoadCompletedAchievements()
{
  ...
  do
  {
    ...
    if (!achievement)
    {
      ...
      LOG_ERROR("achievement", "Non-existing achievement {} data removed from table `character_achievement`.",
                achievementId);
  ...
  LOG_INFO("server.loading", ">> Loaded {} completed achievements in {} ms",
           (unsigned long)_allCompletedAchievements.size(), GetMSTimeDiffToNow(oldMSTime));
  LOG_INFO("server.loading", " ");
}
...
void AchievementGlobalMgr::LoadRewards()
{
  ...
  do
  {
    ...
    {
      LOG_ERROR("sql.sql",
                "Table `achievement_reward` (Entry: {}) does not have any title or item reward data. Ignoring.", entry);
      continue;
    }

    if (achievement->requiredFaction == ACHIEVEMENT_FACTION_ANY && (!reward.titleId[0] ^ !reward.titleId[1]))
      LOG_DEBUG("achievement", "Table `achievement_reward` (Entry: {}) has title (A: {} H: {}) set for only one team.",
    ...
    if (reward.sender)
    {
      ...
      {
        LOG_ERROR("sql.sql",
                  "Table `achievement_reward` (Entry: {}) has invalid creature_template entry {} as Sender. Will not "
                  "send the mail reward.",
                  entry, reward.sender);
        reward.sender = 0;
      }
    }
    else
    {
      if (reward.itemId)
        LOG_ERROR("sql.sql",
                  "Table `achievement_reward` (Entry: {}) has itemId reward set but does not have Sender data set. "
                  "Item will not be sent.",
                  entry);
    ...
    if (reward.mailTemplate)
    {
      ...
      {
        LOG_ERROR("sql.sql", "Table `achievement_reward` (Entry: {}) has invalid mailTemplate ({}) (check the DBC).",
                  entry, reward.mailTemplate);
        reward.mailTemplate = 0;
      }
      else if (!reward.subject.empty() || !reward.text.empty())
        LOG_ERROR("sql.sql",
                  "Table `achievement_reward` (Entry: {}) has mailTemplate ({}) and mail Subject/Body. To use the "
                  "column mailTemplate, Subject and Body must be empty.",
                  entry, reward.mailTemplate);
    }
    ...
    if (reward.itemId)
    {
      ...
      {
        // Not sure it's an error, it's probably an outDebug instead, because we can simply send a mail with no reward,
        // right?
        LOG_ERROR("sql.sql",
                  "Table `achievement_reward` (Entry: {}) has invalid item_template id {}. Reward mail will not "
                  "contain any item.",
                  entry, reward.itemId);
        reward.itemId = 0;
      }
...
void AchievementGlobalMgr::LoadRewardLocales()
{
  ...
  LOG_INFO("server.loading", ">> Loaded {} Achievement Reward Locale Strings in {} ms",
           (unsigned long)_achievementRewardLocales.size(), GetMSTimeDiffToNow(oldMSTime));
  LOG_INFO("server.loading", " ");
}
...
void AchievementGlobalMgr::UpdateAchievementCriteriaForOfflinePlayer(ObjectGuid::LowType      playerLowGuid,
                                                                     AchievementCriteriaTypes type, uint32 miscValue1,
                                                                     uint32 miscValue2)
{
  CharacterDatabasePreparedStatement* stmt =
      CharacterDatabase.GetPreparedStatement(CHAR_INS_CHAR_ACHIEVEMENT_OFFLINE_UPDATES);
