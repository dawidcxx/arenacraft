...
void WorldSession::HandleBankerActivateOpcode(WorldPacket& recvData)
{
  ...
  if (!unit)
  {
    LOG_DEBUG("network", "WORLD: HandleBankerActivateOpcode - Unit ({}) not found or you can not interact with him.",
              guid.ToString());
    return;
  }
...
void WorldSession::HandleAutoBankItemOpcode(WorldPackets::Bank::AutoBankItem& packet)
{
  ...
  if (!CanUseBank())
  {
    LOG_DEBUG("network", "WORLD: HandleAutoBankItemOpcode - Unit ({}) not found or you can't interact with him.",
...
void WorldSession::HandleAutoStoreBankItemOpcode(WorldPackets::Bank::AutoStoreBankItem& packet)
{
  ...
  if (!CanUseBank())
  {
    LOG_DEBUG("network", "WORLD: HandleAutoStoreBankItemOpcode - Unit ({}) not found or you can't interact with him.",
              m_currentBankerGUID.ToString());
    return;
  }
...
void WorldSession::HandleBuyBankSlotOpcode(WorldPackets::Bank::BuyBankSlot& buyBankSlot)
{
  ...
  if (!CanUseBank(buyBankSlot.Banker))
  {
    ...
    LOG_DEBUG("network", "WORLD: HandleBuyBankSlotOpcode - {} not found or you can't interact with him.",
