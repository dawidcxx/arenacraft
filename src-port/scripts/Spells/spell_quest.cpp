...
class spell_q11065_wrangle_some_aether_rays : public SpellScript
{
  ...
  void Register() override { OnCheckCast += SpellCheckCastFn(spell_q11065_wrangle_some_aether_rays::CheckCast); }
};

class spell_q11065_wrangle_some_aether_rays_aura : public AuraScript
{
  PrepareAuraScript(spell_q11065_wrangle_some_aether_rays_aura) void HandleEffectRemove(AuraEffect const* /*aurEff*/,
                                                                                        AuraEffectHandleModes /*mode*/)
  {
    ...
    if (ar && ar->ToCreature())
    {
      if (GetCaster() && GetCaster()->ToPlayer())
      {
        ...
        if (Creature* cr =
                GetCaster()->SummonCreature(23343, ar->GetPositionX(), ar->GetPositionY(), ar->GetPositionZ(),
                                            ar->GetOrientation(), TEMPSUMMON_TIMED_DESPAWN, 180000))
        {
  ...
  void HandleEffectApply(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/) { SetDuration(5000); }

  void Register() override
  {
    OnEffectApply += AuraEffectApplyFn(spell_q11065_wrangle_some_aether_rays_aura::HandleEffectApply, EFFECT_0,
                                       SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
    OnEffectRemove += AuraEffectRemoveFn(spell_q11065_wrangle_some_aether_rays_aura::HandleEffectRemove, EFFECT_0,
                                         SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
  }
};
...
class spell_q12014_steady_as_a_rock : public SpellScript
{
  ...
  void Register() override { AfterCast += SpellCastFn(spell_q12014_steady_as_a_rock::HandleFinish); }
};
...
class spell_q11026_a11051_banish_the_demons_aura : public AuraScript
{
  ...
  void Register() override
  {
    ...
    if (m_scriptSpellId == 40825)
      OnEffectRemove += AuraEffectRemoveFn(spell_q11026_a11051_banish_the_demons_aura::HandleEffectRemove, EFFECT_0,
                                           SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
  }
};
...
class spell_q11026_a11051_banish_the_demons : public SpellScript
{
  ...
  void Register() override
  {
    ...
    if (m_scriptSpellId == 40828)
      OnEffectHitTarget += SpellEffectFn(spell_q11026_a11051_banish_the_demons::HandleScriptEffect, EFFECT_0,
...
class spell_q10525_vision_guide : public AuraScript
{
  ...
  void Register() override
  {
    OnEffectApply += AuraEffectApplyFn(spell_q10525_vision_guide::HandleEffectApply, EFFECT_0, SPELL_AURA_TRANSFORM,
                                       AURA_EFFECT_HANDLE_REAL);
    AfterEffectRemove += AuraEffectRemoveFn(spell_q10525_vision_guide::HandleEffectRemove, EFFECT_0,
...
class spell_q11322_q11317_the_cleansing : public AuraScript
{
  ...
  void Register() override
  {
    OnEffectApply += AuraEffectApplyFn(spell_q11322_q11317_the_cleansing::HandleEffectApply, EFFECT_0, SPELL_AURA_DUMMY,
                                       AURA_EFFECT_HANDLE_REAL);
  }
};
...
class spell_q10769_dissension_amongst_the_ranks_aura : public AuraScript
{
  ...
  void Register() override
  {
    ...
    {
      OnEffectApply += AuraEffectApplyFn(spell_q10769_dissension_amongst_the_ranks_aura::HandleEffectApply, EFFECT_0,
                                         SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
      OnEffectRemove += AuraEffectRemoveFn(spell_q10769_dissension_amongst_the_ranks_aura::HandleEffectRemove, EFFECT_0,
                                           SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
    }
  }
};
...
class spell_q10769_dissension_amongst_the_ranks : public SpellScript
{
  ...
  void Register() override
  {
    if (m_scriptSpellId == 38223)
      OnEffectHitTarget += SpellEffectFn(spell_q10769_dissension_amongst_the_ranks::HandleScriptEffect, EFFECT_0,
                                         SPELL_EFFECT_SCRIPT_EFFECT);
  }
};
...
class spell_quest_test_flight_charging : public AuraScript
{
  ...
  void HandleEffectPeriodicSelf(AuraEffect const* aurEff)
  {
    ...
    {
      GetTarget()->SummonCreature(NPC_CANNON_TARGET, 1919.99f, 5581.97f, 272.30f, 5.27f, TEMPSUMMON_TIMED_DESPAWN,
                                  12000);
  ...
  void Register() override
  {
    ...
    {
      OnEffectApply += AuraEffectApplyFn(spell_quest_test_flight_charging::OnApplySelf, EFFECT_0,
                                         SPELL_AURA_PERIODIC_TRIGGER_SPELL, AURA_EFFECT_HANDLE_REAL);
      OnEffectPeriodic += AuraEffectPeriodicFn(spell_quest_test_flight_charging::HandleEffectPeriodicSelf, EFFECT_0,
                                               SPELL_AURA_PERIODIC_TRIGGER_SPELL);
    }
    else
      OnEffectPeriodic += AuraEffectPeriodicFn(spell_quest_test_flight_charging::HandleEffectPeriodicPlatform, EFFECT_0,
                                               SPELL_AURA_PERIODIC_TRIGGER_SPELL);
  }
};
      ...
      void HandleScript(SpellEffIndex effIndex)
  {
    ...
    if (Unit* unit = GetHitUnit())
      if (unit->IsImmuneToPC())
        return;
    GetCaster()->CastCustomSpell(42576 /*SPELL_CANNON_BLAST*/, SPELLVALUE_BASE_POINT0, GetEffectValue(), GetCaster(),
                                 true);
  }
...
class spell_q10985_light_of_the_naaru : public AuraScript
{
  ...
  void Register() override { DoCheckProc += AuraCheckProcFn(spell_q10985_light_of_the_naaru::CheckProc); }
};
...
public:
  ...
  {
    return new spell_generic_quest_update_entry_SpellScript(SPELL_EFFECT_DUMMY, EFFECT_1, NPC_MORBENT,
                                                            NPC_WEAKENED_MORBENT, true);
  }
};
...
class spell_q2203_thaumaturgy_channel : public AuraScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override { return ValidateSpellInfo({SPELL_THAUMATURGY_CHANNEL}); }
  ...
  void Register() override
  {
    OnEffectPeriodic += AuraEffectPeriodicFn(spell_q2203_thaumaturgy_channel::HandleEffectPeriodic, EFFECT_0,
                                             SPELL_AURA_PERIODIC_TRIGGER_SPELL);
  }
};
...
class spell_q11396_11399_force_shield_arcane_purple_x3 : public AuraScript
{
  ...
  void Register() override
  {
    OnEffectApply += AuraEffectApplyFn(spell_q11396_11399_force_shield_arcane_purple_x3::HandleEffectApply, EFFECT_0,
                                       SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
    OnEffectRemove += AuraEffectRemoveFn(spell_q11396_11399_force_shield_arcane_purple_x3::HandleEffectRemove, EFFECT_0,
                                         SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
  }
};
...
class spell_q11396_11399_scourging_crystal_controller_dummy : public SpellScript
{
  ...
  {
    OnEffectHitTarget +=
        SpellEffectFn(spell_q11396_11399_scourging_crystal_controller_dummy::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
  }
};
...
public:
  ...
  SpellScript* GetSpellScript() const override
  {
    return new spell_generic_quest_update_entry_SpellScript(SPELL_EFFECT_DUMMY, EFFECT_0, NPC_FELBLOOD_INITIATE,
...
class spell_q11587_arcane_prisoner_rescue : public SpellScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override
  {
    return ValidateSpellInfo(
        {SPELL_SUMMON_ARCANE_PRISONER_MALE, SPELL_SUMMON_ARCANE_PRISONER_FEMALE, SPELL_ARCANE_PRISONER_KILL_CREDIT});
  }
...
class spell_q11730_ultrasonic_screwdriver : public SpellScript
{
  ...
  bool Load() override { return GetCaster()->IsPlayer() && GetCastItem(); }

  bool Validate(SpellInfo const* /*spellInfo*/) override
  {
    return ValidateSpellInfo({SPELL_SUMMON_SCAVENGEBOT_004A8, SPELL_SUMMON_SENTRYBOT_57K, SPELL_SUMMON_DEFENDOTANK_66D,
                              SPELL_SUMMON_SCAVENGEBOT_005B6, SPELL_SUMMON_55D_COLLECTATRON, SPELL_ROBOT_KILL_CREDIT});
  }
...
class spell_q12634_despawn_fruit_tosser : public SpellScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override
  {
    return ValidateSpellInfo({SPELL_BANANAS_FALL_TO_GROUND, SPELL_ORANGE_FALLS_TO_GROUND, SPELL_PAPAYA_FALLS_TO_GROUND,
...
class spell_q12851_going_bearback : public AuraScript
{
  ...
  void Register() override
  {
    AfterEffectApply += AuraEffectApplyFn(spell_q12851_going_bearback::HandleEffectApply, EFFECT_0,
...
class spell_q14112_14145_chum_the_water : public SpellScript
{
  ...
  {
    Unit* caster = GetCaster();
    caster->CastSpell(caster, RAND(SUMMON_ANGRY_KVALDIR, SUMMON_NORTH_SEA_MAKO, SUMMON_NORTH_SEA_THRESHER,
...
class spell_q12987_read_pronouncement : public AuraScript
{
  ...
  void OnApply(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
  {
    ...
    if (Player* target = GetTarget()->ToPlayer())
    {
      ...
      {
        sCreatureTextMgr->SendChat(trigger, SAY_1, target, CHAT_MSG_ADDON, LANG_ADDON, TEXT_RANGE_NORMAL, 0,
                                   TEAM_NEUTRAL, false, target);
        target->KilledMonsterCredit(NPC_KILLCREDIT);
        sCreatureTextMgr->SendChat(trigger, SAY_2, target, CHAT_MSG_ADDON, LANG_ADDON, TEXT_RANGE_NORMAL, 0,
                                   TEAM_NEUTRAL, false, target);
      }
    }
  }
  ...
  {
    AfterEffectApply +=
        AuraEffectApplyFn(spell_q12987_read_pronouncement::OnApply, EFFECT_0, SPELL_AURA_NONE, AURA_EFFECT_HANDLE_REAL);
  }
};
...
class spell_q11010_q11102_q11023_aggro_check_aura : public AuraScript
{
  ...
  void Register() override
  {
    OnEffectPeriodic += AuraEffectPeriodicFn(spell_q11010_q11102_q11023_aggro_check_aura::HandleTriggerSpell, EFFECT_0,
                                             SPELL_AURA_PERIODIC_TRIGGER_SPELL);
  }
};
...
class spell_q11010_q11102_q11023_aggro_burst : public AuraScript
{
  ...
  void Register() override
  {
    OnEffectPeriodic += AuraEffectPeriodicFn(spell_q11010_q11102_q11023_aggro_burst::HandleEffectPeriodic, EFFECT_0,
...
class spell_q12730_quenching_mist : public AuraScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override { return ValidateSpellInfo({SPELL_FLICKERING_FLAMES}); }
...
class spell_q13291_q13292_q13239_q13261_frostbrood_skytalon_grab_decoy : public SpellScript
{
  ...
  bool Validate(SpellInfo const* /*spell*/) override { return ValidateSpellInfo({SPELL_RIDE}); }
  ...
  void Register() override
  {
    OnEffectHitTarget += SpellEffectFn(spell_q13291_q13292_q13239_q13261_frostbrood_skytalon_grab_decoy::HandleDummy,
...
class spell_q13291_q13292_q13239_q13261_armored_decoy_summon_skytalon : public SpellScript
{
  ...
  {
    OnDestinationTargetSelect += SpellDestinationTargetSelectFn(
        spell_q13291_q13292_q13239_q13261_armored_decoy_summon_skytalon::SetDest, EFFECT_0, TARGET_DEST_CASTER_BACK);
  }
};
...
class spell_q12690_burst_at_the_seams : public SpellScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override
  {
    return ValidateSpellInfo({SPELL_BURST_AT_THE_SEAMS, SPELL_BURST_AT_THE_SEAMS_DMG, SPELL_BURST_AT_THE_SEAMS_DMG_2,
                              SPELL_BURST_AT_THE_SEAMS_BONE, SPELL_BURST_AT_THE_SEAMS_MEAT,
  ...
  void HandleScript(SpellEffIndex /*effIndex*/) { GetCaster()->ToCreature()->DespawnOrUnsummon(2 * IN_MILLISECONDS); }
...
class spell_q12308_escape_from_silverbrook : public SpellScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override { return ValidateSpellInfo({SPELL_SUMMON_WORGEN}); }

  void HandleDummy(SpellEffIndex /*effIndex*/) { GetCaster()->CastSpell(GetCaster(), SPELL_SUMMON_WORGEN, true); }
...
class spell_q12619_emblazon_runeblade : public AuraScript
{
  ...
  void Register() override
  {
    OnEffectPeriodic += AuraEffectPeriodicFn(spell_q12619_emblazon_runeblade::HandleEffectPeriodic, EFFECT_0,
                                             SPELL_AURA_PERIODIC_TRIGGER_SPELL);
  }
};
...
class spell_q12919_gymers_grab : public SpellScript
{
  ...
  bool Validate(SpellInfo const* /*spell*/) override { return ValidateSpellInfo({SPELL_RIDE_GYMER}); }
...
class spell_q9718_crow_transform : public AuraScript
{
  ...
  void Register() override
  {
    OnEffectRemove += AuraEffectRemoveFn(spell_q9718_crow_transform::HandleEffectRemove, EFFECT_0, SPELL_AURA_TRANSFORM,
...
class spell_q5056_summon_shy_rotam : public SpellScript
{
  ...
  void HandleFinish()
  {
    ...
    if (Creature* summon = GetCaster()->SummonCreature(NPC_SHY_ROTAM, shyRotamSpawnPosition, TEMPSUMMON_TIMED_DESPAWN,
  ...
  void Register() override { AfterCast += SpellCastFn(spell_q5056_summon_shy_rotam::HandleFinish); }
};
...
void AddSC_quest_spell_scripts()
{
  ...
  RegisterSpellAndAuraScriptPair(spell_q10769_dissension_amongst_the_ranks,
