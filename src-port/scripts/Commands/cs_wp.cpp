...
public:
  ...
  {
    static ChatCommandTable wpCommandTable = {{"add", HandleWpAddCommand, SEC_ADMINISTRATOR, Console::No},
    ...
    static ChatCommandTable commandTable   = {{"wp", wpCommandTable}};
    return commandTable;
  }
  /**
  ...
  static bool HandleWpAddCommand(ChatHandler* handler, const char* args)
  {
    ...
    handler->PSendSysMessage("{}{}{}{}{}{}|r", "|cff00ff00", "PathID: |r|cff00ffff", pathid,
  ...
  static bool HandleWpEventCommand(ChatHandler* handler, const char* args)
  {
    ...
    if (show == "listid")
    {
      ...
      do
      {
        ...
        handler->PSendSysMessage(
            "|cffff33ffid:|r|cff00ffff {}|r|cff00ff00, guid: |r|cff00ffff{}|r|cff00ff00, delay: "
            "|r|cff00ffff{}|r|cff00ff00, command: |r|cff00ffff{}|r|cff00ff00, datalong: |r|cff00ffff{}|r|cff00ff00, "
            "datalong2: |r|cff00ffff{}|r|cff00ff00, datatext: |r|cff00ffff{}|r|cff00ff00, posx: "
            "|r|cff00ffff{}|r|cff00ff00, posy: |r|cff00ffff{}|r|cff00ff00, posz: |r|cff00ffff{}|r|cff00ff00, "
            "orientation: |r|cff00ffff{}|r",
    ...
    if (show == "mod")
    {
      ...
      if (arg_str_2 == "setid")
      {
        ...
        handler->PSendSysMessage("{}{}|r|cff00ffff{}|r|cff00ff00{}|r|cff00ffff{}|r", "|cff00ff00",
      ...
      else
      {
        ...
        {
          WorldDatabase.Execute("UPDATE waypoint_scripts SET {}='{}' WHERE guid='{}'", arg_2, atoi(arg_3),
        ...
        else
        {
          ...
          WorldDatabase.Execute("UPDATE waypoint_scripts SET {}='{}' WHERE guid='{}'", arg_2, arg_str_3,
                                id); // Query can't be a prepared statement
        }
      }
      handler->PSendSysMessage("{}{}|r|cff00ffff{}:|r|cff00ff00 {} {}|r", "|cff00ff00", "Waypoint script:", id, arg_2,
                               "updated.");
    }
    return true;
  }
  ...
  static bool HandleWpModifyCommand(ChatHandler* handler, const char* args)
  {
    ...
    if (show == "move")
    {
      ...
      Map*    map = chr->GetMap();
      {
        ...
        if (wpSpawnId != 0)
        {
          ...
          if (!wpCreature2->Create(map->GenerateLowGuid<HighGuid::Unit>(), map, chr->GetPhaseMaskForSpawn(),
                                   VISUAL_WAYPOINT, 0, chr->GetPositionX(), chr->GetPositionY(), chr->GetPositionZ(),
                                   chr->GetOrientation()))
          {
    ...
    if (text == 0)
    {
      ...
      WorldDatabase.Execute("UPDATE waypoint_data SET {}=nullptr WHERE id='{}' AND point='{}'", show_str, pathid,
    ...
    else
    {
      ...
      WorldDatabase.Execute("UPDATE waypoint_data SET {}='{}' WHERE id='{}' AND point='{}'", show_str, text2, pathid,
                            point); // Query can't be a prepared statement
    }
  ...
  static bool HandleWpShowCommand(ChatHandler* handler, const char* args)
  {
    ...
    if (show == "info")
    {
      ...
      do
      {
        ...
        handler->PSendSysMessage(
            "|cff00ff00Show info: for current point: |r|cff00ffff{}|r|cff00ff00, Path ID: |r|cff00ffff{}|r", point,
            pathid);
    ...
    if (show == "on")
    {
      ...
      do
      {
        ...
        if (!wpCreature->Create(map->GenerateLowGuid<HighGuid::Unit>(), map, chr->GetPhaseMaskForSpawn(), id, 0, x, y,
                                z, o))
        {
    ...
    if (show == "first")
    {
      ...
      if (!creature->Create(map->GenerateLowGuid<HighGuid::Unit>(), map, chr->GetPhaseMaskForSpawn(), id, 0, x, y, z,
                            o))
      {
        handler->PSendSysMessage(LANG_WAYPOINT_VP_NOTCREATED, id);
        delete creature;
