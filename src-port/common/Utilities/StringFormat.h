...
template <typename... Args> inline std::string StringFormat(FormatString<Args...> fmt, Args&&... args)
{
  try
  {
...
{
template <class Str> AC_COMMON_API Str Trim(const Str& s, const std::locale& loc = std::locale());
