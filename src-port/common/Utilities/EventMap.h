...
public:
   ...
   */
  void Update(Milliseconds time) { _time += static_cast<uint32>(time.count()); }
   ...
   * @param group The group which the event is associated to. Has to be between
   * 1 and 8. 0 means it has no group.
