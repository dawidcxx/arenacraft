...
[[nodiscard]] inline float getSlopeAngle(float startX, float startY, float startZ, float destX, float destY,
                                         float destZ)
{
...
[[nodiscard]] inline float getSlopeAngleAbs(float startX, float startY, float startZ, float destX, float destY,
                                            float destZ)
{
  return std::abs(getSlopeAngle(startX, startY, startZ, destX, destY, destZ));
}

[[nodiscard]] inline double getCircleAreaByRadius(double radius) { return radius * radius * M_PI; }

[[nodiscard]] inline double getCirclePerimeterByRadius(double radius) { return radius * M_PI; }
