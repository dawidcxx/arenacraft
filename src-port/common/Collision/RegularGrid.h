...
template <class Node> class NodeArray
{
public:
...
#define CELL_SIZE      float(HGRID_MAP_SIZE / (float)CELL_NUMBER)
                    ...
                    bool stopAtFirstHit)
  {
    ...
    // int Cycles =
    // std::max((int)ceilf(max_dist/tMaxX),(int)ceilf(max_dist/tMaxY)); int i =
    // 0;
  ...
  template <typename IsectCallback> void intersectPoint(const G3D::Vector3& point, IsectCallback& intersectCallback)
  {
