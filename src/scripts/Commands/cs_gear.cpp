...
public:
  ...
  {
    static ChatCommandTable gearCommandTable = {{"repair", HandleGearRepairCommand, SEC_GAMEMASTER, Console::No},
  ...
  static bool HandleGearStatsCommand(ChatHandler* handler)
  {
    ...
    handler->PSendSysMessage("Current equipment average item level: |cff00ffff{}|r",
