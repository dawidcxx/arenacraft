...
public:
  ...
  ChatCommandTable GetCommands() const override
  {
    ...
    static ChatCommandTable commandTable = {{"debug", debugCommandTable},
  ...
  static bool HandleDebugPlayCinematicCommand(ChatHandler* handler, uint32 cinematicId)
  {
    ...
    if (std::vector<FlyByCamera> const* flyByCameras = GetFlyByCameras(cineSeq->cinematicCamera))
    {
      ...
      {
        handler->PSendSysMessage("{} - {}ms [{} ({} degrees)]", count, cam.timeStamp, cam.locations.ToString(),
  ...
  static bool HandleDebugSendSpellFailCommand(ChatHandler* handler, SpellCastResult result, Optional<uint32> failArg1,
  ...
  {
    WorldPacket data;
    ChatHandler::BuildChatPacket(data, type, LANG_UNIVERSAL, handler->GetPlayer(), handler->GetPlayer(), "testtest", 0,
                                 "chan");
    handler->GetSession()->SendPacket(&data);
    return true;
  }
  ...
  static bool HandleDebugGetLootRecipientCommand(ChatHandler* handler)
  {
    ...
    handler->PSendSysMessage("Loot recipient for creature {} (GUID {}, SpawnID {}) is {}", target->GetName(),
                             target->GetGUID().ToString(), target->GetSpawnId(),
  ...
  static bool HandleDebugGetItemStateCommand(ChatHandler* handler, std::string itemState)
  {
            ...
            for (uint8 j = 0; j < bag->GetBagSize(); ++j)
              if (Item* item2 = bag->GetItemByPos(j))
                if (item2->GetState() == state)
                  handler->PSendSysMessage("bag: 255 slot: {} {} owner: {}", item2->GetSlot(),
                                           item2->GetGUID().ToString(), item2->GetOwnerGUID().ToString());
          }
          else if (item->GetState() == state)
            handler->PSendSysMessage("bag: 255 slot: {} {} owner: {}", item->GetSlot(), item->GetGUID().ToString(),
    ...
    if (listQueue)
    {
      ...
      for (auto const& item : updateQueue)
      {
        ...
        handler->PSendSysMessage("bag: {} slot: {} guid: {} - state: {}", bagSlot, item->GetSlot(),
                                 item->GetGUID().ToString(), st);
      }
    ...
    if (checkAll)
    {
      ...
      for (uint8 i = PLAYER_SLOT_START; i < PLAYER_SLOT_END; ++i)
      {
        ...
        if (item->GetSlot() != i)
        {
          handler->PSendSysMessage("Item with slot {} and guid {} has an incorrect slot value: {}", i,
                                   item->GetGUID().ToString(), item->GetSlot());
          error = true;
          continue;
        }
        ...
        if (item->GetOwnerGUID() != player->GetGUID())
        {
          handler->PSendSysMessage("The item with slot {} {} does have non-matching owner guid {} and {}!",
                                   item->GetSlot(), item->GetGUID().ToString(), item->GetOwnerGUID().ToString(),
        ...
        if (Bag* container = item->GetContainer())
        {
          handler->PSendSysMessage("The item with slot {} {} has a container (slot: {}, {}) but shouldn't!",
                                   item->GetSlot(), item->GetGUID().ToString(), container->GetSlot(),
        ...
        if (item->IsInUpdateQueue())
        {
          ...
          if (qp > updateQueue.size())
          {
            handler->PSendSysMessage(
                ...
                item->GetSlot(), item->GetGUID().ToString(), qp);
            error = true;
            continue;
          }
          ...
          {
            handler->PSendSysMessage("The item with slot {} and guid {} has a queuepos ({}) that points to another "
                                     "item in the queue (bag: {}, slot: {}, guid: {})",
                                     item->GetSlot(), item->GetGUID().ToString(), qp, updateQueue[qp]->GetBagSlot(),
                                     updateQueue[qp]->GetSlot(), updateQueue[qp]->GetGUID().ToString());
            error = true;
            continue;
          }
        }
        ...
        {
          handler->PSendSysMessage("The item with slot {} and guid {} is not in queue but should be (state: {})!",
                                   item->GetSlot(), item->GetGUID().ToString(), item->GetState());
          error = true;
          continue;
        }
        ...
        if (Bag* bag = item->ToBag())
        {
          for (uint8 j = 0; j < bag->GetBagSize(); ++j)
          {
            ...
            if (item2->GetSlot() != j)
            {
              handler->PSendSysMessage("The item in bag {} and slot {} (guid: {}) has an incorrect slot value: {}",
                                       bag->GetSlot(), j, item2->GetGUID().ToString(), item2->GetSlot());
              error = true;
              continue;
            }
            ...
            if (item2->GetOwnerGUID() != player->GetGUID())
            {
              handler->PSendSysMessage(
                  ...
                  bag->GetSlot(), item2->GetSlot(), item2->GetGUID().ToString(), item2->GetOwnerGUID().ToString(),
                  player->GetGUID().ToString());
              error = true;
              continue;
            }
            ...
            if (!container)
            {
              handler->PSendSysMessage("The item in bag {} at slot {} {} has no container!", bag->GetSlot(),
                                       item2->GetSlot(), item2->GetGUID().ToString());
              error = true;
              continue;
            }
            ...
            if (container != bag)
            {
              handler->PSendSysMessage("The item in bag {} at slot {} {} has a different container(slot {} {})!",
                                       bag->GetSlot(), item2->GetSlot(), item2->GetGUID().ToString(),
                                       container->GetSlot(), container->GetGUID().ToString());
              error = true;
              continue;
            }
            ...
            if (item2->IsInUpdateQueue())
            {
              ...
              if (qp > updateQueue.size())
              {
                handler->PSendSysMessage("The item in bag {} at slot {} having guid {} has a queuepos ({}) larger than "
                                         "the update queue size! ",
                                         bag->GetSlot(), item2->GetSlot(), item2->GetGUID().ToString(), qp);
                error = true;
                continue;
              }
              ...
              if (!updateQueue[qp])
              {
                handler->PSendSysMessage("The item in bag {} at slot {} having guid {} has a queuepos ({}) that points "
                                         "to NULL in the queue!",
                                         bag->GetSlot(), item2->GetSlot(), item2->GetGUID().ToString(), qp);
                error = true;
                continue;
              }
              ...
              {
                handler->PSendSysMessage("The item in bag {} at slot {} having guid {} has a queuepos ({}) that points "
                                         "to another item in the queue (bag: {}, slot: {}, guid: {})",
                                         bag->GetSlot(), item2->GetSlot(), item2->GetGUID().ToString(), qp,
            ...
            else if (item2->GetState() != ITEM_UNCHANGED)
            {
              handler->PSendSysMessage(
                  ...
                  bag->GetSlot(), item2->GetSlot(), item2->GetGUID().ToString(), item2->GetState());
              error = true;
              continue;
            }
          }
      ...
      for (auto const& item : updateQueue)
      {
        ...
        if (item->GetOwnerGUID() != player->GetGUID())
        {
          handler->SendSysMessage(Acore::StringFormat(
              "queue({}): For the item {}, the owner ({}) and the player ({}) don't match!", index,
              item->GetGUID().ToString(), item->GetOwnerGUID().ToString(), player->GetGUID().ToString()));
          error = true;
          continue;
        }
        ...
        if (item->GetQueuePos() != index)
        {
          handler->SendSysMessage(
              Acore::StringFormat("queue({}): For the item {}, the queuepos doesn't match it's position in the queue!",
                                  index, item->GetGUID().ToString()));
          error = true;
          continue;
        }
        ...
        if (!test)
        {
          handler->SendSysMessage(Acore::StringFormat("queue({}): The bag({}) and slot({}) values for {} are "
                                                      "incorrect, the player doesn't have any item at that position!",
                                                      index, item->GetBagSlot(), item->GetSlot(),
        ...
        {
          handler->SendSysMessage(Acore::StringFormat(
              "queue({}): The bag({}) and slot({}) values for the {} are incorrect, {} is there instead!", index,
              item->GetBagSlot(), item->GetSlot(), item->GetGUID().ToString(), test->GetGUID().ToString()));
          error = true;
          continue;
        }
      }
  ...
  static bool HandleDebugCooldownCommand(ChatHandler* handler, uint32 spell_id, uint32 end_time,
  ...
  static bool HandleDebugThreatListCommand(ChatHandler* handler)
  {
    ...
    for (itr = threatList.begin(); itr != threatList.end(); ++itr)
    {
      ...
      handler->PSendSysMessage("   {}.   {}   ({})  - threat {}", ++count, unit->GetName(), unit->GetGUID().ToString(),
                               (*itr)->GetThreat());
    }
    ...
    for (itr = threatList2.begin(); itr != threatList2.end(); ++itr)
    {
      ...
      handler->PSendSysMessage("   {}.   [offline] {}   ({})  - threat {}", ++count, unit->GetName(),
                               unit->GetGUID().ToString(), (*itr)->GetThreat());
    }
  ...
  static bool HandleDebugSpawnVehicleCommand(ChatHandler* handler, uint32 entry, Optional<uint32> id)
  {
    ...
    if (!v->Create(map->GenerateLowGuid<HighGuid::Vehicle>(), map, handler->GetSession()->GetPlayer()->GetPhaseMask(),
                   entry, *id, x, y, z, o))
    {
      delete v;
      return false;
  ...
  static bool HandleDebugLoSCommand(ChatHandler* handler)
  {
    if (Unit* unit = handler->getSelectedUnit())
    {
      ...
      handler->PSendSysMessage("    VMAP LoS: {}",
                               player->IsWithinLOSInMap(unit, VMAP::ModelIgnoreFlags::Nothing, LINEOFSIGHT_CHECK_VMAP)
                                   ? "clear"
                                   : "obstructed");
      handler->PSendSysMessage("    GObj LoS: {}", player->IsWithinLOSInMap(unit, VMAP::ModelIgnoreFlags::Nothing,
                                                                            LINEOFSIGHT_CHECK_GOBJECT_ALL)
                                                       ? "clear"
                                                       : "obstructed");
      handler->PSendSysMessage("{} is {}in line of sight of {}.", unit->GetName(),
                               (player->IsWithinLOSInMap(unit) ? "" : "not "), player->GetName());
      return true;
    }
  ...
  static bool HandleDebugSetValueCommand(ChatHandler* handler, uint32 index, Variant<uint32, float> value)
  {
    ...
    else if (value.holds_alternative<float>())
    {
      ...
      handler->PSendSysMessage(LANG_SET_FLOAT_FIELD, target->GetGUID().ToString(), static_cast<float>(index),
                               uint32(value));
    }
  ...
  static bool HandleDebugMod32ValueCommand(ChatHandler* handler, uint32 index, uint32 value)
  {
    ...
    {
      handler->PSendSysMessage(LANG_TOO_BIG_INDEX, index, handler->GetPlayer()->GetGUID().ToString(),
  ...
  static bool HandleDebugMoveflagsCommand(ChatHandler* handler, Optional<uint32> moveFlags,
  ...
  static bool HandleWPGPSCommand(ChatHandler* handler, Optional<std::string> type)
  {
    ...
    if (!type)
    {
      ...
      LOG_INFO("sql.dev", "(@PATH, XX, {:.3f}, {:.3f}, {:.5f}, {:.5f}, 0, 0, 0, 100, 0),", player->GetPositionX(),
    ...
    if (type == "sai")
    {
      ...
      LOG_INFO("sql.dev", "(@PATH, XX, {:.3f}, {:.3f}, {:.5f}, {:.5f}, 0),", player->GetPositionX(),
               player->GetPositionY(), player->GetPositionZ(), player->GetOrientation());
    }
  ...
  static bool HandleDebugObjectCountCommand(ChatHandler* handler, Optional<uint32> mapId)
  {
    if (mapId)
    {
      sMapMgr->DoForAllMapsWithMapId(mapId.value(),
                                     [handler](Map* map) -> void { HandleDebugObjectCountMap(handler, map); });
    }
    else
    {
  ...
  {
    handler->PSendSysMessage(
        "Map Id: {} Name: '{}' Instance Id: {} Creatures: {} GameObjects: {} SetActive Objects: {}", map->GetId(),
        map->GetMapName(), map->GetInstanceId(), uint64(map->GetObjectsStore().Size<Creature>()),
        uint64(map->GetObjectsStore().Size<GameObject>()), uint64(map->GetActiveNonPlayersCount()));
  ...
  {
    handler->SendSysMessage("This command does nothing right now. Edit your local core (cs_debug.cpp) to make it do "
                            "whatever you need for testing.");
    return true;
  }
};
