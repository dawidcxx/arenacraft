...
class spell_rog_savage_combat : public AuraScript
{
  ...
  void Register() override
  {
    DoEffectCalcPeriodic +=
        AuraEffectCalcPeriodicFn(spell_rog_savage_combat::CalcPeriodic, EFFECT_0, SPELL_AURA_MOD_DAMAGE_PERCENT_TAKEN);
...
class spell_rog_combat_potency : public AuraScript
{
  ...
  bool CheckProc(ProcEventInfo& eventInfo) { return eventInfo.GetTypeMask() & PROC_FLAG_DONE_MELEE_AUTO_ATTACK; }

  void Register() override { DoCheckProc += AuraCheckProcFn(spell_rog_combat_potency::CheckProc); }
};
...
class spell_rog_blade_flurry : public AuraScript
{
  ...
  void HandleProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
  {
    ...
    if (procTarget && damageInfo)
    {
      ...
      GetTarget()->CastCustomSpell(SPELL_ROGUE_BLADE_FLURRY_EXTRA_ATTACK, values, procTarget, TRIGGERED_FULL_MASK,
                                   nullptr, aurEff);
    }
  }
...
class spell_rog_deadly_poison : public SpellScript
{
  ...
  void HandleBeforeHit(SpellMissInfo missInfo)
  {
    ...
    if (Unit* target = GetHitUnit())
      // Deadly Poison
      if (AuraEffect const* aurEff = target->GetAuraEffect(SPELL_AURA_PERIODIC_DAMAGE, SPELLFAMILY_ROGUE, 0x10000,
                                                           0x80000, 0, GetCaster()->GetGUID()))
...
class spell_rog_killing_spree_aura : public AuraScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override
  {
    return ValidateSpellInfo(
        {SPELL_ROGUE_KILLING_SPREE_TELEPORT, SPELL_ROGUE_KILLING_SPREE_WEAPON_DMG, SPELL_ROGUE_KILLING_SPREE_DMG_BUFF});
  }
...
public:
  ...
  void Register() override
  {
    AfterEffectApply += AuraEffectApplyFn(spell_rog_killing_spree_aura::HandleApply, EFFECT_0,
                                          SPELL_AURA_PERIODIC_DUMMY, AURA_EFFECT_HANDLE_REAL);
    OnEffectPeriodic +=
        AuraEffectPeriodicFn(spell_rog_killing_spree_aura::HandleEffectPeriodic, EFFECT_0, SPELL_AURA_PERIODIC_DUMMY);
    AfterEffectRemove += AuraEffectRemoveFn(spell_rog_killing_spree_aura::HandleRemove, EFFECT_0,
                                            SPELL_AURA_PERIODIC_DUMMY, AURA_EFFECT_HANDLE_REAL);
  }
...
class spell_rog_killing_spree : public SpellScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override { return ValidateSpellInfo({SPELL_ROGUE_KILLING_SPREE}); }
  ...
  void Register() override
  {
    ...
    OnObjectAreaTargetSelect +=
        SpellObjectAreaTargetSelectFn(spell_rog_killing_spree::FilterTargets, EFFECT_1, TARGET_UNIT_DEST_AREA_ENEMY);
...
class spell_rog_prey_on_the_weak : public AuraScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override { return ValidateSpellInfo({SPELL_ROGUE_PREY_ON_THE_WEAK}); }
...
class spell_rog_shiv : public SpellScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override { return ValidateSpellInfo({SPELL_ROGUE_SHIV_TRIGGERED}); }
...
class class_rog_marked_for_death_aura : public AuraScript
{
  ...
  void Register() override
  {
    OnEffectRemove += AuraEffectRemoveFn(class_rog_marked_for_death_aura::OnRemove, EFFECT_FIRST_FOUND,
                                         SPELL_EFFECT_ANY, AURA_EFFECT_HANDLE_REAL);
  }
};
...
class spell_rog_tricks_of_the_trade : public AuraScript
{
  ...
  void Register() override
  {
    AfterEffectRemove += AuraEffectRemoveFn(spell_rog_tricks_of_the_trade::OnRemove, EFFECT_1, SPELL_AURA_DUMMY,
...
class spell_rog_tricks_of_the_trade_proc : public AuraScript
{
  ...
  void Register() override
  {
    AfterEffectRemove += AuraEffectRemoveFn(spell_rog_tricks_of_the_trade_proc::HandleRemove, EFFECT_0,
...
class spell_rog_pickpocket : public SpellScript
{
  ...
  void Register() override { OnCheckCast += SpellCheckCastFn(spell_rog_pickpocket::CheckCast); }
};
...
class spell_rog_vanish_purge : public SpellScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override { return ValidateSpellInfo({SPELL_PARALYZE}); }
