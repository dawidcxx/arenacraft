...
struct npc_love_in_air_snivel : public NullCreatureAI
{
  ...
  {
    uint16 slot = player->FindQuestSlot(player->GetTeamId() == TEAM_ALLIANCE ? QUEST_HOT_ON_TRAIL_ALLY
...
class spell_love_in_air_perfume_immune : public AuraScript
{
  ...
  {
    OnEffectApply += AuraEffectApplyFn(spell_love_in_air_perfume_immune::HandleEffectApply, EFFECT_2, SPELL_AURA_DUMMY,
                                       AURA_EFFECT_HANDLE_REAL);
    OnEffectRemove += AuraEffectRemoveFn(spell_love_in_air_perfume_immune::HandleEffectRemove, EFFECT_2,
...
class spell_item_create_heart_candy : public SpellScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override { return ValidateSpellInfo(CreateHeartCandySpells); }
...
class spell_love_is_in_the_air_romantic_picnic : public AuraScript
{
  ...
  void Register() override
  {
    AfterEffectApply += AuraEffectApplyFn(spell_love_is_in_the_air_romantic_picnic::OnApply, EFFECT_0,
                                          SPELL_AURA_PERIODIC_DUMMY, AURA_EFFECT_HANDLE_REAL);
    OnEffectPeriodic +=
        AuraEffectPeriodicFn(spell_love_is_in_the_air_romantic_picnic::OnPeriodic, EFFECT_0, SPELL_AURA_PERIODIC_DUMMY);
  }
};
...
class spell_gen_aura_service_uniform : public AuraScript
{
  ...
  bool Validate(SpellInfo const* /*spell*/) override { return ValidateSpellInfo({SPELL_SERVICE_UNIFORM}); }
  ...
  void Register() override
  {
    AfterEffectApply += AuraEffectApplyFn(spell_gen_aura_service_uniform::OnApply, EFFECT_0, SPELL_AURA_TRANSFORM,
                                          AURA_EFFECT_HANDLE_REAL);
    AfterEffectRemove += AuraEffectRemoveFn(spell_gen_aura_service_uniform::OnRemove, EFFECT_0, SPELL_AURA_TRANSFORM,
                                            AURA_EFFECT_HANDLE_REAL);
  }
};
