...
public:
  ...
  CreatureAI* GetAI(Creature* creature) const override { return new npc_pet_dk_ebon_gargoyleAI(creature); }
};
...
public:
  ...
  CreatureAI* GetAI(Creature* pCreature) const override { return new npc_pet_dk_ghoulAI(pCreature); }
};
...
public:
  ...
  CreatureAI* GetAI(Creature* pCreature) const override { return new npc_pet_dk_risen_allyAI(pCreature); }
};
...
public:
  ...
  CreatureAI* GetAI(Creature* creature) const override { return new npc_pet_dk_army_of_the_deadAI(creature); }
};
...
public:
  ...
  CreatureAI* GetAI(Creature* creature) const override { return new npc_pet_dk_dancing_rune_weaponAI(creature); }
};
