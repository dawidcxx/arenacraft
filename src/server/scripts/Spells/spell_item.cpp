...
class spell_item_massive_seaforium_charge : public SpellScript
{
  ...
  {
    OnEffectHitTarget +=
        SpellEffectFn(spell_item_massive_seaforium_charge::HandleItemRemove, EFFECT_0, SPELL_EFFECT_SUMMON_OBJECT_WILD);
  }
};
...
class spell_item_goblin_gumbo_kettle : public AuraScript
{
  ...
  void Register() override
  {
    DoEffectCalcPeriodic +=
        AuraEffectCalcPeriodicFn(spell_item_goblin_gumbo_kettle::CalcPeriodic, EFFECT_0, SPELL_AURA_PROC_TRIGGER_SPELL);
...
class spell_item_with_mount_speed : public AuraScript
{
  ...
  {
    OnEffectApply +=
        AuraEffectApplyFn(spell_item_with_mount_speed::OnApply, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
    OnEffectRemove +=
        AuraEffectRemoveFn(spell_item_with_mount_speed::OnRemove, EFFECT_0, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
  }
};
...
class spell_item_shifting_naaru_silver : public AuraScript
{
  ...
  void Register() override
  {
    ...
    {
      OnEffectApply += AuraEffectApplyFn(spell_item_shifting_naaru_silver::OnApply, EFFECT_0, SPELL_AURA_DUMMY,
                                         AURA_EFFECT_HANDLE_REAL);
      AfterEffectRemove += AuraEffectRemoveFn(spell_item_shifting_naaru_silver::OnRemove, EFFECT_0, SPELL_AURA_DUMMY,
                                              AURA_EFFECT_HANDLE_REAL);
    }
    else
      AfterEffectRemove += AuraEffectRemoveFn(spell_item_shifting_naaru_silver::OnBaseRemove, EFFECT_0,
...
class spell_item_toxic_wasteling : public SpellScript
{
  ...
  void HandleJump(SpellEffIndex effIndex)
  {
    ...
    if (Creature* target = GetHitCreature())
    {
      ...
      GetCaster()->ToCreature()->SetHomePosition(target->GetPositionX(), target->GetPositionY(), target->GetPositionZ(),
                                                 0.0f);
      GetCaster()->GetMotionMaster()->MoveJump(target->GetPositionX(), target->GetPositionY(), target->GetPositionZ(),
                                               12.0f, 3.0f, 1);
      target->DespawnOrUnsummon(1500);
    }
  }

  void HandleScriptEffect(SpellEffIndex effIndex) { PreventHitDefaultEffect(effIndex); }
...
class spell_item_essence_of_life : public AuraScript
{
  ...
  void Register() override { DoCheckProc += AuraCheckProcFn(spell_item_essence_of_life::CheckProc); }
};
  ...
  void HandleHeal(SpellEffIndex /*effIndex*/)
  {
    ...
    if (roll_chance_i(20))
      GetCaster()->CastSpell(GetCaster(),
                             crazyAlchemistTable[urand(0, (GetCaster()->getPowerType() == POWER_MANA ? 4 : 3))], true);
  }
...
class spell_item_skull_of_impeding_doom : public AuraScript
{
  ...
  void Register() override
  {
    DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_item_skull_of_impeding_doom::CalculateDamageAmount, EFFECT_1,
                                                 SPELL_AURA_PERIODIC_DAMAGE);
    DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_item_skull_of_impeding_doom::CalculateManaLeechAmount, EFFECT_2,
...
{
  if (!SpellScript::ValidateSpellInfo({SPELL_PERSONALIZED_WEATHER_RAIN, SPELL_PERSONALIZED_WEATHER_SNOW,
                                       SPELL_PERSONALIZED_WEATHER_SUN, SPELL_PERSONALIZED_WEATHER_CLOUDS}))
    return 0;
...
class spell_item_goblin_weather_machine_aura : public AuraScript
{
  ...
  void Register() override
  {
    AfterEffectRemove += AuraEffectRemoveFn(spell_item_goblin_weather_machine_aura::OnRemove, EFFECT_0,
                                            SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
  }
};
...
class spell_item_trauma : public AuraScript
{
  ...
  bool CheckProc(ProcEventInfo& eventInfo) { return eventInfo.GetActionTarget(); }
...
class spell_item_blade_ward_enchant : public AuraScript
{
  ...
  void HandleProc(AuraEffect const* /*aurEff*/, ProcEventInfo& eventInfo)
  {
    ...
    if (SpellInfo const* spellInfo = sSpellMgr->GetSpellInfo(64442 /*SPELL_BLADE_WARDING*/))
    {
      ...
      eventInfo.GetActionTarget()->CastCustomSpell(spellInfo->Id, SPELLVALUE_BASE_POINT0, basepoints,
                                                   eventInfo.GetActor(), true);
    }
  }
...
class spell_item_dragon_kite_summon_lightning_bunny : public SpellScript
{
  ...
  void Register() override
  {
    OnDestinationTargetSelect += SpellDestinationTargetSelectFn(spell_item_dragon_kite_summon_lightning_bunny::SetDest,
                                                                EFFECT_0, TARGET_DEST_CASTER_RANDOM);
  }
};
...
class spell_item_enchanted_broom_periodic : public AuraScript
{
  ...
  void HandlePeriodicTick(AuraEffect const* /*aurEff*/)
  {
    ...
    if (Unit* owner = GetTarget()->GetOwner())
    {
      if (owner->isMoving())
      {
        GetTarget()->GetMotionMaster()->MoveFollow(owner, PET_FOLLOW_DIST, GetTarget()->GetFollowAngle(),
                                                   MOTION_SLOT_ACTIVE);
      }
      else
      {
  ...
  void Register() override
  {
    OnEffectPeriodic += AuraEffectPeriodicFn(spell_item_enchanted_broom_periodic::HandlePeriodicTick, EFFECT_0,
...
class spell_item_draenic_pale_ale : public SpellScript
{
  ...
  void HandleSummon(SpellEffIndex effIndex)
  {
    ...
    for (uint8 count = 0; count < GetEffectValue(); ++count)
    {
      ...
      GetCaster()->GetClosePoint(pos.m_positionX, pos.m_positionY, pos.m_positionZ, pos.GetOrientation(), radius,
                                 M_PI - 1.2f + 0.3f * urand(0, 8));
      Creature* summon = GetCaster()->SummonCreature(GetSpellInfo()->Effects[effIndex].MiscValue, pos,
                                                     TEMPSUMMON_TIMED_DESPAWN, GetSpellInfo()->GetDuration());
      if (!summon)
        continue;
      ...
      summon->GetMotionMaster()->MoveFollow(GetCaster(), PET_FOLLOW_DIST, GetCaster()->GetAngle(summon),
...
class spell_item_direbrew_remote_aura : public AuraScript
{
  ...
  {
    OnEffectPeriodic +=
        AuraEffectPeriodicFn(spell_item_direbrew_remote_aura::HandlePeriodicTick, EFFECT_0, SPELL_AURA_PERIODIC_DUMMY);
  }
};
...
class spell_item_eye_of_gruul_healing_discount : public AuraScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override
  {
    return ValidateSpellInfo({SPELL_DRUID_ITEM_HEALING_TRANCE, SPELL_PALADIN_ITEM_HEALING_TRANCE,
                              SPELL_PRIEST_ITEM_HEALING_TRANCE, SPELL_SHAMAN_ITEM_HEALING_TRANCE});
  }
  ...
  {
    OnEffectProc +=
        AuraEffectProcFn(spell_item_eye_of_gruul_healing_discount::HandleProc, EFFECT_0, SPELL_AURA_PROC_TRIGGER_SPELL);
  }
};
...
class spell_item_instant_statue : public AuraScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override { return ValidateSpellInfo({SPELL_INSTANT_STATUE}); }
  ...
  {
    OnEffectRemove +=
        AuraEffectRemoveFn(spell_item_instant_statue::OnRemove, EFFECT_1, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
  }
};
...
public:
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override { return ValidateSpellInfo({_triggeredSpellId}); }
...
class spell_item_aegis_of_preservation : public AuraScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override { return ValidateSpellInfo({SPELL_AEGIS_HEAL}); }
...
class spell_item_valanyr_hammer_of_ancient_kings : public AuraScript
{
  ...
  bool CheckProc(ProcEventInfo& eventInfo) { return eventInfo.GetHealInfo() && eventInfo.GetHealInfo()->GetHeal() > 0; }

  void Register() override { DoCheckProc += AuraCheckProcFn(spell_item_valanyr_hammer_of_ancient_kings::CheckProc); }
};
...
class spell_item_brittle_armor : public SpellScript
{
  ...
  void HandleScript(SpellEffIndex /* effIndex */) { GetHitUnit()->RemoveAuraFromStack(SPELL_BRITTLE_ARMOR); }
...
class spell_item_blessing_of_ancient_kings : public AuraScript
{
  ...
  bool CheckProc(ProcEventInfo& eventInfo) { return eventInfo.GetProcTarget(); }
  ...
  void HandleProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
  {
    ...
    if (AuraEffect* protEff = eventInfo.GetProcTarget()->GetAuraEffect(SPELL_PROTECTION_OF_ANCIENT_KINGS,
                                                                       0 /*, eventInfo.GetActor()->GetGUID()*/))
    {
      ...
      GetTarget()->CastCustomSpell(SPELL_PROTECTION_OF_ANCIENT_KINGS, SPELLVALUE_BASE_POINT0, absorb,
...
class spell_item_desperate_defense : public AuraScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override { return ValidateSpellInfo({SPELL_DESPERATE_RAGE}); }
  ...
  void Register() override
  {
    ...
    OnEffectRemove += AuraEffectRemoveFn(spell_item_desperate_defense::OnRemove, EFFECT_0, SPELL_AURA_SCHOOL_ABSORB,
                                         AURA_EFFECT_HANDLE_REAL);
  }
};
...
class spell_item_deviate_fish : public SpellScript
{
  ...
  void HandleDummy(SpellEffIndex /*effIndex*/)
  {
    Unit*  caster = GetCaster();
    uint32 spellId =
        RAND(SPELL_SLEEPY, SPELL_INVIGORATE, SPELL_SHRINK, SPELL_PARTY_TIME, SPELL_HEALTHY_SPIRIT, SPELL_REJUVENATION);
...
public:
  ...
  bool Execute(uint64 /*time*/, uint32 /*diff*/) override
  {
    ...
    {
      _player->HandleEmoteCommand(RAND(EMOTE_ONESHOT_APPLAUD, EMOTE_ONESHOT_DANCESPECIAL, EMOTE_ONESHOT_LAUGH,
                                       EMOTE_ONESHOT_CHEER, EMOTE_ONESHOT_CHICKEN));
    }

    _player->m_Events.AddEvent(this, RAND(_player->m_Events.CalculateTime(5000), _player->m_Events.CalculateTime(10000),
...
class spell_item_party_time : public AuraScript
{
  ...
  void HandleEffectApply(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
  {
    ...
    player->m_Events.AddEvent(new PartyTimeEmoteEvent(player),
                              RAND(player->m_Events.CalculateTime(5000), player->m_Events.CalculateTime(10000),
                                   player->m_Events.CalculateTime(15000)));
  }

  void Register() override
  {
    OnEffectApply += AuraEffectApplyFn(spell_item_party_time::HandleEffectApply, EFFECT_0, SPELL_AURA_DUMMY,
                                       AURA_EFFECT_HANDLE_REAL);
  }
};
...
class spell_item_echoes_of_light : public SpellScript
{
  ...
  {
    OnObjectAreaTargetSelect +=
        SpellObjectAreaTargetSelectFn(spell_item_echoes_of_light::FilterTargets, EFFECT_0, TARGET_UNIT_DEST_AREA_ALLY);
  }
};
...
class spell_item_fate_rune_of_unsurpassed_vigor : public AuraScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override { return ValidateSpellInfo({SPELL_UNSURPASSED_VIGOR}); }
...
class spell_item_gnomish_death_ray : public SpellScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override { return ValidateSpellInfo({SPELL_GNOMISH_DEATH_RAY_TARGET}); }
...
class spell_item_make_a_wish : public SpellScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override
  {
    return ValidateSpellInfo({SPELL_MR_PINCHYS_BLESSING, SPELL_SUMMON_MIGHTY_MR_PINCHY, SPELL_SUMMON_FURIOUS_MR_PINCHY,
...
std::array<uint32, 20> const CreateFortuneSpells = {
    ...
    SPELL_CREATE_FORTUNE_5,  SPELL_CREATE_FORTUNE_6,  SPELL_CREATE_FORTUNE_7,  SPELL_CREATE_FORTUNE_8,
    SPELL_CREATE_FORTUNE_9,  SPELL_CREATE_FORTUNE_10, SPELL_CREATE_FORTUNE_11, SPELL_CREATE_FORTUNE_12,
    SPELL_CREATE_FORTUNE_13, SPELL_CREATE_FORTUNE_14, SPELL_CREATE_FORTUNE_15, SPELL_CREATE_FORTUNE_16,
    SPELL_CREATE_FORTUNE_17, SPELL_CREATE_FORTUNE_18, SPELL_CREATE_FORTUNE_19, SPELL_CREATE_FORTUNE_20};
...
class spell_item_mercurial_shield : public SpellScript
{
  ...
  void HandleScript(SpellEffIndex /* effIndex */) { GetHitUnit()->RemoveAuraFromStack(SPELL_MERCURIAL_SHIELD); }
...
class spell_item_mingos_fortune_generator : public SpellScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override { return ValidateSpellInfo(CreateFortuneSpells); }
...
class spell_item_necrotic_touch : public AuraScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override { return ValidateSpellInfo({SPELL_ITEM_NECROTIC_TOUCH_PROC}); }

  bool CheckProc(ProcEventInfo& eventInfo) { return eventInfo.GetProcTarget() && eventInfo.GetProcTarget()->IsAlive(); }
  ...
  void HandleProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
  {
    ...
    GetTarget()->CastCustomSpell(SPELL_ITEM_NECROTIC_TOUCH_PROC, SPELLVALUE_BASE_POINT0, bp, eventInfo.GetProcTarget(),
                                 true, nullptr, aurEff);
  }
...
class spell_item_unsated_craving : public AuraScript
{
  ...
  void HandleProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
  {
    ...
    eventInfo.GetActor()->CastSpell(eventInfo.GetActionTarget(),
                                    GetSpellInfo()->Effects[aurEff->GetEffIndex()].TriggerSpell, TRIGGERED_FULL_MASK);
  }
...
class spell_item_shadowmourne : public AuraScript
{
  ...
  {
    return ValidateSpellInfo(
        {SPELL_SHADOWMOURNE_CHAOS_BANE_DAMAGE, SPELL_SHADOWMOURNE_SOUL_FRAGMENT, SPELL_SHADOWMOURNE_CHAOS_BANE_BUFF});
  }
...
class spell_item_shadowmourne_soul_fragment : public AuraScript
{
  ...
  {
    AfterEffectApply +=
        AuraEffectApplyFn(spell_item_shadowmourne_soul_fragment::OnStackChange, EFFECT_0, SPELL_AURA_MOD_STAT,
                          AuraEffectHandleModes(AURA_EFFECT_HANDLE_REAL | AURA_EFFECT_HANDLE_REAPPLY));
    AfterEffectRemove += AuraEffectRemoveFn(spell_item_shadowmourne_soul_fragment::OnRemove, EFFECT_0,
                                            SPELL_AURA_MOD_STAT, AURA_EFFECT_HANDLE_REAL);
  }
};
...
class spell_item_six_demon_bag : public SpellScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override
  {
    return ValidateSpellInfo({SPELL_FROSTBOLT, SPELL_POLYMORPH, SPELL_SUMMON_FELHOUND_MINION, SPELL_FIREBALL,
                              SPELL_CHAIN_LIGHTNING, SPELL_ENVELOPING_WINDS});
  }
...
class spell_item_map_of_the_geyser_fields : public SpellScript
{
  ...
  void Register() override { OnCheckCast += SpellCheckCastFn(spell_item_map_of_the_geyser_fields::CheckSinkholes); }
};
...
class spell_item_ashbringer : public SpellScript
{
  ...
  void OnDummyEffect(SpellEffIndex effIndex)
  {
    ...
    uint32  sound_id = RAND(SOUND_ASHBRINGER_1, SOUND_ASHBRINGER_2, SOUND_ASHBRINGER_3, SOUND_ASHBRINGER_4,
                            SOUND_ASHBRINGER_5, SOUND_ASHBRINGER_6, SOUND_ASHBRINGER_7, SOUND_ASHBRINGER_8,
                            SOUND_ASHBRINGER_9, SOUND_ASHBRINGER_10, SOUND_ASHBRINGER_11, SOUND_ASHBRINGER_12);

    // Ashbringers effect (spellID 28441) retriggers every 5 seconds, with a chance of making it say one of the above 12
    // sounds
    if (urand(0, 60) < 1)
...
class spell_magic_eater_food : public AuraScript
{
  ...
  {
    OnEffectPeriodic +=
        AuraEffectPeriodicFn(spell_magic_eater_food::HandleTriggerSpell, EFFECT_1, SPELL_AURA_PERIODIC_TRIGGER_SPELL);
  }
};
...
class spell_item_purify_helboar_meat : public SpellScript
{
  ...
  {
    Unit* caster = GetCaster();
    caster->CastSpell(caster, roll_chance_i(50) ? SPELL_SUMMON_PURIFIED_HELBOAR_MEAT : SPELL_SUMMON_TOXIC_HELBOAR_MEAT,
                      true, nullptr);
  }
...
class spell_item_reindeer_transformation : public SpellScript
{
  ...
  bool Validate(SpellInfo const* /*spell*/) override
  {
    return ValidateSpellInfo({SPELL_FLYING_REINDEER_310, SPELL_FLYING_REINDEER_280, SPELL_FLYING_REINDEER_60,
                              SPELL_REINDEER_100, SPELL_REINDEER_60});
  }
    ...
    if (GetCastItem() && GetHitUnit())
    {
      if (roll_chance_i(80))
      {
        GetCaster()->CastSpell(GetHitUnit(),
                               roll_chance_i(80) ? SPELL_POULTRYIZER_SUCCESS_1 : SPELL_POULTRYIZER_SUCCESS_2, true,
                               GetCastItem());
      }
      else
      {
...
class spell_item_socrethars_stone : public SpellScript
{
  ...
  bool Load() override { return (GetCaster()->GetAreaId() == 3900 || GetCaster()->GetAreaId() == 3742); }
...
class spell_item_complete_raptor_capture : public SpellScript
{
  ...
  bool Validate(SpellInfo const* /*spell*/) override { return ValidateSpellInfo({SPELL_RAPTOR_CAPTURE_CREDIT}); }
...
class spell_item_nitro_boots : public SpellScript
{
  ...
  void HandleDummy(SpellEffIndex /* effIndex */)
  {
    ...
    caster->CastSpell(caster,
                      caster->GetMap()->IsDungeon() || roll_chance_i(95) ? SPELL_NITRO_BOOTS_SUCCESS
...
class spell_item_teach_language : public SpellScript
{
  ...
  void HandleDummy(SpellEffIndex /* effIndex */)
  {
    ...
    if (roll_chance_i(34))
      caster->CastSpell(
          caster, caster->GetTeamId() == TEAM_ALLIANCE ? SPELL_LEARN_GNOMISH_BINARY : SPELL_LEARN_GOBLIN_BINARY, true);
  }
...
class spell_item_rocket_boots : public SpellScript
{
  ...
  bool Validate(SpellInfo const* /*spell*/) override { return ValidateSpellInfo({SPELL_ROCKET_BOOTS_PROC}); }
...
class spell_item_eggnog : public SpellScript
{
  ...
  {
    if (roll_chance_i(40))
      GetCaster()->CastSpell(GetHitUnit(), roll_chance_i(50) ? SPELL_EGG_NOG_REINDEER : SPELL_EGG_NOG_SNOWMAN,
                             GetCastItem());
  }
...
class spell_item_goblin_bomb : public SpellScript
{
  ...
  void HandleDummy(SpellEffIndex /*effIndex*/)
  {
    if (Unit* caster = GetCaster())
    {
      caster->CastSpell(caster, roll_chance_i(95) ? SPELL_SUMMON_GOBLIN_BOMB : SPELL_MALFUNCTION_EXPLOSION, true,
                        GetCastItem());
    }
  }
...
class spell_item_linken_boomerang : public SpellScript
{
  ...
  void OnEffectHitTargetDisarm(SpellEffIndex effIndex) { PreventHitDefaultEffect(effIndex); }

  void OnEffectHitTargetStun(SpellEffIndex effIndex) { PreventHitDefaultEffect(effIndex); }
  ...
  void Register() override
  {
    OnEffectLaunchTarget +=
        SpellEffectFn(spell_item_linken_boomerang::OnEffectLaunchTargetDisarm, EFFECT_1, SPELL_EFFECT_TRIGGER_SPELL);
    OnEffectLaunchTarget +=
...
class spell_item_recall : public SpellScript
{
  ...
  void SetDest(SpellDestination& dest)
  {
    ...
    if (player->GetTeamId(true) != bgTeam)
    {
      ...
      {
        Position pos = Position(recallSpellTarget->target_X, recallSpellTarget->target_Y, recallSpellTarget->target_Z,
...
class spell_item_wraith_scythe_drain_life : public SpellScript
{
  ...
  void Register() override { OnHit += SpellHitFn(spell_item_wraith_scythe_drain_life::CalculateDamage); }
};
...
class spell_item_snowman : public SpellScript
{
  ...
  void Register() override { OnCheckCast += SpellCheckCastFn(spell_item_snowman::CheckCast); }
};
...
class spell_item_green_whelp_armor : public AuraScript
{
  ...
  void Register() override { DoCheckProc += AuraCheckProcFn(spell_item_green_whelp_armor::CheckProc); }
};
...
class spell_item_scroll_of_retribution : public SpellScript
{
  ...
  void Register() override { OnCheckCast += SpellCheckCastFn(spell_item_scroll_of_retribution::CheckCast); }
};
...
class spell_item_eye_of_grillok : public SpellScript
{
  ...
  void Register() override { OnCheckCast += SpellCheckCastFn(spell_item_eye_of_grillok::CheckCast); }
};
...
class spell_item_eye_of_grillok_aura : public AuraScript
{
  ...
  {
    OnEffectPeriodic +=
        AuraEffectPeriodicFn(spell_item_eye_of_grillok_aura::OnPeriodic, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL);
  }
};
...
class spell_item_gor_dreks_ointment : public SpellScript
{
  ...
  void Register() override { OnCheckCast += SpellCheckCastFn(spell_item_gor_dreks_ointment::CheckCast); }
};
...
class spell_item_skyguard_blasting_charges : public SpellScript
{
  ...
  {
    OnEffectHitTarget +=
        SpellEffectFn(spell_item_skyguard_blasting_charges::HandleOpenObject, EFFECT_1, SPELL_EFFECT_ACTIVATE_OBJECT);
...
class spell_item_spell_reflectors : public AuraScript
{
  ...
  void Register() override
  {
    DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_item_spell_reflectors::CalculateAmount, EFFECT_0,
...
class spell_item_multiphase_goggles : public AuraScript
{
  ...
  void Register() override
  {
    OnEffectApply += AuraEffectApplyFn(spell_item_multiphase_goggles::OnApply, EFFECT_0,
                                       SPELL_AURA_MOD_INVISIBILITY_DETECT, AURA_EFFECT_HANDLE_REAL);
    OnEffectRemove += AuraEffectRemoveFn(spell_item_multiphase_goggles::OnRemove, EFFECT_0,
                                         SPELL_AURA_MOD_INVISIBILITY_DETECT, AURA_EFFECT_HANDLE_REAL);
  }
};
...
void AddSC_item_spell_scripts()
{
  ...
  RegisterSpellScriptWithArgs(spell_item_trigger_spell, "spell_item_mechanical_dragonling",
                              SPELL_MECHANICAL_DRAGONLING);
  // 23075 Mithril Mechanical Dragonling
  RegisterSpellScriptWithArgs(spell_item_trigger_spell, "spell_item_mithril_mechanical_dragonling",
  ...
  RegisterSpellScriptWithArgs(spell_item_defibrillate, "spell_item_goblin_jumper_cables", 67,
                              SPELL_GOBLIN_JUMPER_CABLES_FAIL);
  RegisterSpellScriptWithArgs(spell_item_defibrillate, "spell_item_goblin_jumper_cables_xl", 50,
