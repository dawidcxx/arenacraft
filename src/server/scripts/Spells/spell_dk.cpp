...
class spell_dk_wandering_plague : public SpellScript
{
  ...
  {
    static const AuraType ccAuras[] = {SPELL_AURA_MOD_CONFUSE, SPELL_AURA_MOD_FEAR,  SPELL_AURA_MOD_STUN,
                                       SPELL_AURA_MOD_ROOT,    SPELL_AURA_TRANSFORM, SPELL_AURA_NONE};
  ...
  void Register() override
  {
    OnObjectAreaTargetSelect +=
        SpellObjectAreaTargetSelectFn(spell_dk_wandering_plague::FilterTargets, EFFECT_0, TARGET_UNIT_DEST_AREA_ENEMY);
  }
};
      ...
      if (Unit* ghoul = unitTarget->GetCharm())
      {
        ...
        for (uint8 i = STAT_STRENGTH; i <= STAT_STAMINA; ++i)
        {
          ...
          AuraEffect const* aurEff =
              GetCaster()->GetAuraEffect(SPELL_AURA_MOD_TOTAL_STAT_PERCENTAGE, SPELLFAMILY_DEATHKNIGHT, 3010, 0);
          if (aurEff)
          {
        ...
        // Attack Power
        ghoul->SetModifierValue(UNIT_MOD_ATTACK_POWER, BASE_VALUE,
        ...
        ghoul->SetInt32Value(UNIT_FIELD_ATTACK_POWER_MODS,
                             (int32)ghoul->GetModifierValue(UNIT_MOD_ATTACK_POWER, TOTAL_VALUE));
        ghoul->SetFloatValue(UNIT_FIELD_ATTACK_POWER_MULTIPLIER,
                             ghoul->GetModifierValue(UNIT_MOD_ATTACK_POWER, TOTAL_PCT) - 1.0f);

        // Health
        ghoul->SetModifierValue(UNIT_MOD_HEALTH, TOTAL_VALUE,
                                (ghoul->GetStat(STAT_STAMINA) - ghoul->GetCreateStat(STAT_STAMINA)) * 10.0f);

        // Power Energy
        ghoul->SetModifierValue(UnitMods(UNIT_MOD_POWER_START + static_cast<uint8>(POWER_ENERGY)), BASE_VALUE,
...
class spell_dk_raise_ally_trigger : public AuraScript
{
  ...
  void Register() override
  {
    OnEffectRemove += AuraEffectRemoveFn(spell_dk_raise_ally_trigger::HandleEffectRemove, EFFECT_1, SPELL_AURA_DUMMY,
...
class spell_dk_death_and_decay_aura : public AuraScript
{
  ...
  void HandlePeriodic(AuraEffect const* aurEff)
  {
    ...
    if (GetCaster() && GetTarget())
    {
      ...
      GetCaster()->CastCustomSpell(GetTarget(), SPELL_DK_DEATH_AND_DECAY_TRIGGER, &basePoints0, nullptr, nullptr, true,
                                   0, aurEff);
    }
  }
  ...
  void Register() override
  {
    if (m_scriptSpellId != SPELL_DK_DEATH_AND_DECAY_TRIGGER)
      OnEffectPeriodic +=
          AuraEffectPeriodicFn(spell_dk_death_and_decay_aura::HandlePeriodic, EFFECT_0, SPELL_AURA_PERIODIC_DUMMY);
  }
};
...
class spell_dk_master_of_ghouls : public AuraScript
{
  ...
  void Register() override
  {
    OnEffectApply += AuraEffectApplyFn(spell_dk_master_of_ghouls::HandleEffectApply, EFFECT_0,
                                       SPELL_AURA_ADD_FLAT_MODIFIER, AURA_EFFECT_HANDLE_REAL);
    OnEffectRemove += AuraEffectRemoveFn(spell_dk_master_of_ghouls::HandleEffectRemove, EFFECT_0,
                                         SPELL_AURA_ADD_FLAT_MODIFIER, AURA_EFFECT_HANDLE_REAL);
  }
};
...
class spell_dk_chains_of_ice : public SpellScript
{
  ...
  void Register() override { AfterCast += SpellCastFn(spell_dk_chains_of_ice::HandleAfterCast); }
};
...
class spell_dk_bloodworms : public SpellScript
{
  ...
  void HandleSummon(SpellEffIndex /*effIndex*/) { SetEffectValue(irand(2, 4)); }
...
class spell_dk_summon_gargoyle : public SpellScript
{
  ...
  void SetDest(SpellDestination& dest)
  {
    ...
    if (GetCaster()->IsWithinLOS(dest._position.GetPositionX(), dest._position.GetPositionY(),
...
class spell_dk_improved_blood_presence_proc : public AuraScript
{
  ...
  void Register() override { DoCheckProc += AuraCheckProcFn(spell_dk_improved_blood_presence_proc::CheckProc); }
};
...
class spell_dk_wandering_plague_aura : public AuraScript
{
  ...
  void HandleProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
  {
    ...
    eventInfo.GetActor()->CastCustomSpell(
        SPELL_DK_WANDERING_PLAGUE_TRIGGER, SPELLVALUE_BASE_POINT0,
        CalculatePct<int32, int32>(eventInfo.GetDamageInfo()->GetDamage(), aurEff->GetAmount()),
        eventInfo.GetActionTarget(), TRIGGERED_FULL_MASK);
  }
...
class spell_dk_rune_of_the_fallen_crusader : public SpellScript
{
  ...
  void Register() override { OnHit += SpellHitFn(spell_dk_rune_of_the_fallen_crusader::RecalculateDamage); }
};
...
class spell_dk_bone_shield : public AuraScript
{
  ...
  void Register() override { OnProc += AuraProcFn(spell_dk_bone_shield::HandleProc); }
};
...
class spell_dk_hungering_cold : public AuraScript
{
  ...
  void Register() override { OnProc += AuraProcFn(spell_dk_hungering_cold::HandleProc); }
};
...
class spell_dk_blood_caked_blade : public AuraScript
{
  ...
  {
    PreventDefaultAction();
    eventInfo.GetActor()->CastSpell(eventInfo.GetActionTarget(), aurEff->GetSpellInfo()->Effects[EFFECT_0].TriggerSpell,
                                    true, nullptr, aurEff);
...
class spell_dk_dancing_rune_weapon_visual : public AuraScript
{
  ...
  void HandleEffectApply(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
  {
    ...
    if (Unit* owner = GetUnitOwner()->ToTempSummon()->GetSummonerUnit())
    {
      ...
      GetUnitOwner()->SetUInt32Value(UNIT_VIRTUAL_ITEM_SLOT_ID + 1,
  ...
  void Register() override
  {
    OnEffectApply += AuraEffectApplyFn(spell_dk_dancing_rune_weapon_visual::HandleEffectApply, EFFECT_0,
...
class spell_dk_scent_of_blood_trigger : public AuraScript
{
  ...
  void Register() override { DoCheckProc += AuraCheckProcFn(spell_dk_scent_of_blood_trigger::CheckProc); }
};
...
class spell_dk_pet_scaling : public AuraScript
{
  ...
  void Register() override
  {
    ...
    OnEffectApply +=
        AuraEffectApplyFn(spell_dk_pet_scaling::HandleEffectApply, EFFECT_ALL, SPELL_AURA_ANY, AURA_EFFECT_HANDLE_REAL);
...
class spell_dk_anti_magic_shell_self : public AuraScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override { return ValidateSpellInfo({SPELL_DK_RUNIC_POWER_ENERGIZE}); }
  ...
  void Trigger(AuraEffect* aurEff, DamageInfo& /*dmgInfo*/, uint32& absorbAmount)
  {
    ...
    GetTarget()->CastCustomSpell(SPELL_DK_RUNIC_POWER_ENERGIZE, SPELLVALUE_BASE_POINT0, bp, GetTarget(), true, nullptr,
                                 aurEff);
  }
  ...
  void Register() override
  {
    ...
    OnEffectApply += AuraEffectApplyFn(spell_dk_anti_magic_shell_self::HandleEffectApply, EFFECT_1,
                                       SPELL_AURA_MOD_IMMUNE_AURA_APPLY_SCHOOL, AURA_EFFECT_HANDLE_REAL);
    OnEffectRemove += AuraEffectRemoveFn(spell_dk_anti_magic_shell_self::HandleEffectRemove, EFFECT_1,
                                         SPELL_AURA_MOD_IMMUNE_AURA_APPLY_SCHOOL, AURA_EFFECT_HANDLE_REAL);
  }
};
...
class spell_dk_blood_boil : public SpellScript
{
  ...
  void Register() override { AfterHit += SpellHitFn(spell_dk_blood_boil::HandleAfterHit); }
...
class spell_dk_blood_gorged : public AuraScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override { return ValidateSpellInfo({SPELL_DK_BLOOD_GORGED_HEAL}); }
  ...
  void HandleProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
  {
    ...
    GetTarget()->CastCustomSpell(SPELL_DK_BLOOD_GORGED_HEAL, SPELLVALUE_BASE_POINT0, bp, _procTarget, true, nullptr,
                                 aurEff);
  }
...
class spell_dk_corpse_explosion : public SpellScript
{
  ...
  void HandleDamage(SpellEffIndex effIndex, Unit* target)
  {
    if (effIndex == EFFECT_0)
      GetCaster()->CastCustomSpell(GetSpellInfo()->Effects[EFFECT_1].CalcValue(), SPELLVALUE_BASE_POINT0,
                                   GetEffectValue(), target, true);
    else if (effIndex == EFFECT_1)
      GetCaster()->CastCustomSpell(GetEffectValue(), SPELLVALUE_BASE_POINT0,
                                   GetSpell()->CalculateSpellDamage(EFFECT_0, nullptr), target, true);
  }
  ...
  void Register() override
  {
    ...
    OnObjectAreaTargetSelect +=
        SpellObjectAreaTargetSelectFn(spell_dk_corpse_explosion::CheckTargets, EFFECT_1, TARGET_UNIT_DEST_AREA_ENTRY);
      ...
      for (Unit::ControlSet::const_iterator itr = player->m_Controlled.begin(); itr != player->m_Controlled.end();
        ...
        if (Creature* undeadPet = (*itr)->ToCreature())
          if (undeadPet->IsAlive() && undeadPet->GetOwnerGUID() == player->GetGUID() &&
              undeadPet->GetCreatureType() == CREATURE_TYPE_UNDEAD && undeadPet->IsWithinDist(player, 100.0f, false))
            return SPELL_CAST_OK;
...
class spell_dk_death_strike : public SpellScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override { return ValidateSpellInfo({SPELL_DK_DEATH_STRIKE_HEAL}); }
  ...
  void HandleDummy(SpellEffIndex /*effIndex*/)
  {
    ...
    if (Unit* target = GetHitUnit())
    {
      ...
      if (AuraEffect const* aurEff = caster->GetAuraEffect(SPELL_AURA_ADD_PCT_MODIFIER, SPELLFAMILY_DEATHKNIGHT,
                                                           DK_ICON_ID_IMPROVED_DEATH_STRIKE, 0))
...
class spell_dk_ghoul_thrash : public SpellScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override { return ValidateSpellInfo({SPELL_GHOUL_FRENZY}); }

  void CalcDamage(SpellEffIndex /*effIndex*/)
  {
    /*
    Causes more damage per frenzy point:
        1 point   : (Attack power * 40 * 0.01 + Attack power * 0.05)-(Attack power * 40 * 0.01 + Attack power * 0.10)
    damage 2 points  : (Attack power * 40 * 0.01 + Attack power * 0.10)-(Attack power * 40 * 0.01 + Attack power * 0.20)
    damage 3 points  : (Attack power * 40 * 0.01 + Attack power * 0.15)-(Attack power * 40 * 0.01 + Attack power * 0.30)
    damage 4 points  : (Attack power * 40 * 0.01 + Attack power * 0.20)-(Attack power * 40 * 0.01 + Attack power * 0.40)
    damage 5 points  : (Attack power * 40 * 0.01 + Attack power * 0.25)-(Attack power * 40 * 0.01 + Attack power * 0.50)
    damage
    */
...
class spell_dk_icebound_fortitude : public AuraScript
{
  ...
  void Register() override
  {
    DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_dk_icebound_fortitude::CalculateAmount, EFFECT_2,
...
class spell_dk_improved_blood_presence : public AuraScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override
  {
    return ValidateSpellInfo({SPELL_DK_BLOOD_PRESENCE, SPELL_DK_FROST_PRESENCE, SPELL_DK_UNHOLY_PRESENCE,
  ...
  void HandleEffectApply(AuraEffect const* aurEff, AuraEffectHandleModes /*mode*/)
  {
    ...
    if ((target->HasAura(SPELL_DK_FROST_PRESENCE) || target->HasAura(SPELL_DK_UNHOLY_PRESENCE)) &&
      ...
      target->CastCustomSpell(SPELL_DK_IMPROVED_BLOOD_PRESENCE_TRIGGERED, SPELLVALUE_BASE_POINT1, aurEff->GetAmount(),
  ...
  void Register() override
  {
    AfterEffectApply += AuraEffectApplyFn(spell_dk_improved_blood_presence::HandleEffectApply, EFFECT_0,
                                          SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
    AfterEffectRemove += AuraEffectRemoveFn(spell_dk_improved_blood_presence::HandleEffectRemove, EFFECT_0,
                                            SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
  }
};
...
class spell_dk_improved_frost_presence : public AuraScript
{
  ...
  void HandleEffectApply(AuraEffect const* aurEff, AuraEffectHandleModes /*mode*/)
  {
    ...
    if ((target->HasAura(SPELL_DK_BLOOD_PRESENCE) || target->HasAura(SPELL_DK_UNHOLY_PRESENCE)) &&
      ...
      target->CastCustomSpell(SPELL_DK_FROST_PRESENCE_TRIGGERED, SPELLVALUE_BASE_POINT0, aurEff->GetAmount(), target,
                              true, nullptr, aurEff);
  }
  ...
  void Register() override
  {
    AfterEffectApply += AuraEffectApplyFn(spell_dk_improved_frost_presence::HandleEffectApply, EFFECT_0,
                                          SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
    AfterEffectRemove += AuraEffectRemoveFn(spell_dk_improved_frost_presence::HandleEffectRemove, EFFECT_0,
                                            SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
  }
};
...
class spell_dk_improved_unholy_presence : public AuraScript
{
  ...
  {
    return ValidateSpellInfo({SPELL_DK_BLOOD_PRESENCE, SPELL_DK_FROST_PRESENCE, SPELL_DK_UNHOLY_PRESENCE,
                              SPELL_DK_IMPROVED_UNHOLY_PRESENCE_TRIGGERED, SPELL_DK_UNHOLY_PRESENCE_TRIGGERED});
  }
  ...
  void HandleEffectApply(AuraEffect const* aurEff, AuraEffectHandleModes /*mode*/)
  {
    ...
    if (target->HasAura(SPELL_DK_UNHOLY_PRESENCE) && !target->HasAura(SPELL_DK_IMPROVED_UNHOLY_PRESENCE_TRIGGERED))
    {
      ...
      target->CastCustomSpell(target, SPELL_DK_IMPROVED_UNHOLY_PRESENCE_TRIGGERED, &basePoints, &basePoints,
                              &basePoints, true, nullptr, aurEff);
    }
    ...
    if ((target->HasAura(SPELL_DK_BLOOD_PRESENCE) || target->HasAura(SPELL_DK_FROST_PRESENCE)) &&
      ...
      target->CastCustomSpell(SPELL_DK_UNHOLY_PRESENCE_TRIGGERED, SPELLVALUE_BASE_POINT0, aurEff->GetAmount(), target,
                              true, nullptr, aurEff);
  }
  ...
  void Register() override
  {
    AfterEffectApply += AuraEffectApplyFn(spell_dk_improved_unholy_presence::HandleEffectApply, EFFECT_0,
                                          SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
    AfterEffectRemove += AuraEffectRemoveFn(spell_dk_improved_unholy_presence::HandleEffectRemove, EFFECT_0,
                                            SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
  }
};
...
class spell_dk_presence : public AuraScript
{
  ...
  {
    return ValidateSpellInfo({SPELL_DK_BLOOD_PRESENCE, SPELL_DK_FROST_PRESENCE, SPELL_DK_UNHOLY_PRESENCE,
                              SPELL_DK_IMPROVED_BLOOD_PRESENCE_R1, SPELL_DK_IMPROVED_FROST_PRESENCE_R1,
                              SPELL_DK_IMPROVED_UNHOLY_PRESENCE_R1, SPELL_DK_IMPROVED_BLOOD_PRESENCE_TRIGGERED,
                              SPELL_DK_IMPROVED_UNHOLY_PRESENCE_TRIGGERED, SPELL_DK_FROST_PRESENCE_TRIGGERED,
  ...
  void HandleImprovedBloodPresence(AuraEffect const* aurEff, AuraEffectHandleModes /*mode*/)
  {
    ...
    if (GetId() == SPELL_DK_BLOOD_PRESENCE)
      ...
      if (!target->HasAura(SPELL_DK_IMPROVED_BLOOD_PRESENCE_TRIGGERED))
        target->CastCustomSpell(SPELL_DK_IMPROVED_BLOOD_PRESENCE_TRIGGERED, SPELLVALUE_BASE_POINT1,
                                impAurEff->GetAmount(), target, true, nullptr, aurEff);
  }
  ...
  void HandleImprovedFrostPresence(AuraEffect const* aurEff, AuraEffectHandleModes /*mode*/)
  {
    ...
    if (GetId() == SPELL_DK_FROST_PRESENCE)
      ...
      if (!target->HasAura(SPELL_DK_FROST_PRESENCE_TRIGGERED))
        target->CastCustomSpell(SPELL_DK_FROST_PRESENCE_TRIGGERED, SPELLVALUE_BASE_POINT0, impAurEff->GetAmount(),
                                target, true, nullptr, aurEff);
  }
  ...
  void HandleImprovedUnholyPresence(AuraEffect const* aurEff, AuraEffectHandleModes /*mode*/)
  {
            ...
            target->GetAuraEffectOfRankedSpell(SPELL_DK_IMPROVED_UNHOLY_PRESENCE_R1, EFFECT_0))
    {
      if (GetId() == SPELL_DK_UNHOLY_PRESENCE)
      {
        ...
        target->CastCustomSpell(target, SPELL_DK_IMPROVED_UNHOLY_PRESENCE_TRIGGERED, &bp, &bp, &bp, true, nullptr,
                                aurEff);
      }
      else if (!target->HasAura(SPELL_DK_UNHOLY_PRESENCE_TRIGGERED))
        target->CastCustomSpell(SPELL_DK_UNHOLY_PRESENCE_TRIGGERED, SPELLVALUE_BASE_POINT0, impAurEff->GetAmount(),
                                target, true, nullptr, aurEff);
    }
  }
  ...
  void Register() override
  {
    AfterEffectApply += AuraEffectApplyFn(spell_dk_presence::HandleImprovedBloodPresence, EFFECT_0, SPELL_AURA_ANY,
                                          AURA_EFFECT_HANDLE_REAL);
    AfterEffectApply += AuraEffectApplyFn(spell_dk_presence::HandleImprovedFrostPresence, EFFECT_0, SPELL_AURA_ANY,
                                          AURA_EFFECT_HANDLE_REAL);
    AfterEffectApply += AuraEffectApplyFn(spell_dk_presence::HandleImprovedUnholyPresence, EFFECT_0, SPELL_AURA_ANY,
                                          AURA_EFFECT_HANDLE_REAL);
    AfterEffectRemove +=
        AuraEffectRemoveFn(spell_dk_presence::HandleEffectRemove, EFFECT_0, SPELL_AURA_ANY, AURA_EFFECT_HANDLE_REAL);
  }
};
  ...
  bool operator()(WorldObject* obj) const
  {
    if (Unit* target = obj->ToUnit())
    {
      if (!target->IsAlive() && _caster->isHonorOrXPTarget(target) &&
          target->GetCreatureType() == CREATURE_TYPE_HUMANOID && target->GetDisplayId() == target->GetNativeDisplayId())
        return false;
    }
...
class spell_dk_raise_dead : public SpellScript
{
  ...
  void ConsumeReagents()
  {
    ...
    if (!_corpse)
      GetCaster()->CastSpell(GetCaster(), SPELL_DK_RAISE_DEAD_USE_REAGENT,
...
class spell_dk_rune_tap_party : public SpellScript
{
  ...
  {
    OnObjectAreaTargetSelect +=
        SpellObjectAreaTargetSelectFn(spell_dk_rune_tap_party::CheckTargets, EFFECT_0, TARGET_UNIT_CASTER_AREA_PARTY);
  }
};
...
class spell_dk_will_of_the_necropolis : public AuraScript
{
  ...
  {
    DoEffectCalcAmount +=
        AuraEffectCalcAmountFn(spell_dk_will_of_the_necropolis::CalculateAmount, EFFECT_0, SPELL_AURA_SCHOOL_ABSORB);
