...
public:
  ...
  ChatCommandTable GetCommands() const override
  {
    ...
    static ChatCommandTable learnCommandTable = {{"all", learnAllCommandTable},
                                                 {"", HandleLearnCommand, SEC_GAMEMASTER, Console::No}};

    static ChatCommandTable commandTable = {{"learn", learnCommandTable},
  ...
  static bool HandleUnLearnCommand(ChatHandler* handler, SpellInfo const* spell,
