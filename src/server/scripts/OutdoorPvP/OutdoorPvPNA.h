...
const go_type HordeControlGOs[NA_CONTROL_GO_NUM] = {
    ...
    {182222, 530, -1825.4022f, 8039.2602f, -26.08f, -2.89725f, 0.0f, 0.0f, 0.992546f,
    ...
    {182266, 530, -1815.8f, 8036.51f, -26.2354f, -2.89725f, 0.0f, 0.0f, 0.992546f,
     -0.121869f}, // DESTROYED_ALLY_ROOST_SOUTH
    {182275, 530, -1507.95f, 8132.1f, -19.5585f, -1.3439f, 0.0f, 0.0f, 0.622515f,
     -0.782608f}, // DESTROYED_ALLY_ROOST_WEST
    {182276, 530, -1384.52f, 7779.33f, -11.1663f, -0.575959f, 0.0f, 0.0f, 0.284015f,
     -0.95882f}, // DESTROYED_ALLY_ROOST_NORTH
    {182277, 530, -1650.11f, 7732.56f, -15.4505f, -2.80998f, 0.0f, 0.0f, 0.986286f,
...
const go_type AllianceControlGOs[NA_CONTROL_GO_NUM] = {
    ...
    {182305, 530, -1825.4022f, 8039.2602f, -26.08f, -2.89725f, 0.0f, 0.0f, 0.992546f,
    ...
    {182297, 530, -1815.8f, 8036.51f, -26.2354f, -2.89725f, 0.0f, 0.0f, 0.992546f,
     -0.121869f}, // DESTROYED_HORDE_ROOST_SOUTH
    {182298, 530, -1507.95f, 8132.1f, -19.5585f, -1.3439f, 0.0f, 0.0f, 0.622515f,
     -0.782608f}, // DESTROYED_HORDE_ROOST_WEST
    {182299, 530, -1384.52f, 7779.33f, -11.1663f, -0.575959f, 0.0f, 0.0f, 0.284015f,
     -0.95882f}, // DESTROYED_HORDE_ROOST_NORTH
    {182300, 530, -1650.11f, 7732.56f, -15.4505f, -2.80998f, 0.0f, 0.0f, 0.986286f,
