...
enum NPCFranklin
{
  ...
  FRANKLIN_DESPAWN_SAY  = 9815, // breadcast_text.ID          "Only a fool would
                                // remain in this battle..."
...
struct NPCStaveQuestAI : public ScriptedAI
{
  ...
  std::map<int, int> entryKeys = {{ARTORIUS_NORMAL_ENTRY, 1}, {ARTORIUS_EVIL_ENTRY, 1},   {SIMONE_NORMAL_ENTRY, 2},
                                  {SIMONE_EVIL_ENTRY, 2},     {PRECIOUS_NORMAL_ENTRY, 3}, {PRECIOUS_EVIL_ENTRY, 3},
                                  {NELSON_NORMAL_ENTRY, 4},   {NELSON_EVIL_ENTRY, 4},     {FRANKLIN_NORMAL_ENTRY, 5},
  ...
  std::map<int, std::map<std::string, int>> entryList = {
      ...
      {5, {{"normal", FRANKLIN_NORMAL_ENTRY}, {"evil", FRANKLIN_EVIL_ENTRY}}}};
