...
bool NPCStaveQuestAI::InNormalForm() { return me->GetEntry() == GetFormEntry("normal"); }
...
Player* NPCStaveQuestAI::GetGossipPlayer() { return ObjectAccessor::GetPlayer(*me, gossipPlayerGUID); }
...
void NPCStaveQuestAI::AttackedBy(Unit* attacker) { StoreAttackerGuidValue(attacker); }
...
public:
  ...
  CreatureAI* GetAI(Creature* creature) const override { return new npc_artoriusAI(creature); }
  ...
  struct npc_artoriusAI : public NPCStaveQuestAI
  {
    ...
    void UpdateAI(uint32 diff) override
    {
      ...
      if (UpdateVictim())
      {
        // This should prevent hunters from staying in combat when feign death is used and there is a bystander with 0
        // threat
        EvadeOnFeignDeath();
      }
      else
...
public:
  ...
  CreatureAI* GetAI(Creature* creature) const override { return new npc_preciousAI(creature); }
...
public:
  ...
  CreatureAI* GetAI(Creature* creature) const override { return new npc_simoneAI(creature); }
...
public:
  ...
  CreatureAI* GetAI(Creature* creature) const override { return new npc_nelsonAI(creature); }
...
public:
  ...
  CreatureAI* GetAI(Creature* creature) const override { return new npc_franklinAI(creature); }
