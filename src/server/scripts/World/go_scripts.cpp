...
public:
  ...
  bool OnGossipHello(Player* pPlayer, GameObject* go) override
  {
    ...
    {
      if (Creature* cr =
              go->SummonCreature(28105, 6708.7f, 5115.45f, -18.3f, 0.7f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 30000))
      {
        cr->Yell("My treasure! You no steal from Tartek, dumb big-tongue traitor thing. Tartek and nasty dragon going "
                 "to kill you! You so dumb.",
                 LANG_UNIVERSAL);
...
public:
  ...
  {
    go_witherbark_totem_bundleAI(GameObject* gameObject) : GameObjectAI(gameObject) { _timer = 1; }
  ...
  GameObjectAI* GetAI(GameObject* go) const override { return new go_witherbark_totem_bundleAI(go); }
};
...
public:
  ...
  {
    go_tadpole_cageAI(GameObject* gameObject) : GameObjectAI(gameObject) { requireSummon = 2; }
    ...
    void SummonTadpoles()
    {
      ...
      for (int8 i = 0; i < count; ++i)
        me->SummonCreature(NPC_WINTERFIN_TADPOLE, me->GetPositionX() + cos(2 * M_PI * i / 3.0f) * 0.60f,
                           me->GetPositionY() + std::sin(2 * M_PI * i / 3.0f) * 0.60f, me->GetPositionZ(),
                           me->GetOrientation(), TEMPSUMMON_CORPSE_TIMED_DESPAWN, 30000);
    }
  ...
  GameObjectAI* GetAI(GameObject* go) const override { return new go_tadpole_cageAI(go); }
};
...
public:
    ...
    void UpdateAI(uint32 diff) override
    {
      ...
      if (timer > 3000)
      {
        ...
        if (players.size() > 0)
        {
          ...
          if (Creature* trigger = me->SummonTrigger((*itr)->GetPositionX(), (*itr)->GetPositionY(),
                                                    (*itr)->GetPositionZ(), 0, 2000, true))
  ...
  GameObjectAI* GetAI(GameObject* go) const override { return new go_flamesAI(go); }
};
...
public:
  ...
  GameObjectAI* GetAI(GameObject* go) const override { return new go_heatAI(go); }
};
...
public:
  ...
  {
    go_bear_trapAI(GameObject* gameObject) : GameObjectAI(gameObject) { Initialize(); }
  ...
  GameObjectAI* GetAI(GameObject* go) const override { return new go_bear_trapAI(go); }
};
...
public:
  ...
  {
    go_l70_etc_musicAI(GameObject* go) : GameObjectAI(go) { _events.ScheduleEvent(EVENT_ETC_START_MUSIC, 1600); }
      ...
      while (uint32 eventId = _events.ExecuteEvent())
      {
        ...
        case EVENT_ETC_START_MUSIC:
          ...
          _events.ScheduleEvent(EVENT_ETC_START_MUSIC,
                                1600); // Every 1.6 seconds SMSG_PLAY_MUSIC packet (PlayDirectMusic) is pushed to the
                                       // client (sniffed value)
          break;
        default:
          break;
        }
  ...
  GameObjectAI* GetAI(GameObject* go) const override { return new go_l70_etc_musicAI(go); }
};
...
public:
    ...
    void UpdateAI(uint32 diff) override
    {
      ...
      while (uint32 eventId = _events.ExecuteEvent())
      {
        ...
        case EVENT_BM_SELECT_MUSIC:
        {
          ...
          if (me->GetAreaId() == SILVERMOON || me->GetAreaId() == UNDERCITY || me->GetAreaId() == ORGRIMMAR_1 ||
              me->GetAreaId() == ORGRIMMAR_2 || me->GetAreaId() == THUNDERBLUFF)
          {
            switch (rnd)
            {
            case 0:
          ...
          else if (me->GetAreaId() == IRONFORGE_1 || me->GetAreaId() == IRONFORGE_2 || me->GetAreaId() == STORMWIND ||
                   me->GetAreaId() == EXODAR || me->GetAreaId() == DARNASSUS)
          {
            switch (rnd)
            {
            case 0:
  ...
  GameObjectAI* GetAI(GameObject* go) const override { return new go_brewfest_musicAI(go); }
};
...
public:
  ...
  struct go_pirate_day_musicAI : public GameObjectAI
  {
    ...
    go_pirate_day_musicAI(GameObject* go) : GameObjectAI(go) { _events.ScheduleEvent(EVENT_PDM_START_MUSIC, 1000); }
      ...
      while (uint32 eventId = _events.ExecuteEvent())
      {
        ...
        case EVENT_PDM_START_MUSIC:
          ...
          _events.ScheduleEvent(EVENT_PDM_START_MUSIC,
                                5000); // Every 5 second's SMSG_PLAY_MUSIC packet (PlayDirectMusic) is pushed to the
                                       // client (sniffed value)
          break;
        default:
          break;
  ...
  GameObjectAI* GetAI(GameObject* go) const override { return new go_pirate_day_musicAI(go); }
};
...
public:
  ...
  struct go_darkmoon_faire_musicAI : public GameObjectAI
  {
    ...
    go_darkmoon_faire_musicAI(GameObject* go) : GameObjectAI(go) { _events.ScheduleEvent(EVENT_DFM_START_MUSIC, 1000); }
    ...
    void UpdateAI(uint32 diff) override
    {
      ...
      while (uint32 eventId = _events.ExecuteEvent())
      {
        ...
        case EVENT_DFM_START_MUSIC:
          if (!IsHolidayActive(HOLIDAY_DARKMOON_FAIRE_ELWYNN) || !IsHolidayActive(HOLIDAY_DARKMOON_FAIRE_THUNDER) ||
  ...
  GameObjectAI* GetAI(GameObject* go) const override { return new go_darkmoon_faire_musicAI(go); }
};
...
public:
  ...
  {
    go_midsummer_musicAI(GameObject* go) : GameObjectAI(go) { _events.ScheduleEvent(EVENT_MM_START_MUSIC, 1000); }
  ...
  GameObjectAI* GetAI(GameObject* go) const override { return new go_midsummer_musicAI(go); }
};
...
public:
    ...
    void UpdateAI(uint32 const diff) override
    {
      ...
      while (uint32 eventId = _events.ExecuteEvent())
      {
        ...
        case EVENT_STILLBLADE_SPAWN:
        {
          ...
          {
            player->SummonCreature(NPC_STILLBLADE, 8032.587f, -7524.518f, 149.68073f, 6.161012172698974609f,
                                   TEMPSUMMON_DEAD_DESPAWN, 60000);
  ...
  GameObjectAI* GetAI(GameObject* go) const override { return new go_gilded_brazierAI(go); }
};
...
public:
  ...
  bool OnGossipHello(Player* player, GameObject* go) override
  {
    if (go->GetGoType() == GAMEOBJECT_TYPE_GOOBER)
      player->SummonCreature(NPC_ARIKARA, -5008.338f, -2118.894f, 83.657f, 0.874f,
...
public:
    ...
    bool OnGossipHello(Player* player, GameObject* go) override
    {
        ...
        if (BirdEntry)
            player->SummonCreature(BirdEntry, fX, fY, fZ, go->GetOrientation(), TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT,
60000);
...
public:
  ...
  bool OnGossipHello(Player* player, GameObject* go) override
  {
    ...
    AddGossipItemFor(player, GOSSIP_ICON_CHAT, GOSSIP_FEL_CRYSTALFORGE_ITEM_1, GOSSIP_SENDER_MAIN,
                     GOSSIP_ACTION_INFO_DEF);
    AddGossipItemFor(player, GOSSIP_ICON_CHAT, GOSSIP_FEL_CRYSTALFORGE_ITEM_5, GOSSIP_SENDER_MAIN,
  ...
  bool OnGossipSelect(Player* player, GameObject* go, uint32 /*sender*/, uint32 action) override
  {
    ...
    case GOSSIP_ACTION_INFO_DEF:
      ...
      AddGossipItemFor(player, GOSSIP_ICON_CHAT, GOSSIP_FEL_CRYSTALFORGE_ITEM_RETURN, GOSSIP_SENDER_MAIN,
...
public:
  ...
  bool OnGossipHello(Player* player, GameObject* go) override
  {
    ...
    AddGossipItemFor(player, GOSSIP_ICON_CHAT, GOSSIP_BASHIR_CRYSTALFORGE_ITEM_1, GOSSIP_SENDER_MAIN,
                     GOSSIP_ACTION_INFO_DEF);
    AddGossipItemFor(player, GOSSIP_ICON_CHAT, GOSSIP_BASHIR_CRYSTALFORGE_ITEM_5, GOSSIP_SENDER_MAIN,
                     GOSSIP_ACTION_INFO_DEF + 1);
  ...
  bool OnGossipSelect(Player* player, GameObject* go, uint32 /*sender*/, uint32 action) override
  {
    ...
    case GOSSIP_ACTION_INFO_DEF:
      ...
      AddGossipItemFor(player, GOSSIP_ICON_CHAT, GOSSIP_BASHIR_CRYSTALFORGE_ITEM_RETURN, GOSSIP_SENDER_MAIN,
                       GOSSIP_ACTION_INFO_DEF + 2);
...
public:
  ...
  GameObjectAI* GetAI(GameObject* go) const override { return new go_soulwellAI(go); }
};
...
public:
  ...
  bool OnGossipHello(Player* player, GameObject* go) override
  {
    ...
    go->SummonCreature(NPC_HIVE_AMBUSHER, go->GetPositionX() + 1, go->GetPositionY(), go->GetPositionZ(),
                       go->GetAngle(player), TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 60000);
    go->SummonCreature(NPC_HIVE_AMBUSHER, go->GetPositionX(), go->GetPositionY() + 1, go->GetPositionZ(),
                       go->GetAngle(player), TEMPSUMMON_TIMED_OR_DEAD_DESPAWN, 60000);
    return true;
  }
};
...
public:
  ...
  GameObjectAI* GetAI(GameObject* go) const override { return new go_bellsAI(go); }
};
