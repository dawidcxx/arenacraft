...
void LootItemStorage::LoadStorageFromDB()
{
  ...
  do
  {
    ...
    itemList.emplace_back(fields[1].Get<uint32>(), fields[2].Get<uint32>(), fields[3].Get<uint32>(),
                          fields[4].Get<int32>(), fields[5].Get<uint32>(), fields[6].Get<bool>(), fields[7].Get<bool>(),
                          fields[8].Get<bool>(), fields[9].Get<bool>(), fields[10].Get<bool>(), fields[11].Get<bool>(),
...
void LootItemStorage::AddNewStoredLoot(Loot* loot, Player* /*player*/)
{
  ...
  if (!loot->isLooted())
    for (LootItemList::const_iterator li = loot->items.begin(); li != loot->items.end(); li++)
    {
      ...
      itemList.emplace_back(li->itemid, li->itemIndex, li->count, li->randomPropertyId, li->randomSuffix,
                            li->follow_loot_rules, li->freeforall, li->is_blocked, li->is_counted,
