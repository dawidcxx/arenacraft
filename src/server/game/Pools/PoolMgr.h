...
{
public:
  template <typename T> bool IsActiveObject(uint32 db_guid_or_pool_id) const;

  uint32 GetActiveObjectCount(uint32 pool_id) const;

  template <typename T> void ActivateObject(uint32 db_guid_or_pool_id, uint32 pool_id);

  template <typename T> void RemoveObject(uint32 db_guid_or_pool_id, uint32 pool_id);
...
public:
  ...
  template <typename T> uint32 IsPartOfAPool(uint32 db_guid_or_pool_id) const;
  ...
  template <typename T> void UpdatePool(uint32 pool_id, uint32 db_guid_or_pool_id);
...
private:
  template <typename T> void SpawnPool(uint32 pool_id, uint32 db_guid_or_pool_id);
...
// yes
template <> inline uint32 PoolMgr::IsPartOfAPool<Creature>(uint32 db_guid) const
{
...
// if yes
template <> inline uint32 PoolMgr::IsPartOfAPool<GameObject>(uint32 db_guid) const
{
...
// if yes
template <> inline uint32 PoolMgr::IsPartOfAPool<Quest>(uint32 questId) const
{
...
// if yes
template <> inline uint32 PoolMgr::IsPartOfAPool<Pool>(uint32 pool_id) const
{
