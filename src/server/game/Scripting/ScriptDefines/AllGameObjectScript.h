...
public:
  ...
  [[nodiscard]] virtual bool CanGameObjectGossipSelect(Player* /*player*/, GameObject* /*go*/, uint32 /*sender*/,
                                                       uint32 /*action*/)
  {
    return false;
  }
  ...
  // gossip menu.
  [[nodiscard]] virtual bool CanGameObjectGossipSelectCode(Player* /*player*/, GameObject* /*go*/, uint32 /*sender*/,
  ...
  [[nodiscard]] virtual bool CanGameObjectQuestAccept(Player* /*player*/, GameObject* /*go*/, Quest const* /*quest*/)
  {
    return false;
  }

  // Called when a player selects a quest reward.
  [[nodiscard]] virtual bool CanGameObjectQuestReward(Player* /*player*/, GameObject* /*go*/, Quest const* /*quest*/,
                                                      uint32 /*opt*/)
  {
    return false;
  }
  ...
  // Called when the health of a game object is modified (destructible buildings
  // only).
  virtual void OnGameObjectModifyHealth(GameObject* /*go*/, Unit* /*attackerOrHealer*/, int32& /*change*/,
