...
public:
  ...
  [[nodiscard]] virtual bool IsCompletedCriteria(AchievementMgr* /*mgr*/,
  ...
  [[nodiscard]] virtual bool IsRealmCompleted(AchievementGlobalMgr const* /*globalmgr*/,
                                              AchievementEntry const* /*achievement*/,
  ...
  virtual void OnBeforeCheckCriteria(AchievementMgr* /*mgr*/,
                                     std::list<AchievementCriteriaEntry const*> const* /*achievementCriteriaList*/)
  {
  }

  [[nodiscard]] virtual bool CanCheckCriteria(AchievementMgr* /*mgr*/,
                                              AchievementCriteriaEntry const* /*achievementCriteria*/)
  {
    return true;
  }
