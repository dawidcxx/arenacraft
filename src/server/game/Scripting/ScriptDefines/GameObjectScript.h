...
public:
  ...
  [[nodiscard]] virtual bool OnGossipSelect(Player* /*player*/, GameObject* /*go*/, uint32 /*sender*/,
                                            uint32 /*action*/)
  {
    return false;
  }
  ...
  // gossip menu.
  [[nodiscard]] virtual bool OnGossipSelectCode(Player* /*player*/, GameObject* /*go*/, uint32 /*sender*/,
  ...
  [[nodiscard]] virtual bool OnQuestReward(Player* /*player*/, GameObject* /*go*/, Quest const* /*quest*/,
                                           uint32 /*opt*/)
  {
    return false;
  }
  ...
  // only).
  virtual void OnModifyHealth(GameObject* /*go*/, Unit* /*attackerOrHealer*/, int32& /*change*/,
