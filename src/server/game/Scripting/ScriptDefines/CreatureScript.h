...
public:
  ...
  [[nodiscard]] virtual bool OnGossipSelect(Player* /*player*/, Creature* /*creature*/, uint32 /*sender*/,
                                            uint32 /*action*/)
  {
    return false;
  }
  ...
  // menu.
  [[nodiscard]] virtual bool OnGossipSelectCode(Player* /*player*/, Creature* /*creature*/, uint32 /*sender*/,
  ...
  [[nodiscard]] virtual bool OnQuestReward(Player* /*player*/, Creature* /*creature*/, Quest const* /*quest*/,
                                           uint32 /*opt*/)
  {
    return false;
  }
