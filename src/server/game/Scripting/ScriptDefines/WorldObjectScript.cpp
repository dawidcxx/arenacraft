...
void ScriptMgr::OnWorldObjectSetMap(WorldObject* object, Map* map)
{
  ...
  CALL_ENABLED_HOOKS(WorldObjectScript, WORLDOBJECTHOOK_ON_WORLD_OBJECT_SET_MAP,
...
void ScriptMgr::OnWorldObjectResetMap(WorldObject* object)
{
  ...
  CALL_ENABLED_HOOKS(WorldObjectScript, WORLDOBJECTHOOK_ON_WORLD_OBJECT_RESET_MAP,
...
void ScriptMgr::OnWorldObjectUpdate(WorldObject* object, uint32 diff)
{
  ...
  CALL_ENABLED_HOOKS(WorldObjectScript, WORLDOBJECTHOOK_ON_WORLD_OBJECT_UPDATE,
