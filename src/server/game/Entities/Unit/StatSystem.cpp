...
void Player::UpdateAttackPowerAndDamage(bool ranged)
{
  ...
  {
    if (IsClass(CLASS_PALADIN, CLASS_CONTEXT_STATS) || IsClass(CLASS_DEATH_KNIGHT, CLASS_CONTEXT_STATS) ||
...
void Player::UpdateParryPercentage()
{
  ...
  if (CanParry() && parry_cap[pclass] > 0.0f)
  {
    ...
    m_realParry =
        nondiminishing + diminishing * parry_cap[pclass] / (diminishing + parry_cap[pclass] * m_diminishing_k[pclass]);
...
void Player::UpdateDodgePercentage()
{
  ...
  uint32 pclass = getClass() - 1;
  m_realDodge =
      nondiminishing + (diminishing * dodge_cap[pclass] / (diminishing + dodge_cap[pclass] * m_diminishing_k[pclass]));
