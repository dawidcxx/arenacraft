...
#define MAX_SEARCHER_DISTANCE                                                                                          \
  150.0f // pussywizard: replace the use of MAX_VISIBILITY_DISTANCE in
         // searchers, because MAX_VISIBILITY_DISTANCE is quite too big for this
         // purpose
...
uint32 PAIR64_HIPART(uint64 x) { return (uint32)((x >> 32) & UI64LIT(0x00000000FFFFFFFF)); }

uint32 PAIR64_LOPART(uint64 x) { return (uint32)(x & UI64LIT(0x00000000FFFFFFFF)); }
