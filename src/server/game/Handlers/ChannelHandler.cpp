...
void WorldSession::HandleJoinChannel(WorldPacket& recvPacket)
{
  ...
  LOG_DEBUG("chat.system", "CMSG_JOIN_CHANNEL {} Channel: {}, unk1: {}, unk2: {}, channel: {}, password: {}",
...
void WorldSession::HandleChannelPassword(WorldPacket& recvPacket)
{
  ...
  LOG_DEBUG("chat.system", "CMSG_CHANNEL_PASSWORD {} Channel: {}, Password: {}", GetPlayerInfo(), channelName,
            password);
...
void WorldSession::HandleChannelSetOwner(WorldPacket& recvPacket)
{
  ...
  LOG_DEBUG("chat.system", "CMSG_CHANNEL_SET_OWNER {} Channel: {}, Target: {}", GetPlayerInfo(), channelName,
            targetName);
...
void WorldSession::HandleChannelModerator(WorldPacket& recvPacket)
{
  ...
  LOG_DEBUG("chat.system", "CMSG_CHANNEL_MODERATOR {} Channel: {}, Target: {}", GetPlayerInfo(), channelName,
            targetName);
  if (!normalizePlayerName(targetName))
    return;
...
void WorldSession::HandleChannelUnmoderator(WorldPacket& recvPacket)
{
  ...
  LOG_DEBUG("chat.system", "CMSG_CHANNEL_UNMODERATOR {} Channel: {}, Target: {}", GetPlayerInfo(), channelName,
            targetName);
  if (!normalizePlayerName(targetName))
    return;
...
void WorldSession::HandleChannelUnmute(WorldPacket& recvPacket)
{
  ...
  LOG_DEBUG("chat.system", "CMSG_CHANNEL_UNMUTE {} Channel: {}, Target: {}", GetPlayerInfo(), channelName, targetName);
  if (!normalizePlayerName(targetName))
    return;
...
void WorldSession::HandleChannelInvite(WorldPacket& recvPacket)
{
  ...
  LOG_DEBUG("chat.system", "CMSG_CHANNEL_INVITE {} Channel: {}, Target: {}", GetPlayerInfo(), channelName, targetName);
  if (!normalizePlayerName(targetName))
    return;
...
void WorldSession::HandleGetChannelMemberCount(WorldPacket& recvPacket)
{
  ...
  if (ChannelMgr* cMgr = ChannelMgr::forTeam(GetPlayer()->GetTeamId()))
  {
    if (Channel* channel = cMgr->GetChannel(channelName, GetPlayer()))
    {
      LOG_DEBUG("chat.system", "SMSG_CHANNEL_MEMBER_COUNT {} Channel: {} Count: {}", GetPlayerInfo(), channelName,
