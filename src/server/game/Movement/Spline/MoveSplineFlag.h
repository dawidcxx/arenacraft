...
public:
  ...
  {
    None = 0x00000000,
    // x00-xFF(first byte) used as animation Ids storage in pair with Animation
    // flag
    Done    = 0x00000100,
    Falling = 0x00000200, // Affects elevation computation, can't be combined
                          // with Parabolic flag
    No_Spline = 0x00000400,
    Parabolic = 0x00000800, // Affects elevation computation, can't be combined
                            // with Falling flag
    Walkmode = 0x00001000,
    ...
    Enter_Cycle      = 0x00100000,    // Everytimes appears with cyclic flag in monster move
                                      // packet, erases first spline vertex after first cycle done
