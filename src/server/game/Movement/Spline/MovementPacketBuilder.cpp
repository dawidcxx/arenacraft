...
void PacketBuilder::WriteCommonMonsterMovePart(const MoveSpline& move_spline, ByteBuffer& data)
{
  ...
  // add fake Enter_Cycle flag - needed for client-side cyclic movement (client will erase first spline vertex after
  // first cycle done) Xinef: this flag breaks cycle for ground movement, client teleports npc between last and first
  // point instead of using smooth movement
