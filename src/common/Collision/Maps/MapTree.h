...
private:
  ...
  // stores <tree_index, reference_count> to invalidate tree values, unload map,
  // and to be able to report errors
  loadedSpawnMap iLoadedSpawns;
  std::string    iBasePath;

private:
  bool GetIntersectionTime(const G3D::Ray& pRay, float& pMaxDist, bool StopAtFirstHit,
...
public:
  ...
  [[nodiscard]] bool  isInLineOfSight(const G3D::Vector3& pos1, const G3D::Vector3& pos2,
                                      ModelIgnoreFlags ignoreFlags) const;
  bool                GetObjectHitPos(const G3D::Vector3& pos1, const G3D::Vector3& pos2, G3D::Vector3& pResultHitPos,
