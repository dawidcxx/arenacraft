...
template <GenericHashImpl::HashCreator HashCreator, std::size_t DigestLength> class GenericHash
{
public:
  ...
  GenericHash(GenericHash const& right) : _ctx(GenericHashImpl::MakeCTX()) { *this = right; }
