...
template <> AC_COMMON_API uint32 Acore::Time::TimeStringTo<Seconds>(std::string_view timestring)
{
  uint32 secs       = 0;
  uint32 buffer     = 0;
  uint32 multiplier = 0;
...
template <>
AC_COMMON_API std::string Acore::Time::ToTimeString<Microseconds>(uint64     durationTime,
                                                                  ...
                                                                  TimeFormat timeFormat /*= TimeFormat::ShortText*/)
{
  ...
  auto GetStringFormat =
      [&](uint32 timeType, std::string_view shortText, std::string_view fullText1, std::string_view fullText)
  {
    ss << timeType;
...
template <>
AC_COMMON_API std::string Acore::Time::ToTimeString<Milliseconds>(uint64     durationTime,
                                                                  TimeOutput timeOutput /*= TimeOutput::Seconds*/,
                                                                  TimeFormat timeFormat /*= TimeFormat::ShortText*/)
{
...
template <>
AC_COMMON_API std::string Acore::Time::ToTimeString<Seconds>(uint64     durationTime,
                                                             TimeOutput timeOutput /*= TimeOutput::Seconds*/,
                                                             TimeFormat timeFormat /*= TimeFormat::ShortText*/)
{
...
template <>
AC_COMMON_API std::string Acore::Time::ToTimeString<Minutes>(uint64     durationTime,
                                                             TimeOutput timeOutput /*= TimeOutput::Seconds*/,
                                                             TimeFormat timeFormat /*= TimeFormat::ShortText*/)
{
...
template <>
AC_COMMON_API std::string Acore::Time::ToTimeString<Seconds>(std::string_view durationTime,
                                                             TimeOutput       timeOutput /*= TimeOutput::Seconds*/,
                                                             TimeFormat       timeFormat /*= TimeFormat::ShortText*/)
{
...
std::string Acore::Time::ToTimeString(Microseconds durationTime, TimeOutput timeOutput /*= TimeOutput::Seconds*/,
                                      TimeFormat timeFormat /*= TimeFormat::ShortText*/)
{
