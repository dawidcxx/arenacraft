...
/**
    ...
    to log crashes. exit(1) calls here are for static analysis tools to indicate that calling functions defined in this
   file terminates the application.
 */
 ...
 */
inline std::string MakeMessage(std::string_view messageType, std::string_view file, uint32 line,
                               std::string_view function, std::string_view message, std::string_view fmtMessage = {},
 ...
 * @param fmtMessage [optional] Display format message after condition
 */
inline std::string MakeAbortMessage(std::string_view file, uint32 line, std::string_view function,
...
void Acore::Assert(std::string_view file, uint32 line, std::string_view function, std::string_view debugInfo,
...
void Acore::Fatal(std::string_view file, uint32 line, std::string_view function, std::string_view message,
                  std::string_view fmtMessage /*= {}*/)
{
