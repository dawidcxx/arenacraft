...
{
  return uniqueObjectIds.emplace(std::make_pair(clientId, clientDoodadId), uint32(uniqueObjectIds.size() + 1))
      .first->second;
}
...
bool ExtractSingleWmo(std::string& fname)
{
  ...
  // store the correct no of groups (excludes skipped antiportals/unreachable)
