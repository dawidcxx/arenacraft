...
enum AcoreStrings
{
  ...
  LANG_ARENA_YOUR_TEAM_ONLY  = 722,               // "Your group has members not in your arena
                                                  // team. Please regroup to join."
  ...
  LANG_BG_GROUP_MIXED_FACTION = 728,              // "Your group has players from the opposing faction. You can't join
                                                  // the battleground as a group."
  LANG_BG_GROUP_MIXED_LEVELS = 729,               // "Your group has players from different battleground brakets. You
                                                  // can't join as group."
  LANG_BG_GROUP_MEMBER_ALREADY_IN_QUEUE = 730,    // "Someone in your party is already in this battleground queue.
  ...
  LANG_BG_GROUP_MEMBER_NO_FREE_QUEUE_SLOTS = 732, // "Someone in your party is already in three battleground queues.
  ...
  LANG_CANNOT_GO_TO_BG_FROM_BG = 736, // "You cannot teleport to a battleground from another battleground.
                                      // Please leave the current battleground first."
  ...
  LANG_BG_SA_ROUND_TWO_ONE_MINUTE    = 10065,     // Round 2 of the Battle for the Strand of the Ancients begins in 1
                                                  // minute.
