...
public:
  ...
  struct InstResetEvent
  {
    ...
    InstResetEvent(uint8 t, uint32 _mapid, Difficulty d) : type(t), difficulty(d), mapid(_mapid) {}
  };
  ...
  void SetResetTimeFor(uint32 mapid, Difficulty d, time_t t) { m_resetTimeByMapDifficulty[MAKE_PAIR32(mapid, d)] = t; }
  ...
  [[nodiscard]] ResetTimeByMapDifficultyMap const& GetResetTimeMap() const { return m_resetTimeByMapDifficulty; }
  ...
  InstancePlayerBind* PlayerBindToInstance(ObjectGuid guid, InstanceSave* save, bool permanent,
