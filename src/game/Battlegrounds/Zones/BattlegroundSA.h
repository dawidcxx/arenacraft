...
uint32 const BG_SA_NpcEntries[BG_SA_MAXNPC] = {
    NPC_ANTI_PERSONNAL_CANNON, NPC_ANTI_PERSONNAL_CANNON, NPC_ANTI_PERSONNAL_CANNON, NPC_ANTI_PERSONNAL_CANNON,
    NPC_ANTI_PERSONNAL_CANNON, NPC_ANTI_PERSONNAL_CANNON, NPC_ANTI_PERSONNAL_CANNON, NPC_ANTI_PERSONNAL_CANNON,
    NPC_ANTI_PERSONNAL_CANNON, NPC_ANTI_PERSONNAL_CANNON,
    // Triggers
...
const float SOTADefPortalDest[5][4] = {
    {1388.94f, 103.067f, 34.49f, 5.4571f},    {1043.69f, -87.95f, 87.12f, 0.003f},
    {1441.0411f, -240.974f, 35.264f, 0.949f}, {1228.342f, -235.234f, 60.03f, 0.4584f},
