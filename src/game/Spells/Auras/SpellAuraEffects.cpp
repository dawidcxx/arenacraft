...
// AURA_EFFECT_HANDLE_CHANGE_AMOUNT_MASK set - aura is recalculated or is just applied/removed - need to redo all things
// related to m_amount AURA_EFFECT_HANDLE_CHANGE_AMOUNT_SEND_FOR_CLIENT_MASK - logical or of above conditions
...
pAuraEffectHandler AuraEffectHandler[TOTAL_AURAS] = {
    ...
    &AuraEffect::HandleNoImmediateEffect, // 14 SPELL_AURA_MOD_DAMAGE_TAKEN implemented in Unit::MeleeDamageBonus and
    ...
    &AuraEffect::HandleNoImmediateEffect,     // 23 SPELL_AURA_PERIODIC_TRIGGER_SPELL implemented in
    ...
    &AuraEffect::HandleNoImmediateEffect,           // 42 SPELL_AURA_PROC_TRIGGER_SPELL  implemented in
                                                    // Unit::ProcDamageAndSpellFor and Unit::HandleProcTriggerSpell
    &AuraEffect::HandleNoImmediateEffect,           // 43 SPELL_AURA_PROC_TRIGGER_DAMAGE implemented in
    ...
    &AuraEffect::HandleNoImmediateEffect,        // 50 SPELL_AURA_MOD_CRITICAL_HEALING_AMOUNT implemented in
    ...
    &AuraEffect::HandleNoImmediateEffect,        // 59 SPELL_AURA_MOD_DAMAGE_DONE_CREATURE implemented in
                                                 // Unit::MeleeDamageBonus and Unit::SpellDamageBonus
    ...
    &AuraEffect::HandleNoImmediateEffect,        // 62 SPELL_AURA_PERIODIC_HEALTH_FUNNEL implemented in
                                                 // AuraEffect::PeriodicTick
    ...
    &AuraEffect::HandleNoImmediateEffect,    // 87 SPELL_AURA_MOD_DAMAGE_PERCENT_TAKEN implemented in
                                             // Unit::MeleeDamageBonus and Unit::SpellDamageBonus
    &AuraEffect::HandleNoImmediateEffect,    // 88 SPELL_AURA_MOD_HEALTH_REGEN_PERCENT implemented in
    ...
    &AuraEffect::HandleUnused, // 100 SPELL_AURA_AURAS_VISIBLE obsolete? all player can see all auras now, but still
                               // have spells including GM-spell
    &AuraEffect::HandleModResistancePercent, // 101 SPELL_AURA_MOD_RESISTANCE_PCT
    &AuraEffect::HandleNoImmediateEffect,    // 102 SPELL_AURA_MOD_MELEE_ATTACK_POWER_VERSUS implemented in
    ...
    &AuraEffect::HandleNoImmediateEffect,    // 107 SPELL_AURA_ADD_FLAT_MODIFIER implemented in
                                             // AuraEffect::CalculateSpellMod()
    &AuraEffect::HandleNoImmediateEffect,    // 108 SPELL_AURA_ADD_PCT_MODIFIER implemented in
                                             // AuraEffect::CalculateSpellMod()
    &AuraEffect::HandleNoImmediateEffect,    // 109 SPELL_AURA_ADD_TARGET_TRIGGER
    &AuraEffect::HandleModPowerRegenPCT,  // 110 SPELL_AURA_MOD_POWER_REGEN_PERCENT implemented in Player::Regenerate,
                                          // Creature::Regenerate
    &AuraEffect::HandleNoImmediateEffect, // 111 SPELL_AURA_ADD_CASTER_HIT_TRIGGER implemented in
                                          // Unit::SelectMagnetTarget
    &AuraEffect::HandleNoImmediateEffect, // 112 SPELL_AURA_OVERRIDE_CLASS_SCRIPTS
    &AuraEffect::HandleNoImmediateEffect, // 113 SPELL_AURA_MOD_RANGED_DAMAGE_TAKEN implemented in
                                          // Unit::MeleeDamageBonus
    &AuraEffect::HandleNoImmediateEffect, // 114 SPELL_AURA_MOD_RANGED_DAMAGE_TAKEN_PCT implemented in
                                          // Unit::MeleeDamageBonus
    &AuraEffect::HandleNoImmediateEffect, // 115 SPELL_AURA_MOD_HEALING                 implemented in
                                          // Unit::SpellBaseHealingBonusForVictim
    &AuraEffect::HandleNoImmediateEffect, // 116 SPELL_AURA_MOD_REGEN_DURING_COMBAT
    &AuraEffect::HandleNoImmediateEffect, // 117 SPELL_AURA_MOD_MECHANIC_RESISTANCE     implemented in
                                          // Unit::MagicSpellHitResult
    &AuraEffect::HandleNoImmediateEffect, // 118 SPELL_AURA_MOD_HEALING_PCT             implemented in
    ...
    &AuraEffect::HandleNoImmediateEffect, // 126 SPELL_AURA_MOD_MELEE_DAMAGE_TAKEN_PCT implemented in
                                          // Unit::MeleeDamageBonus
    &AuraEffect::HandleNoImmediateEffect, // 127 SPELL_AURA_RANGED_ATTACK_POWER_ATTACKER_BONUS implemented in
                                          // Unit::MeleeDamageBonus
    ...
    &AuraEffect::HandleNoImmediateEffect,            // 131 SPELL_AURA_MOD_RANGED_ATTACK_POWER_VERSUS implemented in
                                                     // Unit::MeleeDamageBonus
    ...
    &AuraEffect::HandleNoImmediateEffect,            // 136 SPELL_AURA_MOD_HEALING_DONE_PERCENT   implemented in
                                                     // Unit::SpellHealingBonus
    ...
    &AuraEffect::HandleNoImmediateEffect,            // 144 SPELL_AURA_SAFE_FALL                         implemented in
    ...
    &AuraEffect::HandleNoImmediateEffect, // 160 SPELL_AURA_MOD_AOE_AVOIDANCE                 implemented in
                                          // Unit::MagicSpellHitResult
    ...
    &AuraEffect::HandleNoImmediateEffect, // 165 SPELL_AURA_MELEE_ATTACK_POWER_ATTACKER_BONUS implemented in
                                          // Unit::MeleeDamageBonus
    ...
    &AuraEffect::HandleNoImmediateEffect, // 168 SPELL_AURA_MOD_DAMAGE_DONE_VERSUS            implemented in
                                          // Unit::SpellDamageBonus, Unit::MeleeDamageBonus
    &AuraEffect::HandleNoImmediateEffect, // 169 SPELL_AURA_MOD_CRIT_PERCENT_VERSUS           implemented in
                                          // Unit::DealDamageBySchool, Unit::DoAttackDamage, Unit::SpellCriticalBonus
    &AuraEffect::HandleDetectAmore, // 170 SPELL_AURA_DETECT_AMORE       various spells that change visual of units for
                                    // aura target (clientside?)
    &AuraEffect::HandleAuraModIncreaseSpeed,        // 171 SPELL_AURA_MOD_SPEED_NOT_STACK
    &AuraEffect::HandleAuraModIncreaseMountedSpeed, // 172 SPELL_AURA_MOD_MOUNTED_SPEED_NOT_STACK
    &AuraEffect::HandleNULL, // 173 unused (3.2.0) no spells, old SPELL_AURA_ALLOW_CHAMPION_SPELLS  only for Proclaim
                             // Champion spell
    &AuraEffect::HandleModSpellDamagePercentFromStat, // 174 SPELL_AURA_MOD_SPELL_DAMAGE_OF_STAT_PERCENT  implemented in
                                                      // Unit::SpellBaseDamageBonus
    &AuraEffect::HandleModSpellHealingPercentFromStat, // 175 SPELL_AURA_MOD_SPELL_HEALING_OF_STAT_PERCENT implemented
                                                       // in Unit::SpellBaseHealingBonus
    &AuraEffect::HandleSpiritOfRedemption, // 176 SPELL_AURA_SPIRIT_OF_REDEMPTION   only for Spirit of Redemption spell,
                                           // die at aura end
    &AuraEffect::HandleCharmConvert,       // 177 SPELL_AURA_AOE_CHARM
    &AuraEffect::HandleNoImmediateEffect,  // 178 SPELL_AURA_MOD_DEBUFF_RESISTANCE          implemented in
                                           // Unit::MagicSpellHitResult
    &AuraEffect::HandleNoImmediateEffect,  // 179 SPELL_AURA_MOD_ATTACKER_SPELL_CRIT_CHANCE implemented in
                                           // Unit::SpellCriticalBonus
    &AuraEffect::HandleNoImmediateEffect,  // 180 SPELL_AURA_MOD_FLAT_SPELL_DAMAGE_VERSUS   implemented in
                                           // Unit::SpellDamageBonus
    ...
    &AuraEffect::HandleNoImmediateEffect,      // 184 SPELL_AURA_MOD_ATTACKER_MELEE_HIT_CHANCE  implemented in
                                               // Unit::RollMeleeOutcomeAgainst
    &AuraEffect::HandleNoImmediateEffect,      // 185 SPELL_AURA_MOD_ATTACKER_RANGED_HIT_CHANCE implemented in
                                               // Unit::RollMeleeOutcomeAgainst
    &AuraEffect::HandleNoImmediateEffect,      // 186 SPELL_AURA_MOD_ATTACKER_SPELL_HIT_CHANCE  implemented in
                                               // Unit::MagicSpellHitResult
    &AuraEffect::HandleNoImmediateEffect,      // 187 SPELL_AURA_MOD_ATTACKER_MELEE_CRIT_CHANCE  implemented in
                                               // ObjectAccessor::GetUnitCriticalChance
    &AuraEffect::HandleNoImmediateEffect,      // 188 SPELL_AURA_MOD_ATTACKER_RANGED_CRIT_CHANCE implemented in
                                               // ObjectAccessor::GetUnitCriticalChance
    &AuraEffect::HandleModRating,              // 189 SPELL_AURA_MOD_RATING
    &AuraEffect::HandleNoImmediateEffect,      // 190 SPELL_AURA_MOD_FACTION_REPUTATION_GAIN     implemented in
    ...
    &AuraEffect::HandleNoImmediateEffect,      // 194 SPELL_AURA_MOD_TARGET_ABSORB_SCHOOL implemented in
                                               // Unit::CalcAbsorbResist
    &AuraEffect::HandleNoImmediateEffect,      // 195 SPELL_AURA_MOD_TARGET_ABILITY_ABSORB_SCHOOL implemented in
                                               // Unit::CalcAbsorbResist
    &AuraEffect::HandleNoImmediateEffect,      // 196 SPELL_AURA_MOD_COOLDOWN - flat mod of spell cooldowns
    &AuraEffect::HandleNoImmediateEffect, // 197 SPELL_AURA_MOD_ATTACKER_SPELL_AND_WEAPON_CRIT_CHANCE implemented in
                                          // Unit::SpellCriticalBonus ObjectAccessor::GetUnitCriticalChance
    &AuraEffect::HandleNULL,              // 198 unused (3.2.0) old SPELL_AURA_MOD_ALL_WEAPON_SKILLS
    &AuraEffect::HandleNoImmediateEffect, // 199 SPELL_AURA_MOD_INCREASES_SPELL_PCT_TO_HIT  implemented in
                                          // Unit::MagicSpellHitResult
    &AuraEffect::HandleNoImmediateEffect, // 200 SPELL_AURA_MOD_XP_PCT implemented in Player::RewardPlayerAndGroupAtKill
    &AuraEffect::HandleAuraAllowFlight,   // 201 SPELL_AURA_FLY                             this aura enable flight
                                          // mode...
    &AuraEffect::HandleNoImmediateEffect, // 202 SPELL_AURA_CANNOT_BE_DODGED                implemented in
                                          // Unit::RollPhysicalOutcomeAgainst
    &AuraEffect::HandleNoImmediateEffect, // 203 SPELL_AURA_MOD_ATTACKER_MELEE_CRIT_DAMAGE  implemented in
                                          // Unit::CalculateMeleeDamage and Unit::CalculateSpellDamage
    &AuraEffect::HandleNoImmediateEffect, // 204 SPELL_AURA_MOD_ATTACKER_RANGED_CRIT_DAMAGE implemented in
                                          // Unit::CalculateMeleeDamage and Unit::CalculateSpellDamage
    ...
    &AuraEffect::HandleNoImmediateEffect,  // 227 SPELL_AURA_PERIODIC_TRIGGER_SPELL_WITH_VALUE implemented in
                                           // AuraEffect::PeriodicTick
    ...
    &AuraEffect::HandleAuraModIncreaseMaxHealth, // 230 SPELL_AURA_MOD_INCREASE_HEALTH_2 only Blood Pact and Commanding
                                                 // Shout
    &AuraEffect::HandleNoImmediateEffect,        // 231 SPELL_AURA_PROC_TRIGGER_SPELL_WITH_VALUE
    &AuraEffect::HandleNoImmediateEffect,        // 232 SPELL_AURA_MECHANIC_DURATION_MOD           implement in
    ...
    &AuraEffect::HandleNoImmediateEffect,  // 234 SPELL_AURA_MECHANIC_DURATION_MOD_NOT_STACK implement in
                                           // Unit::CalculateSpellDuration
    &AuraEffect::HandleNoImmediateEffect,  // 235 SPELL_AURA_MOD_DISPEL_RESIST               implement in
                                           // Unit::MagicSpellHitResult
    &AuraEffect::HandleAuraControlVehicle, // 236 SPELL_AURA_CONTROL_VEHICLE
    &AuraEffect::HandleModSpellDamagePercentFromAttackPower,  // 237 SPELL_AURA_MOD_SPELL_DAMAGE_OF_ATTACK_POWER
                                                              // implemented in Unit::SpellBaseDamageBonus
    &AuraEffect::HandleModSpellHealingPercentFromAttackPower, // 238 SPELL_AURA_MOD_SPELL_HEALING_OF_ATTACK_POWER
                                                              // implemented in Unit::SpellBaseHealingBonus
    &AuraEffect::HandleAuraModScale, // 239 SPELL_AURA_MOD_SCALE_2 only in Noggenfogger Elixir (16595) before 2.3.0 aura
                                     // 61
    ...
    &AuraEffect::HandleNoImmediateEffect,     // 246 SPELL_AURA_MOD_AURA_DURATION_BY_DISPEL_NOT_STACK implemented in
                                              // Spell::EffectApplyAura
    &AuraEffect::HandleAuraCloneCaster,       // 247 SPELL_AURA_CLONE_CASTER
    &AuraEffect::HandleNoImmediateEffect,     // 248 SPELL_AURA_MOD_COMBAT_RESULT_CHANCE         implemented in
                                              // Unit::RollMeleeOutcomeAgainst
    ...
    &AuraEffect::HandleModCombatSpeedPct,     // 252 SPELL_AURA_252 Is there any difference between this and
                                              // SPELL_AURA_MELEE_SLOW ? maybe not stacking mod?
    ...
    &AuraEffect::HandleNoImmediateEffect, // 255 SPELL_AURA_MOD_MECHANIC_DAMAGE_TAKEN_PERCENT    implemented in
                                          // Unit::SpellDamageBonus
    ...
    &AuraEffect::HandleNoImmediateEffect,    // 260 SPELL_AURA_SCREEN_EFFECT (miscvalue = id in ScreenEffect.dbc) not
                                             // required any code
    &AuraEffect::HandlePhase,                // 261 SPELL_AURA_PHASE
    &AuraEffect::HandleNoImmediateEffect,    // 262 SPELL_AURA_ABILITY_IGNORE_AURASTATE implemented in spell::cancast
    &AuraEffect::HandleAuraAllowOnlyAbility, // 263 SPELL_AURA_ALLOW_ONLY_ABILITY player can use only abilities set in
                                             // SpellClassMask
    &AuraEffect::HandleUnused,               // 264 unused (3.2.0)
    &AuraEffect::HandleUnused,               // 265 unused (3.2.0)
    &AuraEffect::HandleUnused,               // 266 unused (3.2.0)
    &AuraEffect::HandleNoImmediateEffect,    // 267 SPELL_AURA_MOD_IMMUNE_AURA_APPLY_SCHOOL         implemented in
    ...
    &AuraEffect::HandleNoImmediateEffect,               // 269 SPELL_AURA_MOD_IGNORE_TARGET_RESIST implemented in
                                                        // Unit::CalcAbsorbResist and CalcArmorReducedDamage
    &AuraEffect::HandleNoImmediateEffect, // 270 SPELL_AURA_MOD_ABILITY_IGNORE_TARGET_RESIST implemented in
                                          // Unit::CalcAbsorbResist and CalcArmorReducedDamage
    &AuraEffect::HandleNoImmediateEffect, // 271 SPELL_AURA_MOD_DAMAGE_FROM_CASTER    implemented in
                                          // Unit::SpellDamageBonus
    &AuraEffect::HandleNoImmediateEffect, // 272 SPELL_AURA_IGNORE_MELEE_RESET
    &AuraEffect::HandleUnused,            // 273 clientside
    &AuraEffect::HandleNoImmediateEffect, // 274 SPELL_AURA_CONSUME_NO_AMMO implemented in
                                          // spell::CalculateDamageDoneForAllTargets
    ...
    &AuraEffect::HandleNoImmediateEffect, // 277 SPELL_AURA_MOD_ABILITY_AFFECTED_TARGETS implemented in
                                          // spell::settargetmap
    ...
    &AuraEffect::HandleNoImmediateEffect,             // 283 SPELL_AURA_MOD_HEALING_RECEIVED       implemented in
                                                      // Unit::SpellHealingBonus
    &AuraEffect::HandleAuraLinked,                    // 284 SPELL_AURA_LINKED
    &AuraEffect::HandleAuraModAttackPowerOfArmor,     // 285 SPELL_AURA_MOD_ATTACK_POWER_OF_ARMOR  implemented in
                                                      // Player::UpdateAttackPowerAndDamage
    &AuraEffect::HandleNoImmediateEffect,             // 286 SPELL_AURA_ABILITY_PERIODIC_CRIT implemented in
                                                      // AuraEffect::PeriodicTick
    &AuraEffect::HandleNoImmediateEffect,             // 287 SPELL_AURA_DEFLECT_SPELLS             implemented in
                                                      // Unit::MagicSpellHitResult and Unit::MeleeSpellHitResult
    &AuraEffect::HandleNoImmediateEffect,             // 288 SPELL_AURA_IGNORE_HIT_DIRECTION  implemented in
                                                      // Unit::MagicSpellHitResult and Unit::MeleeSpellHitResult
                                                      // Unit::RollMeleeOutcomeAgainst
    &AuraEffect::HandleNoImmediateEffect,             // 289 SPELL_AURA_PREVENT_DURABILITY_LOSS implemented in
                                                      // Player::DurabilityPointsLoss
    ...
    &AuraEffect::HandleAuraOverrideSpells, // 293 auras which probably add set of abilities to their target based on
                                           // it's miscvalue
    &AuraEffect::HandleModManaRegen, // 294 SPELL_AURA_PREVENT_REGENERATE_POWER implemented in Player::Regenerate(Powers
                                     // power), HandleModManaRegen to refresh regeneration clientside
    ...
    &AuraEffect::HandleNoImmediateEffect,      // 303 SPELL_AURA_MOD_DAMAGE_DONE_VERSUS_AURASTATE implemented in
                                               // Unit::SpellDamageBonus, Unit::MeleeDamageBonus
    ...
    &AuraEffect::HandleNoImmediateEffect, // 310 SPELL_AURA_MOD_CREATURE_AOE_DAMAGE_AVOIDANCE implemented in
...
AuraEffect::AuraEffect(Aura* base, uint8 effIndex, int32* baseAmount, Unit* caster)
    : m_base(base), m_spellInfo(base->GetSpellInfo()),
      ...
      m_dieSides(m_spellInfo->Effects[effIndex].DieSides), m_critChance(0), m_oldAmount(0), m_isAuraEnabled(true),
      m_channelData(nullptr), m_spellmod(nullptr), m_periodicTimer(0), m_tickNumber(0), m_effIndex(effIndex),
...
int32 AuraEffect::GetMiscValueB() const { return m_spellInfo->Effects[m_effIndex].MiscValueB; }

int32 AuraEffect::GetMiscValue() const { return m_spellInfo->Effects[m_effIndex].MiscValue; }

AuraType AuraEffect::GetAuraType() const { return (AuraType)m_spellInfo->Effects[m_effIndex].ApplyAuraName; }
...
int32 AuraEffect::CalculateAmount(Unit* caster)
{
  ...
  case SPELL_AURA_TRANSFORM:
    ...
    if (caster)
    {
      ...
      for (Unit::AuraEffectList::const_iterator itr = overrideClassScripts.begin(); itr != overrideClassScripts.end();
           ++itr)
      {
  ...
  if (caster)
    ...
    case SPELL_AURA_PERIODIC_LEECH:
      // xinef: save caster depending auras, always pass 1 as stack amount, effect will be multiplicated at the end of
      // the function by correct value!
    ...
    case SPELL_AURA_DAMAGE_SHIELD:
      if (GetBase()->GetType() == UNIT_AURA_TYPE)
        amount = caster->SpellDamageBonusDone(GetBase()->GetUnitOwner(), GetSpellInfo(), amount, SPELL_DIRECT_DAMAGE,
                                              0.0f, 1);
      break;
    default:
      break;
...
void AuraEffect::HandleEffect(AuraApplication* aurApp, uint8 mode, bool apply)
{
  ...
  // registration/unregistration is done always before real effect handling (some effect handlers code is depending on
  // this)
  ...
  // xinef: this condition works under assumption that effect handlers performs ALL necessery action with CHANGE_AMOUNT
  // mode xinef: as far as i've checked, all grouped spells meet this condition
  ...
  if (apply)
    prevented = GetBase()->CallScriptEffectApplyHandlers(this, const_cast<AuraApplication const*>(aurApp),
                                                         (AuraEffectHandleModes)mode);
  else
    prevented = GetBase()->CallScriptEffectRemoveHandlers(this, const_cast<AuraApplication const*>(aurApp),
                                                          (AuraEffectHandleModes)mode);
...
float AuraEffect::CalcPeriodicCritChance(Unit const* caster, Unit const* target) const
{
    ...
    if (Player* modOwner = caster->GetSpellModOwner())
    {
           ...
           ++itr)
      {
        if ((*itr)->IsAffectedOnSpell(GetSpellInfo()))
        {
          critChance = modOwner->SpellDoneCritChance(
              ...
              (GetSpellInfo()->DmgClass == SPELL_DAMAGE_CLASS_RANGED ? RANGED_ATTACK : BASE_ATTACK), true);
          break;
        }
      }
      ...
      case SPELLFAMILY_ROGUE:
        if (GetSpellInfo()->SpellFamilyFlags[0] & 0x100000)
          critChance = modOwner->SpellDoneCritChance(nullptr, GetSpellInfo(), GetSpellInfo()->GetSchoolMask(),
                                                     BASE_ATTACK, true);
        break;
      }
    }
  ...
  if (target && critChance > 0.0f)
    critChance = target->SpellTakenCritChance(caster, GetSpellInfo(), GetSpellInfo()->GetSchoolMask(), critChance,
                                              BASE_ATTACK, true);
...
bool AuraEffect::HasSpellClassMask() const { return m_spellInfo->Effects[m_effIndex].SpellClassMask; }
...
void AuraEffect::HandleShapeshiftBoosts(Unit* target, bool apply) const
{
    ...
    if (player)
    {
        ...
        if (uint32 glyphId = player->GetGlyph(i))
        {
          if (GlyphPropertiesEntry const* glyph = sGlyphPropertiesStore.LookupEntry(glyphId))
          {
            ...
            if (!spellInfo || !spellInfo->HasAttribute(SpellAttr0(SPELL_ATTR0_PASSIVE | SPELL_ATTR0_DO_NOT_DISPLAY)))
              continue;
            if (spellInfo->Stances & (1 << (GetMiscValue() - 1)))
              target->CastSpell(target, glyph->SpellId,
      ...
      case FORM_CAT:
        ...
        if (AuraEffect const* aurEff =
                target->GetAuraEffect(SPELL_AURA_MOD_SPELL_HEALING_OF_STAT_PERCENT, SPELLFAMILY_DRUID, 2254, 0))
        {
          uint32 spellId3 = 0;
          switch (aurEff->GetId())
          {
  ...
  else
  {
    ...
    // Iterate through all the shapeshift auras that the target has, if there is another aura with
    // SPELL_AURA_MOD_SHAPESHIFT, then this aura is being removed due to that one being applied
...
void AuraEffect::HandleModInvisibility(AuraApplication const* aurApp, uint8 mode, bool apply) const
{
  ...
  if (apply)
  {
    ...
    if (target->IsPlayer() && (type == INVISIBILITY_GENERAL || type == INVISIBILITY_UNK10))
      target->SetByteFlag(PLAYER_FIELD_BYTES2, PLAYER_FIELD_BYTES_2_OFFSET_AURA_VISION,
  ...
  else
  {
    ...
    else
    {
      ...
      if (!found)
      {
        ...
        {
          target->RemoveByteFlag(PLAYER_FIELD_BYTES2, PLAYER_FIELD_BYTES_2_OFFSET_AURA_VISION,
                                 PLAYER_FIELD_BYTE2_INVISIBILITY_GLOW);
        }
      }
    }
...
void AuraEffect::HandleAuraTransform(AuraApplication const* aurApp, uint8 mode, bool apply) const
{
  ...
  if (apply)
  {
    // update active transform spell only when transform or shapeshift not set or not overwriting negative by positive
    // case
      ...
      for (uint32 i = CURRENT_FIRST_NON_MELEE_SPELL; i < CURRENT_MAX_SPELL; i++)
      {
            ...
            (*iter)->GetCurrentSpell(i)->m_targets.GetUnitTargetGUID() == target->GetGUID())
        {
          ...
          if (si->HasAttribute(SPELL_ATTR6_IGNORE_PHASE_SHIFT) && (*iter)->IsCreature())
          {
            ...
            if ((!c->IsPet() && c->GetCreatureTemplate()->rank == CREATURE_ELITE_WORLDBOSS) || c->isWorldBoss() ||
                c->IsDungeonBoss())
              continue;
          }
          bool interrupt = false; // pussywizard: skip spells that don't target units, but casted on unit (eg.
                                  // TARGET_DEST_TARGET_ENEMY)
          for (uint8 j = 0; j < MAX_SPELL_EFFECTS; ++j)
            if (si->Effects[j].Effect && (si->Effects[j].GetUsedTargetObjectType() == TARGET_OBJECT_TYPE_UNIT ||
...
void AuraEffect::HandleAuraModPacify(AuraApplication const* aurApp, uint8 mode, bool apply) const
{
  ...
  if (apply)
  {
    ...
    // target->AttackStop(); // pussywizard: why having this flag prevents from being in combat? it should just prevent
    // melee attack
  }
  else
  {
...
void AuraEffect::HandlePreventFleeing(AuraApplication const* aurApp, uint8 mode, bool apply) const
{
  ...
  Unit* target = aurApp->GetTarget();
  // Since patch 3.0.2 this mechanic no longer affects fear effects. It will ONLY prevent humanoids from fleeing due to
  // low health.
  if (target->IsPlayer() || !apply || target->HasFearAura())
    return;
  /// @todo: find a way to cancel fleeing for assistance.
  /// Currently this will only stop creatures fleeing due to low health that could not find nearby allies to flee
  /// towards.
...
void AuraEffect::HandleAuraModIncreaseFlightSpeed(AuraApplication const* aurApp, uint8 mode, bool apply) const
{
  ...
  if (GetAuraType() == SPELL_AURA_MOD_INCREASE_MOUNTED_FLIGHT_SPEED)
  {
    // do not remove unit flag if there are more than this auraEffect of that kind on unit on unit
    if (mode & AURA_EFFECT_HANDLE_SEND_FOR_CLIENT_MASK &&
        (apply || (!target->HasIncreaseMountedFlightSpeedAura() && !target->HasFlyAura())))
    {
      target->SetCanFly(apply);
...
void AuraEffect::HandleModMechanicImmunity(AuraApplication const* aurApp, uint8 mode, bool apply) const
{
  ...
  case 46227: // Medalion of Immunity
    ...
    target->RemoveAurasByType(
        SPELL_AURA_PREVENTS_FLEEING); // xinef: Patch 2.3.0 PvP Trinkets: Insignia of the Alliance, Insignia of the
                                      // Horde, Medallion of the Alliance, and Medallion of the Horde now clear the
                                      // debuff from Judgement of Justice.
    // Actually we should apply immunities here, too, but the aura has only 100 ms duration, so there is practically no
    // point
    break;
...
void AuraEffect::HandleAuraModStat(AuraApplication const* aurApp, uint8 mode, bool apply) const
{
  ...
  {
    LOG_ERROR("spells.aura.effect",
              "WARNING: Spell {} effect {} has an unsupported misc value ({}) for SPELL_AURA_MOD_STAT ", GetId(),
              GetEffIndex(), GetMiscValue());
    return;
  }
...
void AuraEffect::HandleModSpellDamagePercentFromAttackPower(AuraApplication const* aurApp, uint8 mode,
                                                            bool /*apply*/) const
{
  if (!(mode & (AURA_EFFECT_HANDLE_CHANGE_AMOUNT_MASK | AURA_EFFECT_HANDLE_STAT)))
    return;
...
void AuraEffect::HandleModSpellHealingPercentFromAttackPower(AuraApplication const* aurApp, uint8 mode,
                                                             bool /*apply*/) const
{
  if (!(mode & (AURA_EFFECT_HANDLE_CHANGE_AMOUNT_MASK | AURA_EFFECT_HANDLE_STAT)))
    return;
...
void AuraEffect::HandleAuraModRangedAttackPowerOfStatPercent(AuraApplication const* aurApp, uint8 mode,
                                                             bool /*apply*/) const
{
  if (!(mode & (AURA_EFFECT_HANDLE_CHANGE_AMOUNT_MASK | AURA_EFFECT_HANDLE_STAT)))
    return;
...
void AuraEffect::HandleModDamagePercentDone(AuraApplication const* aurApp, uint8 mode, bool apply) const
{
  ...
  {
    // done in Player::_ApplyWeaponDependentAuraMods for SPELL_SCHOOL_MASK_NORMAL && EquippedItemClass != -1 and also
    // for wand case
  }
}
...
void AuraEffect::HandlePeriodicDummyAuraTick(Unit* target, Unit* caster) const
{
  ...
  case SPELLFAMILY_DRUID:
  {
    ...
    case 22842:
    {
      // Converts up to 10 rage per second into health for $d.  Each point of rage is converted into ${$m2/10}.1% of max
      // health. Should be manauser
...
void AuraEffect::HandlePeriodicTriggerSpellAuraTick(Unit* target, Unit* caster) const
{
  ...
  if (!triggeredSpellInfo)
  {
    ...
    case SPELLFAMILY_GENERIC:
    {
      ...
      case 27808:
        if (caster)
        {
          caster->CastCustomSpell(29879, SPELLVALUE_BASE_POINT0, int32(target->CountPctFromMaxHealth(21)), target, true,
                                  nullptr, this);
          if (GetTickNumber() == 1)
      ...
      // Tear of Azzinoth Summon Channel - it's not really supposed to do anything, and this only prevents the console
      // spam
      case 39857:
  ...
  else
  {
    ...
    case 66882:
      target->CastCustomSpell(triggerSpellId, SPELLVALUE_RADIUS_MOD,
                              (int32)((((float)m_tickNumber / 60) * 0.9f + 0.1f) * 10000 * 2 / 3), nullptr, true,
                              nullptr, this);
      return;
    ...
    case 56432:
      ...
      {
        target->CastCustomSpell(triggerSpellId, SPELLVALUE_RADIUS_MOD,
                                (int32)(10000 * (1.0f - 0.02f * (m_tickNumber + 1))), nullptr, true, nullptr, this);
        return;
      }
      break;
    // Beacon of Light
    case 53563:
    {
      ...
      GetBase()->GetUnitOwner()->CastSpell(target, triggeredSpellInfo, true, 0, this,
  ...
  if (triggeredSpellInfo)
  {
            ...
            triggeredSpellInfo->NeedsToBeTriggeredByCaster(m_spellInfo, GetEffIndex()) ? caster : target)
    {
      ...
      LOG_DEBUG("spells.aura", "AuraEffect::HandlePeriodicTriggerSpellAuraTick: Spell {} Trigger {}", GetId(),
...
void AuraEffect::HandlePeriodicTriggerSpellWithValueAuraTick(Unit* target, Unit* caster) const
{
  ...
  if (SpellInfo const* triggeredSpellInfo = sSpellMgr->GetSpellInfo(triggerSpellId))
  {
            ...
            triggeredSpellInfo->NeedsToBeTriggeredByCaster(m_spellInfo, GetEffIndex()) ? caster : target)
    {
      ...
      LOG_DEBUG("spells.aura", "AuraEffect::HandlePeriodicTriggerSpellWithValueAuraTick: Spell {} Trigger {}", GetId(),
                triggeredSpellInfo->Id);
    }
  }
  else
  {
    ...
    LOG_DEBUG("spells.aura",
              "AuraEffect::HandlePeriodicTriggerSpellWithValueAuraTick: Spell {} has non-existent spell {} in "
              "EffectTriggered[{}] and is therefor not triggered.",
...
void AuraEffect::HandlePeriodicDamageAurasTick(Unit* target, Unit* caster) const
{
  ...
  // Script Hook For HandlePeriodicDamageAurasTick -- Allow scripts to change the Damage pre class mitigation
  // calculations
  ...
  if (GetAuraType() == SPELL_AURA_PERIODIC_DAMAGE)
  {
    ...
    if (GetBase()->GetType() == DYNOBJ_AURA_TYPE && caster)
      damage = caster->SpellDamageBonusDone(target, GetSpellInfo(), damage, DOT, GetEffIndex(), 0.0f,
  ...
  DamageInfo dmgInfo(caster, target, damage, GetSpellInfo(), GetSpellInfo()->GetSchoolMask(), DOT,
  ...
  Unit::ProcDamageAndSpell(caster, target, caster ? procAttacker : 0, procVictim, procEx, damage, BASE_ATTACK,
                           GetSpellInfo(), nullptr, GetEffIndex(), nullptr, &dmgInfo);
}
...
void AuraEffect::HandlePeriodicHealthLeechAuraTick(Unit* target, Unit* caster) const
{
  ...
  // Script Hook For HandlePeriodicHealthLeechAurasTick -- Allow scripts to change the Damage pre class mitigation
  // calculations
  sScriptMgr->ModifyPeriodicDamageAurasTick(target, caster, damage, GetSpellInfo());
  ...
  LOG_DEBUG("spells.aura.effect", "PeriodicTick: {} health leech of {} for {} dmg inflicted by {} abs is {}",
            GetCasterGUID().ToString(), target->GetGUID().ToString(), damage, GetId(), absorb);
  if (caster)
    caster->SendSpellNonMeleeDamageLog(target, GetSpellInfo(), damage, GetSpellInfo()->GetSchoolMask(), absorb, resist,
                                       false, 0, crit);

  int32 new_damage;

  new_damage = Unit::DealDamage(caster, target, damage, &cleanDamage, DOT, GetSpellInfo()->GetSchoolMask(),
                                GetSpellInfo(), false);
  ...
  uint32 heal = uint32(caster->SpellHealingBonusDone(caster, GetSpellInfo(), uint32(new_damage * gainMultiplier), DOT,
                                                     GetEffIndex(), 0.0f, GetBase()->GetStackAmount()));
...
void AuraEffect::HandlePeriodicHealthFunnelAuraTick(Unit* target, Unit* caster) const
{
  ...
  LOG_DEBUG("spells.aura", "PeriodicTick: donator {} target {} damage {}.", caster->GetEntry(), target->GetEntry(),
            damage);
...
void AuraEffect::HandlePeriodicHealAurasTick(Unit* target, Unit* caster) const
{
  ...
  else
  {
    ...
    if (GetBase()->GetType() == DYNOBJ_AURA_TYPE)
      damage = caster->SpellHealingBonusDone(target, GetSpellInfo(), damage, DOT, GetEffIndex(), 0.0f,
                                             GetBase()->GetStackAmount());
  ...
  SpellPeriodicAuraLogInfo pInfo(this, healInfo.GetHeal(), healInfo.GetHeal() - healInfo.GetEffectiveHeal(),
                                 healInfo.GetAbsorb(), 0, 0.0f, crit);
  target->SendPeriodicAuraLog(&pInfo);
  ...
  if (target != caster && GetSpellInfo()->HasAttribute(SPELL_ATTR2_NO_TARGET_PER_SECOND_COST))
  {
    ...
    CleanDamage cleanDamage = CleanDamage(0, 0, BASE_ATTACK, MELEE_HIT_NORMAL);
    Unit::DealDamage(caster, caster, manaPerSecond, &cleanDamage, SELF_DAMAGE, GetSpellInfo()->GetSchoolMask(),
                     GetSpellInfo(), true);
  }
  ...
  // ignore item heals
  if (!haveCastItem && GetAuraType() != SPELL_AURA_OBS_MOD_HEALTH) // xinef: dont allow obs_mod_health to proc spells,
                                                                   // this is passive regeneration and not hot
    Unit::ProcDamageAndSpell(caster, target, caster ? procAttacker : 0, procVictim, procEx, heal, BASE_ATTACK,
                             GetSpellInfo(), nullptr, GetEffIndex(), nullptr, nullptr, &healInfo);
}
...
void AuraEffect::HandleObsModPowerAuraTick(Unit* target, Unit* caster) const
{
  ...
  LOG_DEBUG("spells.aura.effect", "PeriodicTick: {} energize {} for {} dmg inflicted by {}", GetCasterGUID().ToString(),
            target->GetGUID().ToString(), amount, GetId());
...
void AuraEffect::HandlePeriodicPowerBurnAuraTick(Unit* target, Unit* caster) const
{
  ...
  Unit::ProcDamageAndSpell(caster, damageInfo.target, procAttacker, procVictim, procEx, damageInfo.damage, BASE_ATTACK,
                           spellProto, nullptr, GetEffIndex(), nullptr, &dmgInfo);
}
...
void AuraEffect::HandleProcTriggerSpellAuraProc(AuraApplication* aurApp, ProcEventInfo& eventInfo)
{
  ...
  if (SpellInfo const* triggeredSpellInfo = sSpellMgr->GetSpellInfo(triggerSpellId))
  {
    LOG_DEBUG("spells.aura", "AuraEffect::HandleProcTriggerSpellAuraProc: Triggering spell {} from aura {} proc",
  ...
  {
    LOG_DEBUG("spells.aura",
              "AuraEffect::HandleProcTriggerSpellAuraProc: Could not trigger spell {} from aura {} proc, because the "
              "spell does not have an entry in Spell.dbc.",
...
void AuraEffect::HandleProcTriggerSpellWithValueAuraProc(AuraApplication* aurApp, ProcEventInfo& eventInfo)
{
  ...
  {
    LOG_DEBUG("spells.aura",
              "AuraEffect::HandleProcTriggerSpellWithValueAuraProc: Could not trigger spell {} from aura {} proc, "
              "because the spell does not have an entry in Spell.dbc.",
              triggerSpellId, GetId());
  }
}
...
void AuraEffect::HandleProcTriggerDamageAuraProc(AuraApplication* aurApp, ProcEventInfo& eventInfo)
{
  ...
  LOG_DEBUG("spells.aura", "AuraEffect::HandleProcTriggerDamageAuraProc: Triggering {} spell damage from aura {} proc",
            damage, GetId());
...
void AuraEffect::HandleRaidProcFromChargeAuraProc(AuraApplication* aurApp, ProcEventInfo& /*eventInfo*/)
{
  ...
  LOG_DEBUG("spells.aura", "AuraEffect::HandleRaidProcFromChargeAuraProc: Triggering spell {} from aura {} proc",
            triggerSpellId, GetId());
...
void AuraEffect::HandleRaidProcFromChargeWithValueAuraProc(AuraApplication* aurApp, ProcEventInfo& /*eventInfo*/)
{
  ...
  {
    LOG_DEBUG("spells.aura", "AuraEffect::HandleRaidProcFromChargeWithValueAuraProc: received not handled spell: {}",
              GetId());
    return;
  }
