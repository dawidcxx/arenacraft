...
const creature_type EP_EWT_Summons_A[EP_EWT_NUM_CREATURES] = {{17635, 0, 3167.61f, -4352.09f, 138.20f, 4.5811f},
...
const creature_type EP_EWT_Summons_H[EP_EWT_NUM_CREATURES] = {{17995, 0, 3167.61f, -4352.09f, 138.20f, 4.5811f},
...
const go_type EP_NPT_LordaeronShrine = {181682,   0,    3167.72f, -4355.91f, 138.785f,
                                        1.69297f, 0.0f, 0.0f,     0.748956f, 0.66262f};
