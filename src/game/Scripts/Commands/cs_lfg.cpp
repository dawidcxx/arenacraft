...
void GetPlayerInfo(ChatHandler* handler, Player* player)
{
  ...
  handler->PSendSysMessage(LANG_LFG_PLAYER_INFO, player->GetName(), state, uint8(dungeons.size()),
                           lfg::ConcatenateDungeons(dungeons), lfg::GetRolesString(sLFGMgr->GetRoles(guid)),
...
public:
  ...
  static bool HandleLfgQueueInfoCommand(ChatHandler* /*handler*/) { return true; }
