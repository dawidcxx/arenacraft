...
class spell_warl_eye_of_kilrogg : public AuraScript
{
  ...
  {
    OnEffectApply += AuraEffectApplyFn(spell_warl_eye_of_kilrogg::HandleAuraApply, EFFECT_1, SPELL_AURA_DUMMY,
                                       AURA_EFFECT_HANDLE_REAL);
    AfterEffectRemove += AuraEffectRemoveFn(spell_warl_eye_of_kilrogg::HandleAuraRemove, EFFECT_1, SPELL_AURA_DUMMY,
                                            AURA_EFFECT_HANDLE_REAL);
  }
};
...
class spell_warl_seduction : public AuraScript
{
  ...
  void Register() override
  {
    OnEffectApply += AuraEffectApplyFn(spell_warl_seduction::HandleAuraApply, EFFECT_0, SPELL_AURA_MOD_STUN,
                                       AURA_EFFECT_HANDLE_REAL);
  }
};
...
class spell_warl_improved_demonic_tactics : public AuraScript
{
  ...
  bool Load() override { return GetUnitOwner()->IsPlayer(); }
  ...
  void CalculateAmount(AuraEffect const* aurEff, int32& amount, bool& /*canBeRecalculated*/)
  {
    if (aurEff->GetEffIndex() == EFFECT_0)
      amount = CalculatePct<int32, float>(GetUnitOwner()->ToPlayer()->GetFloatValue(
  ...
  void Register() override
  {
    ...
    DoEffectCalcSpellMod += AuraEffectCalcSpellModFn(spell_warl_improved_demonic_tactics::HandleEffectCalcSpellMod,
...
class spell_warl_ritual_of_summoning : public SpellScript
{
  ...
  void Register() override { OnCheckCast += SpellCheckCastFn(spell_warl_ritual_of_summoning::CheckCast); }
};
...
class spell_warl_demonic_aegis : public AuraScript
{
  ...
  void Register() override
  {
    OnEffectRemove += AuraEffectRemoveFn(spell_warl_demonic_aegis::HandleAuraApply, EFFECT_0,
...
class spell_warl_generic_scaling : public AuraScript
{
  ...
  void Register() override
  {
    if (m_scriptSpellId != 34947)
      DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_warl_generic_scaling::CalculateResistanceAmount, EFFECT_ALL,
                                                   SPELL_AURA_MOD_RESISTANCE);

    if (m_scriptSpellId == 34947 || m_scriptSpellId == 34956)
      DoEffectCalcAmount +=
          AuraEffectCalcAmountFn(spell_warl_generic_scaling::CalculateStatAmount, EFFECT_ALL, SPELL_AURA_MOD_STAT);

    if (m_scriptSpellId == 34947)
    {
      DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_warl_generic_scaling::CalculateAPAmount, EFFECT_ALL,
                                                   SPELL_AURA_MOD_ATTACK_POWER);
      DoEffectCalcAmount +=
          AuraEffectCalcAmountFn(spell_warl_generic_scaling::CalculateSPAmount, EFFECT_ALL, SPELL_AURA_MOD_DAMAGE_DONE);
    }
...
class spell_warl_infernal_scaling : public AuraScript
{
  ...
  void Register() override
  {
    if (m_scriptSpellId != 36186)
      DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_warl_infernal_scaling::CalculateResistanceAmount, EFFECT_ALL,
                                                   SPELL_AURA_MOD_RESISTANCE);

    if (m_scriptSpellId == 36186 || m_scriptSpellId == 36188)
      DoEffectCalcAmount +=
          AuraEffectCalcAmountFn(spell_warl_infernal_scaling::CalculateStatAmount, EFFECT_ALL, SPELL_AURA_MOD_STAT);

    if (m_scriptSpellId == 36186)
    {
      DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_warl_infernal_scaling::CalculateAPAmount, EFFECT_ALL,
                                                   SPELL_AURA_MOD_ATTACK_POWER);
      DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_warl_infernal_scaling::CalculateSPAmount, EFFECT_ALL,
                                                   SPELL_AURA_MOD_DAMAGE_DONE);
    }

    OnEffectApply += AuraEffectApplyFn(spell_warl_infernal_scaling::HandleEffectApply, EFFECT_ALL, SPELL_AURA_ANY,
                                       AURA_EFFECT_HANDLE_REAL);
  }
};
...
class spell_warl_banish : public SpellScript
{
  ...
  void Register() override { BeforeHit += BeforeSpellHitFn(spell_warl_banish::HandleBanish); }
};
...
class spell_warl_demonic_empowerment : public SpellScript
{
  ...
  {
    return ValidateSpellInfo({SPELL_WARLOCK_DEMONIC_EMPOWERMENT_SUCCUBUS, SPELL_WARLOCK_DEMONIC_EMPOWERMENT_VOIDWALKER,
    ...
    if (Creature* targetCreature = GetHitCreature())
    {
      if (targetCreature->IsPet())
      {
        ...
        case CREATURE_FAMILY_VOIDWALKER:
        {
          ...
          int32            hp        = int32(
              targetCreature->CountPctFromMaxHealth(GetCaster()->CalculateSpellDamage(targetCreature, spellInfo, 0)));
          targetCreature->CastCustomSpell(targetCreature, SPELL_WARLOCK_DEMONIC_EMPOWERMENT_VOIDWALKER, &hp, nullptr,
                                          nullptr, true);
...
class spell_warl_everlasting_affliction : public SpellScript
{
  ...
  void HandleScriptEffect(SpellEffIndex /*effIndex*/)
  {
    if (Unit* unitTarget = GetHitUnit())
      ...
      if (AuraEffect* aur = unitTarget->GetAuraEffect(SPELL_AURA_PERIODIC_DAMAGE, SPELLFAMILY_WARLOCK, 0x2, 0, 0,
                                                      GetCaster()->GetGUID()))
      {
...
class spell_warl_seed_of_corruption_damage : public SpellScript
{
  ...
  void Register() override
  {
    OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_warl_seed_of_corruption_damage::FilterTargets,
...
class spell_warl_seed_of_corruption_aura : public AuraScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override
  {
    return ValidateSpellInfo({SPELL_WARLOCK_SEED_OF_CORRUPTION_DAMAGE_R1, SPELL_WARLOCK_SEED_OF_CORRUPTION_DAMAGE_R2,
                              SPELL_WARLOCK_SEED_OF_CORRUPTION_DAMAGE_R3, SPELL_WARLOCK_SEED_OF_CORRUPTION_VISUAL});
  }
  ...
  void CalculateAmount(AuraEffect const* aurEff, int32& amount, bool& /*canBeRecalculated*/)
  {
    ...
    amount = GetCaster()->SpellDamageBonusDone(GetUnitOwner(), GetSpellInfo(), amount, DOT, aurEff->GetEffIndex(),
                                               aurEff->GetPctMods());
  }
  ...
  void Detonate(AuraEffect const* aurEff)
  {
    ...
    GetCaster()->CastSpell(
        GetTarget(), sSpellMgr->GetSpellWithRank(SPELL_WARLOCK_SEED_OF_CORRUPTION_DAMAGE_R1, GetSpellInfo()->GetRank()),
        true, nullptr, aurEff);
  }
  ...
  void Register() override
  {
    ...
    AfterEffectRemove += AuraEffectRemoveFn(spell_warl_seed_of_corruption_aura::OnRemove, EFFECT_0,
...
class spell_warl_seed_of_corruption_generic_aura : public AuraScript
{
  ...
  void Detonate(AuraEffect const* aurEff)
  {
    ...
    GetTarget()->CastSpell(GetTarget(), SPELL_WARLOCK_SEED_OF_CORRUPTION_VISUAL, true, nullptr, aurEff);
    GetCaster()->CastCustomSpell(SPELL_WARLOCK_SEED_OF_CORRUPTION_DAMAGE_GENERIC, SPELLVALUE_BASE_POINT0,
                                 GetSpellInfo()->GetEffect(EFFECT_1).CalcValue(), GetTarget(), true, nullptr, aurEff);
  }
...
class spell_warl_soulshatter : public SpellScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override { return ValidateSpellInfo({SPELL_WARLOCK_SOULSHATTER}); }
...
class spell_warl_siphon_life : public AuraScript
{
  ...
  void OnProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
  {
    ...
    GetTarget()->CastCustomSpell(SPELL_WARLOCK_SIPHON_LIFE_HEAL, SPELLVALUE_BASE_POINT0, amount, GetTarget(), true,
                                 nullptr, aurEff);
  }
...
class spell_warl_life_tap : public SpellScript
{
  ...
  void HandleDummy(SpellEffIndex /*effIndex*/)
  {
    ...
    if (Unit* target = GetHitUnit())
    {
      ...
      int32 manaFeedVal = 0;
      if (AuraEffect const* aurEff =
              caster->GetAuraEffect(SPELL_AURA_ADD_FLAT_MODIFIER, SPELLFAMILY_WARLOCK, WARLOCK_ICON_ID_MANA_FEED, 0))
        manaFeedVal = aurEff->GetAmount();

      if (manaFeedVal > 0)
      {
        ApplyPct(manaFeedVal, mana);
        caster->CastCustomSpell(caster, SPELL_WARLOCK_LIFE_TAP_ENERGIZE_2, &manaFeedVal, nullptr, nullptr, true,
                                nullptr);
      }
    }
  }
...
class spell_warl_demonic_circle_summon : public AuraScript
{
  ...
  void Register() override
  {
    OnEffectRemove += AuraEffectRemoveFn(spell_warl_demonic_circle_summon::HandleRemove, EFFECT_0,
                                         SPELL_AURA_PERIODIC_DUMMY, AURA_EFFECT_HANDLE_REAL_OR_REAPPLY_MASK);
    OnEffectPeriodic +=
        AuraEffectPeriodicFn(spell_warl_demonic_circle_summon::HandleDummyTick, EFFECT_0, SPELL_AURA_PERIODIC_DUMMY);
  }
};
...
class spell_warl_demonic_circle_teleport : public AuraScript
{
    ...
    if (Player* player = GetTarget()->ToPlayer())
    {
      if (GameObject* circle = player->GetGameObject(SPELL_WARLOCK_DEMONIC_CIRCLE_SUMMON))
      {
        player->NearTeleportTo(circle->GetPositionX(), circle->GetPositionY(), circle->GetPositionZ(),
                               circle->GetOrientation(), false, false, false, true);
  ...
  void Register() override
  {
    OnEffectApply += AuraEffectApplyFn(spell_warl_demonic_circle_teleport::HandleTeleport, EFFECT_0,
...
class spell_warl_fel_synergy : public AuraScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override { return ValidateSpellInfo({SPELL_WARLOCK_FEL_SYNERGY_HEAL}); }
  ...
  void OnProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
  {
    ...
    GetTarget()->CastCustomSpell(SPELL_WARLOCK_FEL_SYNERGY_HEAL, SPELLVALUE_BASE_POINT0, heal, (Unit*)nullptr, true,
                                 nullptr, aurEff); // TARGET_UNIT_PET
  }
...
class spell_warl_haunt : public SpellScript
{
  ...
  void Register() override { AfterHit += SpellHitFn(spell_warl_haunt::HandleAfterHit); }
};
...
class spell_warl_haunt_aura : public AuraScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override { return ValidateSpellInfo({SPELL_WARLOCK_HAUNT_HEAL}); }
  ...
  void HandleRemove(AuraEffect const* aurEff, AuraEffectHandleModes /*mode*/)
  {
    if (Unit* caster = GetCaster())
    {
      ...
      GetTarget()->CastCustomSpell(caster, SPELL_WARLOCK_HAUNT_HEAL, &amount, nullptr, nullptr, true, nullptr, aurEff,
                                   GetCasterGUID());
    }
  }
  ...
  void Register() override
  {
    OnEffectRemove += AuraEffectRemoveFn(spell_warl_haunt_aura::HandleRemove, EFFECT_1, SPELL_AURA_DUMMY,
  ...
  void HandleDispel(DispelInfo* dispelInfo)
  {
    if (Unit* caster = GetCaster())
      if (AuraEffect const* aurEff = GetEffect(EFFECT_0))
      {
        ...
        caster->CastCustomSpell(dispelInfo->GetDispeller(), SPELL_WARLOCK_UNSTABLE_AFFLICTION_DISPEL, &damage, nullptr,
                                nullptr, true, nullptr, aurEff);
      }
  }

  void Register() override { AfterDispel += AuraDispelFn(spell_warl_unstable_affliction::HandleDispel); }
};
...
class spell_warl_curse_of_doom : public AuraScript
{
  ...
  void Register() override
  {
    AfterEffectRemove += AuraEffectRemoveFn(spell_warl_curse_of_doom::OnRemove, EFFECT_0, SPELL_AURA_PERIODIC_DAMAGE,
                                            AURA_EFFECT_HANDLE_REAL);
  }
};
...
class spell_warl_health_funnel : public AuraScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override
  {
    return ValidateSpellInfo({SPELL_WARLOCK_IMPROVED_HEALTH_FUNNEL_R2, SPELL_WARLOCK_IMPROVED_HEALTH_FUNNEL_BUFF_R2,
                              SPELL_WARLOCK_IMPROVED_HEALTH_FUNNEL_R1, SPELL_WARLOCK_IMPROVED_HEALTH_FUNNEL_BUFF_R1});
  }
  ...
  void Register() override
  {
    OnEffectRemove += AuraEffectRemoveFn(spell_warl_health_funnel::RemoveEffect, EFFECT_0, SPELL_AURA_PERIODIC_HEAL,
                                         AURA_EFFECT_HANDLE_REAL);
    OnEffectApply += AuraEffectApplyFn(spell_warl_health_funnel::ApplyEffect, EFFECT_0, SPELL_AURA_PERIODIC_HEAL,
                                       AURA_EFFECT_HANDLE_REAL);
  }
};
...
class spell_warl_drain_soul : public AuraScript
{
  ...
  bool Validate(SpellInfo const* /*spellInfo*/) override
  {
    return ValidateSpellInfo({SPELL_WARLOCK_IMPROVED_DRAIN_SOUL_R1, SPELL_WARLOCK_IMPROVED_DRAIN_SOUL_PROC,
                              SPELL_WARLOCK_CREATE_SOULSHARD, SPELL_WARLOCK_GLYPH_OF_DRAIN_SOUL_AURA,
  ...
  void RemoveEffect(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
  {
    Unit* caster = GetCaster();
    Unit* target = GetTarget();
    if (!(GetTargetApplication()->GetRemoveMode() == AURA_REMOVE_BY_DEATH && caster && target && caster->IsPlayer() &&
  ...
  void HandleProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
  {
    ...
    if (Unit* caster = eventInfo.GetActor())
    {
      ...
      {
        int32 amount =
            CalculatePct(caster->GetMaxPower(POWER_MANA), impDrainSoul->GetSpellInfo()->Effects[EFFECT_2].CalcValue());
  ...
  void Register() override
  {
    OnEffectRemove += AuraEffectRemoveFn(spell_warl_drain_soul::RemoveEffect, EFFECT_0, SPELL_AURA_CHANNEL_DEATH_ITEM,
                                         AURA_EFFECT_HANDLE_REAL);
...
class spell_warl_shadowburn : public AuraScript
{
  ...
  void Register() override
  {
    OnEffectRemove += AuraEffectRemoveFn(spell_warl_shadowburn::RemoveEffect, EFFECT_0, SPELL_AURA_CHANNEL_DEATH_ITEM,
                                         AURA_EFFECT_HANDLE_REAL);
  }
};
...
class spell_warl_glyph_of_felguard : public AuraScript
{
  ...
  void Register() override
  {
    OnEffectApply += AuraEffectApplyFn(spell_warl_glyph_of_felguard::HandleApply, EFFECT_0, SPELL_AURA_DUMMY,
                                       AURA_EFFECT_HANDLE_REAL);
    OnEffectRemove += AuraEffectRemoveFn(spell_warl_glyph_of_felguard::HandleRemove, EFFECT_0, SPELL_AURA_DUMMY,
                                         AURA_EFFECT_HANDLE_REAL);
  }
};
...
class spell_warl_glyph_of_voidwalker : public AuraScript
{
  ...
  void Register() override
  {
    OnEffectApply += AuraEffectApplyFn(spell_warl_glyph_of_voidwalker::HandleApply, EFFECT_0, SPELL_AURA_DUMMY,
                                       AURA_EFFECT_HANDLE_REAL);
    OnEffectRemove += AuraEffectRemoveFn(spell_warl_glyph_of_voidwalker::HandleRemove, EFFECT_0, SPELL_AURA_DUMMY,
                                         AURA_EFFECT_HANDLE_REAL);
  }
};
  ...
  void HandleProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
  {
    ...
    if (Unit* owner = eventInfo.GetActor()->GetOwner())
    {
              ...
              owner->GetDummyAuraEffect(SPELLFAMILY_WARLOCK, WARLOCK_ICON_ID_DEMONIC_PACT, EFFECT_0))
      {
        ...
        owner->CastCustomSpell((Unit*)nullptr, SPELL_WARLOCK_DEMONIC_PACT_PROC, &bp, &bp, 0, true, nullptr,
                               talentAurEff);
