...
public:
  ...
  // used by Evade code for select point to evade with expected restart default
  // movement
...
template <class Movement> struct MovementGeneratorFactory : public MovementGeneratorCreator
{
