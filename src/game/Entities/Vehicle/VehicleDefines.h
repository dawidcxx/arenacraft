...
enum VehicleFlags
{
  ...
  VEHICLE_FLAG_CUSTOM_PITCH      = 0x00000040, // If set use pitchMin and pitchMax from DBC, otherwise
...
struct VehicleSeat
{
  explicit VehicleSeat(VehicleSeatEntry const* seatInfo, VehicleSeatAddon const* seatAddon)
      : SeatInfo(seatInfo), SeatAddon(seatAddon)
  {
    Passenger.Reset();
  }
