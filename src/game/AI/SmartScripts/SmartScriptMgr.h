...
enum SMART_EVENT_PHASE_BITS
{
  ...
  SMART_EVENT_PHASE_ALL        = SMART_EVENT_PHASE_1_BIT + SMART_EVENT_PHASE_2_BIT + SMART_EVENT_PHASE_3_BIT +
                          SMART_EVENT_PHASE_4_BIT + SMART_EVENT_PHASE_5_BIT + SMART_EVENT_PHASE_6_BIT +
                          SMART_EVENT_PHASE_7_BIT + SMART_EVENT_PHASE_8_BIT + SMART_EVENT_PHASE_9_BIT +
                          SMART_EVENT_PHASE_10_BIT + SMART_EVENT_PHASE_11_BIT + SMART_EVENT_PHASE_12_BIT
};

const uint32 SmartPhaseMask[SMART_EVENT_PHASE_COUNT][2] = {
    {SMART_EVENT_PHASE_1, SMART_EVENT_PHASE_1_BIT},   {SMART_EVENT_PHASE_2, SMART_EVENT_PHASE_2_BIT},
    {SMART_EVENT_PHASE_3, SMART_EVENT_PHASE_3_BIT},   {SMART_EVENT_PHASE_4, SMART_EVENT_PHASE_4_BIT},
    {SMART_EVENT_PHASE_5, SMART_EVENT_PHASE_5_BIT},   {SMART_EVENT_PHASE_6, SMART_EVENT_PHASE_6_BIT},
    {SMART_EVENT_PHASE_7, SMART_EVENT_PHASE_7_BIT},   {SMART_EVENT_PHASE_8, SMART_EVENT_PHASE_8_BIT},
    {SMART_EVENT_PHASE_9, SMART_EVENT_PHASE_9_BIT},   {SMART_EVENT_PHASE_10, SMART_EVENT_PHASE_10_BIT},
...
enum SMART_EVENT
{
  ...
  SMART_EVENT_LINK                    = 61, // INTERNAL USAGE, no params, used to link together multiple events,
  ...
  SMART_EVENT_GOSSIP_HELLO  = 64,           // event_para_1 (only) 0 = no filter set, always execute action, 1 =
...
enum SMART_ACTION
{
  ...
  SMART_ACTION_TALK = 1,                    // groupID from creature_text, duration to wait before TEXT_OVER event
                                            // is triggered, use first target from targetlist as invoker,
                                            // useTalkTarget (0/1) - use target as talk target
  SMART_ACTION_SET_FACTION             = 2, // FactionId (or 0 for default)
  SMART_ACTION_MORPH_TO_ENTRY_OR_MODEL = 3, // Creature_template entry(param1) OR ModelId (param2) (or 0 for both
                                            // to demorph)
  ...
  SMART_ACTION_ALLOW_COMBAT_MOVEMENT = 21,       // AllowCombatMovement (0 = stop combat based movement, anything else
                                                 // continue attacking)
  ...
  SMART_ACTION_FOLLOW                 = 29,      // Distance (0 = default), Angle (0 = default), EndCreatureEntry,
  ...
  SMART_ACTION_MOUNT_TO_ENTRY_OR_MODEL    = 43,  // Creature_template entry(param1) OR ModelId (param2) (or 0 for both
                                                 // to dismount)
  ...
  SMART_ACTION_CREATE_TIMED_EVENT  = 67,         // id, InitialMin, InitialMax, RepeatMin(only if it repeats),
  ...
  SMART_ACTION_OVERRIDE_SCRIPT_BASE_OBJECT = 76, // WARNING: CAN CRASH CORE, do not use if you dont know what you are
                                                 // doing
  ...
  SMART_ACTION_CALL_TIMED_ACTIONLIST    = 80,    // ID (overwrites already running actionlist), stop after
  ...
  SMART_ACTION_SIMPLE_TALK     = 84,             // groupID, can be used to make players say groupID, Text_over event
  ...
  SMART_ACTION_CROSS_CAST = 86,                  // spellID, castFlags, CasterTargetType, CasterTarget param1,
  ...
  // SMART_ACTION_SET_GO_STATE                    = 202,    // state // Replaced
  // by SMART_ACTION_GO_SET_GO_STATE
  ...
  SMART_ACTION_CONE_SUMMON = 219,            // entry, duration (0 = perm), dist between rings, dist between earch
                                             // summon in a row, length of cone, width of cone (angle)
  SMART_ACTION_PLAYER_TALK   = 220,          // acore_string.entry, yell? (0/1)
  SMART_ACTION_VORTEX_SUMMON = 221,          // entry, duration (0 = perm), spiral scaling, spiral appearance,
  ...
  SMART_ACTION_SCRIPTED_SPAWN     = 226,     // state, spawnTimerMin, spawnTimerMax,
                                             // respawnDelay, corpseDelay, dontDespawn
  SMART_ACTION_SET_SCALE     = 227,          // scale
  SMART_ACTION_SUMMON_RADIAL = 228,          // summonEntry, summonDuration, repetitions,
                                             // startAngle, stepAngle, dist
  SMART_ACTION_PLAY_SPELL_VISUAL      = 229, // visualId, visualIdImpact
  SMART_ACTION_FOLLOW_GROUP           = 230, // followState, followType, dist
  SMART_ACTION_SET_ORIENTATION_TARGET = 231, // type, target_type, target_param1, target_param2, target_param3,
                                             // target_param4
...
enum SMARTAI_TARGETS
{
  ...
  SMART_TARGET_HOSTILE_SECOND_AGGRO = 3,    // Second highest aggro, maxdist, playerOnly, powerType + 1, missing
                                            // aura
  SMART_TARGET_HOSTILE_LAST_AGGRO = 4,      // Dead last on aggro, maxdist, playerOnly, powerType + 1, missing aura
  SMART_TARGET_HOSTILE_RANDOM     = 5,      // Just any random target on our threat list, maxdist, playerOnly,
                                            // powerType + 1, missing aura
  SMART_TARGET_HOSTILE_RANDOM_NOT_TOP = 6,  // Any random target except top threat, maxdist, playerOnly, powerType
                                            // + 1, missing aura
  ...
  SMART_TARGET_PLAYER_RANGE        = 17,    // min, max, maxCount (maxCount by pussywizard), set target.o to 1 if
  ...
  SMART_TARGET_PLAYER_WITH_AURA = 201,   // spellId, negation, MaxDist, MinDist, set target.o to a number to
...
const uint32 SmartAIEventMask[SMART_EVENT_AC_END][2] = {
    ...
    {SMART_EVENT_UPDATE_OOC,
     SMART_SCRIPT_TYPE_MASK_CREATURE + SMART_SCRIPT_TYPE_MASK_GAMEOBJECT + SMART_SCRIPT_TYPE_MASK_INSTANCE},
    ...
    {SMART_EVENT_LINK, SMART_SCRIPT_TYPE_MASK_CREATURE + SMART_SCRIPT_TYPE_MASK_GAMEOBJECT +
                           SMART_SCRIPT_TYPE_MASK_AREATRIGGER + SMART_SCRIPT_TYPE_MASK_EVENT +
                           SMART_SCRIPT_TYPE_MASK_GOSSIP + SMART_SCRIPT_TYPE_MASK_QUEST + SMART_SCRIPT_TYPE_MASK_SPELL +
                           SMART_SCRIPT_TYPE_MASK_TRANSPORT + SMART_SCRIPT_TYPE_MASK_INSTANCE},
...
enum SmartEventFlags
{
  ...
  SMART_EVENT_FLAGS_ALL           = (SMART_EVENT_FLAG_NOT_REPEATABLE | SMART_EVENT_FLAG_DIFFICULTY_ALL |
  ...
  SMART_EVENT_FLAG_TEMP_IGNORE_CHANCE_ROLL = 0x40000000, // Event occurs no matter what
...
enum SmartCastFlags
{
  ...
  SMARTCAST_TRIGGERED          = 0x002, // Triggered (this makes spell cost zero mana and
                                        // have no cast time)
  ...
  SMARTCAST_AURA_NOT_PRESENT = 0x020,      // Only casts the spell if the target does
                                           // not have an aura from the spell
  SMARTCAST_COMBAT_MOVE = 0x040,           // Prevents combat movement if cast successful.
                                           // Allows movement on range, OOM, LOS
  SMARTCAST_THREATLIST_NOT_SINGLE = 0x080, // Only cast if the source's threatlist is higher than one. This
...
{
  SmartScriptHolder()
      : entryOrGuid(0), source_type(SMART_SCRIPT_TYPE_CREATURE), event_id(0), link(0), event(), action(), target(),
        timer(0), priority(DEFAULT_PRIORITY), active(false), runOnce(false), enableTimed(false)
  {
  }
...
public:
  ...
  bool operator<(SmartScriptHolder const& other) const
  {
    return std::tie(priority, entryOrGuid, source_type, event_id, link) <
           std::tie(other.priority, other.entryOrGuid, other.source_type, other.event_id, other.link);
  }
  ...
  SmartAIEventList GetScript(int32 entry, SmartScriptType type)
  {
    ...
    else
    {
      if (entry > 0) // first search is for guid (negative), do not drop error
                     // if not found
        LOG_DEBUG("sql.sql",
                  "SmartAIMgr::GetScript: Could not load Script for Entry {} "
                  "ScriptType {}.",
                  entry, uint32(type));
      return temp;
    }
...
private:
  ...
  bool IsMinMaxValid(SmartScriptHolder const& e, uint32 min, uint32 max)
  {
    if (max < min)
    {
      LOG_ERROR("sql.sql",
                ...
                "min/max params wrong ({}/{}), skipped.",
                e.entryOrGuid, e.GetScriptType(), e.event_id, e.GetActionType(), min, max);
      return false;
    }
    return true;
  }
  ...
  bool IsCreatureValid(SmartScriptHolder const& e, uint32 entry)
  {
    if (!sObjectMgr->GetCreatureTemplate(entry))
    {
      LOG_ERROR("sql.sql",
                "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses "
                "non-existent Creature entry {}, skipped.",
  ...
  bool IsQuestValid(SmartScriptHolder const& e, uint32 entry)
  {
    if (!sObjectMgr->GetQuestTemplate(entry))
    {
      LOG_ERROR("sql.sql",
                "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses "
                "non-existent Quest entry {}, skipped.",
                e.entryOrGuid, e.GetScriptType(), e.event_id, e.GetActionType(), entry);
      return false;
    }
    return true;
  ...
  bool IsGameObjectValid(SmartScriptHolder const& e, uint32 entry)
  {
    if (!sObjectMgr->GetGameObjectTemplate(entry))
    {
      LOG_ERROR("sql.sql",
                "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses "
                "non-existent GameObject entry {}, skipped.",
                e.entryOrGuid, e.GetScriptType(), e.event_id, e.GetActionType(), entry);
      return false;
    }
    return true;
  ...
  bool IsSpellValid(SmartScriptHolder const& e, uint32 entry)
  {
    if (!sSpellMgr->GetSpellInfo(entry))
    {
      LOG_ERROR("sql.sql",
                "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses "
                "non-existent Spell entry {}, skipped.",
                e.entryOrGuid, e.GetScriptType(), e.event_id, e.GetActionType(), entry);
      return false;
    }
    return true;
  ...
  bool IsItemValid(SmartScriptHolder const& e, uint32 entry)
  {
    if (!sItemStore.LookupEntry(entry))
    {
      LOG_ERROR("sql.sql",
                "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses "
                "non-existent Item entry {}, skipped.",
                e.entryOrGuid, e.GetScriptType(), e.event_id, e.GetActionType(), entry);
      return false;
    }
    return true;
  ...
  bool IsTextEmoteValid(SmartScriptHolder const& e, uint32 entry)
  {
    if (!sEmotesTextStore.LookupEntry(entry))
    {
      LOG_ERROR("sql.sql",
                "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses "
                "non-existent Text Emote entry {}, skipped.",
                e.entryOrGuid, e.GetScriptType(), e.event_id, e.GetActionType(), entry);
      return false;
    }
    return true;
  ...
  bool IsEmoteValid(SmartScriptHolder const& e, uint32 entry)
  {
    if (!sEmotesStore.LookupEntry(entry))
    {
      LOG_ERROR("sql.sql",
                "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses "
                "non-existent Emote entry {}, skipped.",
                e.entryOrGuid, e.GetScriptType(), e.event_id, e.GetActionType(), entry);
      return false;
    }
    return true;
  ...
  bool IsAreaTriggerValid(SmartScriptHolder const& e, uint32 entry)
  {
    if (!sObjectMgr->GetAreaTrigger(entry))
    {
      LOG_ERROR("sql.sql",
                "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses "
                "non-existent AreaTrigger entry {}, skipped.",
                e.entryOrGuid, e.GetScriptType(), e.event_id, e.GetActionType(), entry);
      return false;
    }
    return true;
  ...
  bool IsSoundValid(SmartScriptHolder const& e, uint32 entry)
  {
    if (!sSoundEntriesStore.LookupEntry(entry))
    {
      LOG_ERROR("sql.sql",
                "SmartAIMgr: Entry {} SourceType {} Event {} Action {} uses "
                "non-existent Sound entry {}, skipped.",
                e.entryOrGuid, e.GetScriptType(), e.event_id, e.GetActionType(), entry);
      return false;
    }
    return true;
