...
template <> struct LinkValidator<LinkTags::achievement>
{
  ...
  static bool IsColorValid(AchievementLinkData const&, HyperlinkColor c) { return c == CHAT_LINK_COLOR_ACHIEVEMENT; }
};
...
template <> struct LinkValidator<LinkTags::item>
{
  static bool IsTextValid(ItemLinkData const& data, std::string_view text)
  {
    ...
    if (data.IsBuggedInspectLink) /* DBC lookup will have failed on the client, so the link should've arrived without
                                     suffix */
...
template <> struct LinkValidator<LinkTags::spell>
{
  ...
  static bool IsColorValid(SpellInfo const*, HyperlinkColor c) { return c == CHAT_LINK_COLOR_SPELL; }
};
...
template <> struct LinkValidator<LinkTags::enchant>
{
  ...
  static bool IsColorValid(SpellInfo const*, HyperlinkColor c) { return c == CHAT_LINK_COLOR_ENCHANT; }
};
...
template <> struct LinkValidator<LinkTags::glyph>
{
  ...
  static bool IsColorValid(GlyphLinkData const&, HyperlinkColor c) { return c == CHAT_LINK_COLOR_GLYPH; }
};
...
template <> struct LinkValidator<LinkTags::talent>
{
  ...
  static bool IsColorValid(TalentLinkData const&, HyperlinkColor c) { return c == CHAT_LINK_COLOR_TALENT; }
};
...
template <> struct LinkValidator<LinkTags::trade>
{
  ...
  static bool IsColorValid(TradeskillLinkData const&, HyperlinkColor c) { return c == CHAT_LINK_COLOR_TRADE; }
};
