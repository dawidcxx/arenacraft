...
{
  CALL_ENABLED_HOOKS(PetScript, PETHOOK_ON_CALCULATE_MAX_TALENT_POINTS_FOR_LEVEL,
...
{
  CALL_ENABLED_BOOLEAN_HOOKS(PetScript, PETHOOK_CAN_UNLEARN_SPELL_DEFAULT,
...
PetScript::PetScript(const char* name, std::vector<uint16> enabledHooks) : ScriptObject(name, PETHOOK_END)
{
